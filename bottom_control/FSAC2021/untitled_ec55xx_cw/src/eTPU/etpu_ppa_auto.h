...
#define FS_ETPU_PPA_FUNCTION_NUMBER  3 
...
#define FS_ETPU_PPA_STATUS_OFFSET  0x0004 
 
#endif /* _ETPU_PPA_AUTO_H_ */

#ifndef _ETPU_PPA_P_AUTO_H_ 
#define _ETPU_PPA_P_AUTO_H_ 
 
/****************************************************************
* Function Configuration Information. 
****************************************************************/
#define FS_ETPU_PPA_P_FUNCTION_NUMBER  2 
#define FS_ETPU_PPA_P_TABLE_SELECT    1 
#define FS_ETPU_PPA_P_NUM_PARMS       0x0030 
 
/****************************************************************
* Host Service Request Definitions. 
****************************************************************/
#define FS_ETPU_PPA_P_INIT        7  
...
/* Function Mode Bit Definitions - pulse/period measurement options - mode options*/
#define FS_ETPU_PPA_P_LOW_PULSE 0   
#define FS_ETPU_PPA_P_HIGH_PULSE 2   
#define FS_ETPU_PPA_P_FALLING_EDGE 1   
#define FS_ETPU_PPA_P_RISING_EDGE 3   
 
#define FS_ETPU_PPA_P_TOOTH_TCR1_OFFSET                   0x0001
#define FS_ETPU_PPA_P_TOOTH_TCR2_OFFSET                   0x0005
#define FS_ETPU_PPA_P_EC_PPA_PERIOD_OFFSET                   0x0029
#define FS_ETPU_PPA_P_OVERFLOW_FLAG_OFFSET                   0x000D
