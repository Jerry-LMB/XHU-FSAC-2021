...
#include "FSAC2021.h"
#include "FSAC2021_private.h"

/* #include "myinclude.h" */

/* Named constants for Chart: '<S127>/Chart2' */
#define FSAC2021_IN_Off                ((uint8_T)1U)
#define FSAC2021_IN_On                 ((uint8_T)2U)
#define FSAC2021_IN_Wait               ((uint8_T)3U)

/* Named constants for Chart: '<S147>/Chart' */
#define FSAC2021_IN_Normal             ((uint8_T)1U)
#define FSAC2021_IN_ON                 ((uint8_T)2U)
#define FSAC2021_IN_Off_i              ((uint8_T)3U)
#define FSAC2021_IN_On_b               ((uint8_T)4U)

/* Named constants for Chart: '<S147>/Chart1' */
#define FSAC2021_IN_Normal_b           ((uint8_T)1U)
#define FSAC2021_IN_ON_b               ((uint8_T)2U)
#define FSAC2021_IN_Off_k              ((uint8_T)3U)
#define FSAC2021_IN_On_a               ((uint8_T)4U)

/* Named constants for Chart: '<S151>/Chart4' */
#define FSAC2021_IN_Normal_h           ((uint8_T)1U)
#define FSAC2021_IN_ON_j               ((uint8_T)2U)
#define FSAC2021_IN_Off_g              ((uint8_T)3U)
#define FSAC2021_IN_On_az              ((uint8_T)4U)

/* Named constants for Chart: '<S77>/Chart' */
#define FSAC2021_IN_NO_ACTIVE_CHILD_n  ((uint8_T)0U)
#define FSAC2021_IN_Start_Horn_OFF     ((uint8_T)1U)
#define FSAC2021_IN_Start_Horn_ON      ((uint8_T)2U)

/* Named constants for Chart: '<S76>/Chart' */
#define FSAC2021_IN_EBS_Horn_OFF       ((uint8_T)1U)
#define FSAC2021_IN_EBS_Horn_ON        ((uint8_T)1U)
#define FSAC2021_IN_EBS_Horn_ON1       ((uint8_T)2U)
#define FSAC2021_IN_Horn               ((uint8_T)2U)

/* Named constants for Chart: '<S66>/Chart' */
#define FSAC2021_IN_Aciton_Move        ((uint8_T)1U)
#define FSAC2021_IN_Encoder1           ((uint8_T)1U)
#define FSAC2021_IN_First              ((uint8_T)1U)
#define FSAC2021_IN_Goto               ((uint8_T)1U)
#define FSAC2021_IN_Init               ((uint8_T)1U)
#define FSAC2021_IN_Motor_Enable       ((uint8_T)2U)
#define FSAC2021_IN_Motor_Move         ((uint8_T)3U)
#define FSAC2021_IN_Motor_Stanby       ((uint8_T)4U)
#define FSAC2021_IN_Move               ((uint8_T)2U)
#define FSAC2021_IN_Move_Position_Set  ((uint8_T)2U)
#define FSAC2021_IN_NO_ACTIVE_CHILD_b  ((uint8_T)0U)
#define FSAC2021_IN_Origin_Aciton_Move ((uint8_T)1U)
#define FSAC2021_IN_Origin_Pos_Set     ((uint8_T)2U)
#define FSAC2021_IN_Pre_Operation_Mode ((uint8_T)3U)
#define FSAC2021_IN_Second             ((uint8_T)2U)
#define FSAC2021_IN_Wait_l             ((uint8_T)5U)

/* Named constants for Chart: '<S64>/BCU_Strategy' */
#define FSAC2021_IN_BackOrigin         ((uint8_T)1U)
#define FSAC2021_IN_Idle               ((uint8_T)1U)
#define FSAC2021_IN_Init_g             ((uint8_T)2U)
#define FSAC2021_IN_Move_k             ((uint8_T)3U)
#define FSAC2021_IN_RunMode            ((uint8_T)2U)
#define FSAC2021_IN_Tozeros            ((uint8_T)4U)

/* Named constants for Chart: '<S93>/Chart' */
#define FSAC2021_IN_Visuality_Off      ((uint8_T)1U)
#define FSAC2021_IN_Visuality_On       ((uint8_T)2U)

/* Named constants for Chart: '<S63>/AS_Machine' */
#define FSAC2021_IN_AS_Driving         ((uint8_T)1U)
#define FSAC2021_IN_AS_Emergency       ((uint8_T)2U)
#define FSAC2021_IN_AS_Finished        ((uint8_T)3U)
#define FSAC2021_IN_AS_Off             ((uint8_T)4U)
#define FSAC2021_IN_AS_Ready           ((uint8_T)5U)
#define FSAC2021_IN_Manual_Driving     ((uint8_T)6U)

/* Named constants for Chart: '<S92>/Chart' */
#define FSAC2021_IN_Driverless         ((uint8_T)1U)
#define FSAC2021_IN_Manul              ((uint8_T)2U)
#define FSAC2021_IN_Task               ((uint8_T)3U)
#define FSAC2021_IN_init               ((uint8_T)4U)

/* Named constants for Chart: '<S108>/Chart' */
#define FSAC2021_IN_IN                 ((uint8_T)1U)
#define FSAC2021_IN_Move_c             ((uint8_T)1U)
#define FSAC2021_IN_end                ((uint8_T)2U)
#define FSAC2021_IN_init_g             ((uint8_T)3U)
...
B_FSAC2021_T FSAC2021_B;

/* Block states (auto storage) */
DW_FSAC2021_T FSAC2021_DW;

/* Real-time model */
RT_MODEL_FSAC2021_T FSAC2021_M_;
RT_MODEL_FSAC2021_T *const FSAC2021_M = &FSAC2021_M_;
...
void ISR_FlexCAN_2_MB1(void)
{
  /* Call the system: <S368>/Function-Call Subsystem */
  {
    ...
    /* Receive CAN message */
    {
      ...
      FSAC2021_B.CANReceive1_o3= 278;
      FSAC2021_B.CANReceive1_o5= 8;
      FSAC2021_B.CANReceive1_o2= ec_can_receive(2,1, CAN2BUF1RX);
      FSAC2021_B.CANReceive1_o4[0]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[1]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[2]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[3]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[4]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[5]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[6]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
      FSAC2021_B.CANReceive1_o4[7]= CAN2BUF1RX[can2buf1looprx];
      can2buf1looprx++;
    }
     ...
     *  Sum: '<S374>/Add'
     */
    if (((int32_T)((uint32_T)(FSAC2021_B.CANReceive1_o4[0] == 83) +
                   (FSAC2021_B.CANReceive1_o4[5] == 84)) == 2) > 0) {
      ...
      /*Transmit CAN message*/
      {
        ...
        can2buf9looptx++;
        FSAC2021_B.CANTransmit= ec_can_transmit(2, 9, 0, 593U, 1, CAN2BUF9TX);
      }
...
void ISR_FlexCAN_2_MB0(void)
{
  /* Call the system: <S372>/CCPReceive */
  {
    ...
    /* Receive CAN message */
    {
      ...
      FSAC2021_B.CANReceive_o3= 256;
      FSAC2021_B.CANReceive_o5= 8;
      FSAC2021_B.CANReceive_o2= ec_can_receive(2,0, CAN2BUF0RX);
      FSAC2021_B.CANReceive_o4[0]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[1]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[2]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[3]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[4]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[5]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[6]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
      FSAC2021_B.CANReceive_o4[7]= CAN2BUF0RX[can2buf0looprx];
      can2buf0looprx++;
    }
 ...
 */
void FSAC2021_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
  /* Task runs when its counter is zero, computed via rtmStepTask macro */
  eventFlags[1] = ((boolean_T)rtmStepTask(FSAC2021_M, 1));
  eventFlags[2] = ((boolean_T)rtmStepTask(FSAC2021_M, 2));
  eventFlags[3] = ((boolean_T)rtmStepTask(FSAC2021_M, 3));
  eventFlags[4] = ((boolean_T)rtmStepTask(FSAC2021_M, 4));
  eventFlags[5] = ((boolean_T)rtmStepTask(FSAC2021_M, 5));
  eventFlags[6] = ((boolean_T)rtmStepTask(FSAC2021_M, 6));
  eventFlags[7] = ((boolean_T)rtmStepTask(FSAC2021_M, 7));
  eventFlags[8] = ((boolean_T)rtmStepTask(FSAC2021_M, 8));
  eventFlags[9] = ((boolean_T)rtmStepTask(FSAC2021_M, 9));
}
...
static void rate_monotonic_scheduler(void)
{
  ...
  if (FSAC2021_M->Timing.TaskCounters.TID[1] == 0) {
    FSAC2021_M->Timing.RateInteraction.TID1_7 =
      (FSAC2021_M->Timing.TaskCounters.TID[7] == 0);
  }

  /* tid 3 shares data with slower tid rate: 7 */
  if (FSAC2021_M->Timing.TaskCounters.TID[3] == 0) {
    FSAC2021_M->Timing.RateInteraction.TID3_7 =
      (FSAC2021_M->Timing.TaskCounters.TID[7] == 0);
  }

  /* tid 6 shares data with slower tid rate: 7 */
  if (FSAC2021_M->Timing.TaskCounters.TID[6] == 0) {
    FSAC2021_M->Timing.RateInteraction.TID6_7 =
      (FSAC2021_M->Timing.TaskCounters.TID[7] == 0);
  }

  /* tid 7 shares data with slower tid rate: 9 */
  if (FSAC2021_M->Timing.TaskCounters.TID[7] == 0) {
    FSAC2021_M->Timing.RateInteraction.TID7_9 =
      (FSAC2021_M->Timing.TaskCounters.TID[9] == 0);
  }
   ...
   */
  (FSAC2021_M->Timing.TaskCounters.TID[1])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[1]) > 1) {/* Sample time: [0.001s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[1] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[2])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[2]) > 9) {/* Sample time: [0.005s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[2] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[3])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[3]) > 19) {/* Sample time: [0.01s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[3] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[4])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[4]) > 39) {/* Sample time: [0.02s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[4] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[5])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[5]) > 59) {/* Sample time: [0.03s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[5] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[6])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[6]) > 99) {/* Sample time: [0.05s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[6] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[7])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[7]) > 199) {/* Sample time: [0.1s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[7] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[8])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[8]) > 399) {/* Sample time: [0.2s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[8] = 0;
  }

  (FSAC2021_M->Timing.TaskCounters.TID[9])++;
  if ((FSAC2021_M->Timing.TaskCounters.TID[9]) > 999) {/* Sample time: [0.5s, 0.0s] */
    FSAC2021_M->Timing.TaskCounters.TID[9] = 0;
  }
}
 ...
 *    '<S186>/LPF3'
 */
void FSAC2021_LPF_Init(DW_LPF_FSAC2021_T *localDW)
{
 ...
 *    '<S186>/LPF3'
 */
void FSAC2021_LPF(real32_T rtu_Filter, B_LPF_FSAC2021_T *localB,
...
void FSAC2021_Round(real32_T rtu_Origin_Precision)
{
 ...
 */
void FSAC2021_Whl_Spd_Hz2RPM(uint32_T rtu_Whl_Spd_Hz,
 ...
 */
void FSAC2021_Whl_Spd_Hz2RPM2(uint32_T rtu_Whl_Spd_Hz,
...
void FSAC2021_MOTEC_CONTROL(real32_T rtu_Abs_or_Rel_Ctrl_in, real32_T
 ...
 *    '<S127>/Chart6'
 */
void FSAC2021_Chart2_Enable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Chart2_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
 ...
 *    '<S127>/Chart6'
 */
void FSAC2021_Chart2_Disable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Chart2_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
 ...
 *    '<S127>/Chart6'
 */
void FSAC2021_Chart2(RT_MODEL_FSAC2021_T * const FSAC2021_M, uint8_T
                     rtu_Non_Debounce, B_Chart2_FSAC2021_T *localB,
                     DW_Chart2_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
  ...
  if (localDW->bitsForTID7.is_active_c15_FSAC2021 == 0U) {
    /* Entry: DIAG/DIAG/Analog_Sensor_Diag/Chart2 */
    localDW->bitsForTID7.is_active_c15_FSAC2021 = 1U;

    /* Entry Internal: DIAG/DIAG/Analog_Sensor_Diag/Chart2 */
    /* Transition: '<S136>:4' */
    localDW->bitsForTID7.is_c15_FSAC2021 = FSAC2021_IN_Off;

    /* Entry 'Off': '<S136>:3' */
    localB->Debounce = 0U;
  } else {
    switch (localDW->bitsForTID7.is_c15_FSAC2021) {
     case FSAC2021_IN_Off:
      /* During 'Off': '<S136>:3' */
      if (rtu_Non_Debounce > 0) {
        /* Transition: '<S136>:7' */
        localDW->bitsForTID7.is_c15_FSAC2021 = FSAC2021_IN_Wait;
     ...
     default:
      ...
      if (rtu_Non_Debounce == 0) {
        ...
        if (localDW->temporalCounter_i1 >= 20U) {
          /* Transition: '<S136>:8' */
          localDW->bitsForTID7.is_c15_FSAC2021 = FSAC2021_IN_On;
...
void FSAC2021_Chart_Enable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
...
void FSAC2021_Chart_Disable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Chart_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
...
void FSAC2021_Chart(RT_MODEL_FSAC2021_T * const FSAC2021_M, uint8_T rtu_Input,
                    B_Chart_FSAC2021_T *localB, DW_Chart_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
  localDW->previousTicks = localDW->presentTicks;
  ...
  if (localDW->bitsForTID7.is_active_c4_FSAC2021 == 0U) {
    /* Entry: DIAG/DIAG/CAN_NODE_LOSTCOM/B_M_S_Check/Chart */
    localDW->bitsForTID7.is_active_c4_FSAC2021 = 1U;

    /* Entry Internal: DIAG/DIAG/CAN_NODE_LOSTCOM/B_M_S_Check/Chart */
    /* Transition: '<S153>:21' */
    localDW->bitsForTID7.is_c4_FSAC2021 = FSAC2021_IN_Normal;
    localDW->temporalCounter_i1 = 0U;

    /* Entry 'Normal': '<S153>:13' */
    localB->Output = 1U;
  } else {
    switch (localDW->bitsForTID7.is_c4_FSAC2021) {
     case FSAC2021_IN_Normal:
      /* During 'Normal': '<S153>:13' */
      if ((rtu_Input == 0) && (localDW->temporalCounter_i1 >= 5U)) {
        /* Transition: '<S153>:16' */
        localDW->bitsForTID7.is_c4_FSAC2021 = FSAC2021_IN_ON;
        localDW->temporalCounter_i1 = 0U;
      }
      break;
     ...
     case FSAC2021_IN_ON:
      ...
      if (rtu_Input == 1) {
        /* Transition: '<S153>:17' */
        localDW->bitsForTID7.is_c4_FSAC2021 = FSAC2021_IN_Off_i;
      } else {
        if (localDW->temporalCounter_i1 >= 20U) {
          /* Transition: '<S153>:20' */
          localDW->bitsForTID7.is_c4_FSAC2021 = FSAC2021_IN_On_b;
 ...
 *    '<S152>/Chart4'
 */
void FSAC2021_Chart1_Enable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
 ...
 *    '<S152>/Chart4'
 */
void FSAC2021_Chart1_Disable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Chart1_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
 ...
 *    '<S152>/Chart4'
 */
void FSAC2021_Chart1(RT_MODEL_FSAC2021_T * const FSAC2021_M, uint8_T rtu_Input,
                     B_Chart1_FSAC2021_T *localB, DW_Chart1_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
  localDW->previousTicks = localDW->presentTicks;
  ...
  if (localDW->bitsForTID7.is_active_c6_FSAC2021 == 0U) {
    /* Entry: DIAG/DIAG/CAN_NODE_LOSTCOM/B_M_S_Check/Chart1 */
    localDW->bitsForTID7.is_active_c6_FSAC2021 = 1U;

    /* Entry Internal: DIAG/DIAG/CAN_NODE_LOSTCOM/B_M_S_Check/Chart1 */
    /* Transition: '<S154>:21' */
    localDW->bitsForTID7.is_c6_FSAC2021 = FSAC2021_IN_Normal_b;

    /* Entry 'Normal': '<S154>:13' */
    localB->Output = 1U;
  } else {
    switch (localDW->bitsForTID7.is_c6_FSAC2021) {
     case FSAC2021_IN_Normal_b:
      /* During 'Normal': '<S154>:13' */
      if (rtu_Input == 0) {
        /* Transition: '<S154>:16' */
        localDW->bitsForTID7.is_c6_FSAC2021 = FSAC2021_IN_ON_b;
        localDW->temporalCounter_i1 = 0U;
      }
      break;

     case FSAC2021_IN_ON_b:
      /* During 'ON': '<S154>:14' */
      if (rtu_Input == 1) {
        /* Transition: '<S154>:17' */
        localDW->bitsForTID7.is_c6_FSAC2021 = FSAC2021_IN_Off_k;
      } else {
        if (localDW->temporalCounter_i1 >= 20U) {
          /* Transition: '<S154>:20' */
          localDW->bitsForTID7.is_c6_FSAC2021 = FSAC2021_IN_On_a;
...
void FSAC2021_Chart4_Enable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
...
void FSAC2021_Chart4_Disable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Chart4_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
...
void FSAC2021_Chart4(RT_MODEL_FSAC2021_T * const FSAC2021_M, uint8_T rtu_Input,
                     DW_Chart4_FSAC2021_T *localDW)
{
  localDW->presentTicks = FSAC2021_M->Timing.clockTick7;
  localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
  ...
  if (localDW->bitsForTID7.is_active_c11_FSAC2021 == 0U) {
    /* Entry: DIAG/DIAG/CAN_NODE_LOSTCOM/Subsystem/Chart4 */
    localDW->bitsForTID7.is_active_c11_FSAC2021 = 1U;

    /* Entry Internal: DIAG/DIAG/CAN_NODE_LOSTCOM/Subsystem/Chart4 */
    /* Transition: '<S157>:21' */
    localDW->bitsForTID7.is_c11_FSAC2021 = FSAC2021_IN_Normal_h;

    /* Entry 'Normal': '<S157>:13' */
    motor = 1U;
  } else {
    switch (localDW->bitsForTID7.is_c11_FSAC2021) {
     case FSAC2021_IN_Normal_h:
      /* During 'Normal': '<S157>:13' */
      if (rtu_Input == 0) {
        /* Transition: '<S157>:16' */
        localDW->bitsForTID7.is_c11_FSAC2021 = FSAC2021_IN_ON_j;
        localDW->temporalCounter_i1 = 0U;
      }
      break;

     case FSAC2021_IN_ON_j:
      /* During 'ON': '<S157>:14' */
      if (rtu_Input == 1) {
        /* Transition: '<S157>:17' */
        localDW->bitsForTID7.is_c11_FSAC2021 = FSAC2021_IN_Off_g;
      } else {
        if (localDW->temporalCounter_i1 >= 20U) {
          /* Transition: '<S157>:20' */
          localDW->bitsForTID7.is_c11_FSAC2021 = FSAC2021_IN_On_az;
 ...
 *    '<S134>/Subsystem2'
 */
void FSAC2021_Subsystem(boolean_T rtu_Enable, real32_T rtu_Compare_Volt_mv,
 ...
 *    '<S69>/off'
 */
void FSAC2021_ON(uint8_T *rty_Out1)
{
 ...
 *    '<S68>/OFF'
 */
void FSAC2021_OFF(uint8_T *rty_Out1)
{
 ...
 *    '<S68>/BLINK'
 */
void FSAC2021_BLINK(uint8_T *rty_Out1, DW_BLINK_FSAC2021_T *localDW)
{
...
void FSAC2021_Light_Subsystem(uint8_T rtu_Light_Status,
  B_Light_Subsystem_FSAC2021_T *localB, DW_Light_Subsystem_FSAC2021_T *localDW)
{
  ...
  if (rtu_Light_Status == 0) {
     ...
     */
    FSAC2021_BLINK(&rtb_Merge, &localDW->BLINK);
...
void FSAC2021_Light_Subsystem1(uint8_T rtu_Light_Status,
  B_Light_Subsystem1_FSAC2021_T *localB, DW_Light_Subsystem1_FSAC2021_T *localDW)
{
  ...
  if (rtu_Light_Status == 0) {
     ...
     */
    FSAC2021_BLINK(&rtb_Merge_c, &localDW->BLINK);
...
void F_Light_Subsystem2_Disable(RT_MODEL_FSAC2021_T * const FSAC2021_M,
  DW_Light_Subsystem2_FSAC2021_T *localDW)
{
  ...
  switch (localDW->If_ActiveSubsystem) {
   ...
   case 1:
    ...
    localDW->presentTicks_p = FSAC2021_M->Timing.clockTick8;
   ...
   case 2:
    ...
    localDW->presentTicks = FSAC2021_M->Timing.clockTick8;
    localDW->elapsedTicks = localDW->presentTicks - localDW->previousTicks;
    localDW->previousTicks = localDW->presentTicks;
...
void FSA_Light_Subsystem2_Start(DW_Light_Subsystem2_FSAC2021_T *localDW)
{
  /* Start for If: '<S69>/If' */
  localDW->If_ActiveSubsystem = -1;
}
...
void FSAC2021_Light_Subsystem2(RT_MODEL_FSAC2021_T * const FSAC2021_M, uint8_T
  rtu_Buzzer_Flag, B_Light_Subsystem2_FSAC2021_T *localB,
  DW_Light_Subsystem2_FSAC2021_T *localDW)
{
  /* local block i/o variables */
  uint8_T rtb_Merge_l;
  ...
  switch (rtAction) {
   ...
   case 1:
    ...
    if (localDW->bitsForTID8.is_active_c7_FSAC2021 == 0U) {
      /* Entry: Controller/200ms_Duty/Light_Subsystem2/Start_Horn/Chart */
      localDW->bitsForTID8.is_active_c7_FSAC2021 = 1U;

      /* Entry Internal: Controller/200ms_Duty/Light_Subsystem2/Start_Horn/Chart */
      /* Transition: '<S80>:2' */
      localDW->bitsForTID8.is_c7_FSAC2021 = FSAC2021_IN_Start_Horn_ON;
      localDW->temporalCounter_i1_n = 0U;

      /* Entry 'Start_Horn_ON': '<S80>:3' */
      localB->Buzzer_Pin_o = 1U;
    } else if ((localDW->bitsForTID8.is_c7_FSAC2021 !=
                FSAC2021_IN_Start_Horn_OFF) && (localDW->temporalCounter_i1_n >=
                10U)) {
      /* During 'Start_Horn_ON': '<S80>:3' */
      /* Transition: '<S80>:8' */
      localDW->bitsForTID8.is_c7_FSAC2021 = FSAC2021_IN_Start_Horn_OFF;
   ...
   case 2:
    ...
    if (localDW->bitsForTID8.is_active_c8_FSAC2021 == 0U) {
      /* Entry: Controller/200ms_Duty/Light_Subsystem2/EBS_Horn/Chart */
      localDW->bitsForTID8.is_active_c8_FSAC2021 = 1U;

      /* Entry Internal: Controller/200ms_Duty/Light_Subsystem2/EBS_Horn/Chart */
      /* Transition: '<S79>:16' */
      localDW->bitsForTID8.is_c8_FSAC2021 = FSAC2021_IN_Horn;
      localDW->temporalCounter_i2 = 0U;

      /* Entry Internal 'Horn': '<S79>:14' */
      /* Transition: '<S79>:2' */
      localDW->bitsForTID8.is_Horn = FSAC2021_IN_EBS_Horn_ON;
      localDW->temporalCounter_i1 = 0U;

      /* Entry 'EBS_Horn_ON': '<S79>:3' */
      localB->Buzzer_Pin = 1U;
    } else if (localDW->bitsForTID8.is_c8_FSAC2021 != FSAC2021_IN_EBS_Horn_OFF)
    {
      /* During 'Horn': '<S79>:14' */
      if (localDW->temporalCounter_i2 >= 45U) {
        /* Transition: '<S79>:15' */
        /* Exit Internal 'Horn': '<S79>:14' */
        localDW->bitsForTID8.is_Horn = FSAC2021_IN_NO_ACTIVE_CHILD_n;
        localDW->bitsForTID8.is_c8_FSAC2021 = FSAC2021_IN_EBS_Horn_OFF;

        /* Entry 'EBS_Horn_OFF': '<S79>:1' */
        localB->Buzzer_Pin = 0U;
        localB->Buzzer_Overflag = 1U;
      } else if (localDW->bitsForTID8.is_Horn == FSAC2021_IN_EBS_Horn_ON) {
        /* During 'EBS_Horn_ON': '<S79>:3' */
        if (localDW->temporalCounter_i1 >= 1U) {
          /* Transition: '<S79>:12' */
          localDW->bitsForTID8.is_Horn = FSAC2021_IN_EBS_Horn_ON1;
          localDW->temporalCounter_i1 = 0U;
...
void FSAC2021_step0(void)              /* Sample time: [0.0005s, 0.0s] */
{
...
void FSAC2021_step1(void)              /* Sample time: [0.001s, 0.0s] */
{
  /* RateTransition: '<S3>/RateTransition22' */
  if (FSAC2021_M->Timing.RateInteraction.TID1_7) {
    FSAC2021_B.RateTransition22 = 0U;
  }
...
void FSAC2021_step2(void)              /* Sample time: [0.005s, 0.0s] */
{
...
void FSAC2021_step3(void)              /* Sample time: [0.01s, 0.0s] */
{
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN0BUF59TX[can0buf59looptx]= FSAC2021_ConstB.status_reg_addr_start_Con_k;
    can0buf59looptx++;
    CAN0BUF59TX[can0buf59looptx]= FSAC2021_ConstB.status_reg_num_Convert;
    can0buf59looptx++;
    Read_BCU= ec_can_transmit(0, 59, 0, 382U, 2, CAN0BUF59TX);
  }

  /* RateTransition: '<S2>/Rate Transition41' */
  FSAC2021_B.RateTransition41 = FSAC2021_DW.RateTransition41_Buffer0;

  /* RateTransition: '<S5>/Rate Transition15' */
  FSAC2021_B.RateTransition15 = FSAC2021_DW.RateTransition15_Buffer0;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.Steer_Sensor_o3= 485;
    FSAC2021_B.Steer_Sensor_o5= 8;
    strsr_node= ec_can_receive(0,38, CAN0BUF38RX);
    FSAC2021_B.Steer_Sensor_o4[0]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[1]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[2]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[3]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[4]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[5]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[6]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
    FSAC2021_B.Steer_Sensor_o4[7]= CAN0BUF38RX[can0buf38looprx];
    can0buf38looprx++;
  }
  ...
  /* Output and update for function-call system: '<S391>/STEER_SENSOR_INFO1' */
  {
     ...
     */
    rtb_Str_Sensor_Curr_Angle_L = (FSAC2021_B.Steer_Sensor_o4[1] << 8) +
      FSAC2021_B.Steer_Sensor_o4[2];
     ...
     */
    if ((FSAC2021_B.Steer_Sensor_o4[1] << 8) + FSAC2021_B.Steer_Sensor_o4[2] >=
        32768) {
  ...
  FSAC2021_B.UnitDelay1 = FSAC2021_DW.UnitDelay1_DSTATE_l;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.MOTEC_MOTION1_o3= 256;
    FSAC2021_B.MOTEC_MOTION1_o5= 3;
    FSAC2021_B.MOTEC_MOTION1_o2= ec_can_receive(0,41, CAN0BUF41RX);
    FSAC2021_B.MOTEC_MOTION1_o4[0]= CAN0BUF41RX[can0buf41looprx];
    can0buf41looprx++;
    FSAC2021_B.MOTEC_MOTION1_o4[1]= CAN0BUF41RX[can0buf41looprx];
    can0buf41looprx++;
    FSAC2021_B.MOTEC_MOTION1_o4[2]= CAN0BUF41RX[can0buf41looprx];
    can0buf41looprx++;
  }
   ...
   */
  if (FSAC2021_B.MOTEC_MOTION1_o4[0] > 100.0F) {
    FSAC2021_B.IPC_Acc_sat = 100.0F;
  } else {
    FSAC2021_B.IPC_Acc_sat = FSAC2021_B.MOTEC_MOTION1_o4[0];
  }
   ...
   */
  if (FSAC2021_B.MOTEC_MOTION1_o4[1] > 100.0F) {
    FSAC2021_B.IPC_Brk_sat = 100.0F;
  } else {
    FSAC2021_B.IPC_Brk_sat = FSAC2021_B.MOTEC_MOTION1_o4[1];
  }
   ...
   */
  FSAC2021_B.IPC_Steer_sat = (real32_T)FSAC2021_B.MOTEC_MOTION1_o4[2] + -120.0F;

  /* Outputs for Enabled SubSystem: '<S391>/Subsystem' incorporates:
   *  EnablePort: '<S415>/Enable'
   */
  if (FSAC2021_B.MOTEC_MOTION1_o2 > 0) {
    /* DataTypeConversion: '<S415>/Data Type Conversion22' */
    FSAC2021_B.DataTypeConversion22 = FSAC2021_B.IPC_Steer_sat;

    /* DataTypeConversion: '<S415>/Data Type Conversion24' */
    FSAC2021_B.DataTypeConversion24 = FSAC2021_B.IPC_Brk_sat;

    /* DataTypeConversion: '<S415>/Data Type Conversion23' */
    FSAC2021_B.DataTypeConversion23 = FSAC2021_B.IPC_Acc_sat;
  }
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN1BUF56TX[can1buf56looptx]= ((uint8_T)0U);
    can1buf56looptx++;
    FSAC2021_B.CANTransmit5= ec_can_transmit(1, 56, 1, 2181107875U, 8,
      CAN1BUF56TX);
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BCU_MTR_STATUS_o3= 257;
    FSAC2021_B.BCU_MTR_STATUS_o5= 8;
    brake_node= ec_can_receive(0,21, CAN0BUF21RX);
    FSAC2021_B.BCU_MTR_STATUS_o4[0]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[1]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[2]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[3]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[4]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[5]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[6]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
    FSAC2021_B.BCU_MTR_STATUS_o4[7]= CAN0BUF21RX[can0buf21looprx];
    can0buf21looprx++;
  }
   ...
   */
  FSAC2021_B.Brake_cmd_fault_flag_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[6] & 2U) >> 1);
   ...
   */
  FSAC2021_B.Brake_encoder_fault_sts_sat = (real32_T)
    (FSAC2021_B.BCU_MTR_STATUS_o4[4] & 1);
   ...
   */
  FSAC2021_B.Brake_hd_fault_sts_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[7] & 64U) >> 6);
   ...
   */
  FSAC2021_B.Brake_lowvolt_prtct_sts_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[5] & 64U) >> 6);
   ...
   */
  FSAC2021_B.Brake_mtr_enable_flag_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[6] & 32U) >> 5);
   ...
   */
  FSAC2021_B.Brake_overcurrt_prtct_sts_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[5] & 32U) >> 5);
   ...
   */
  FSAC2021_B.Brake_overheat_prtct_sts_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[5] & 16U) >> 4);
   ...
   */
  FSAC2021_B.Brake_reg_rw_fault_flag_sat = (real32_T)(int32_T)
    ((FSAC2021_B.BCU_MTR_STATUS_o4[6] & 4U) >> 2);

  /* DataTypeConversion: '<S391>/Data Type Conversion10' */
  FSAC2021_B.DataTypeConversion10 = FSAC2021_B.Brake_reg_rw_fault_flag_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion11' */
  FSAC2021_B.DataTypeConversion11 = FSAC2021_B.Brake_overheat_prtct_sts_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion12' */
  FSAC2021_B.DataTypeConversion12 = FSAC2021_B.Brake_overcurrt_prtct_sts_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion17' */
  FSAC2021_B.DataTypeConversion17 = FSAC2021_B.Brake_lowvolt_prtct_sts_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion18' */
  FSAC2021_B.DataTypeConversion18 = FSAC2021_B.Brake_hd_fault_sts_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion20' */
  FSAC2021_B.DataTypeConversion20 = FSAC2021_B.Brake_encoder_fault_sts_sat;

  /* DataTypeConversion: '<S391>/Data Type Conversion21' */
  FSAC2021_B.DataTypeConversion21 = FSAC2021_B.Brake_cmd_fault_flag_sat;

  /* RateTransition: '<S3>/RateTransition24' */
  if (FSAC2021_M->Timing.RateInteraction.TID3_7) {
    FSAC2021_B.RateTransition24 = FSAC2021_B.RateTransition41;
  }
   ...
   */
  FSAC2021_DW.UnitDelay1_DSTATE_l = (uint8_T)
    FSAC2021_B.Brake_mtr_enable_flag_sat;
}

/* Model step function for TID4 */
void FSAC2021_step4(void)              /* Sample time: [0.02s, 0.0s] */
{
  /* local block i/o variables */
  real32_T rtb_Gain_n;
  ...
  rtb_RateTransition18_l = FSAC2021_DW.RateTransition18_Buffer0;

  /* RateTransition: '<S5>/Rate Transition19' */
  rtb_RateTransition19_d = FSAC2021_DW.RateTransition19_Buffer0;

  /* RateTransition: '<S5>/Rate Transition25' */
  rtb_RateTransition25 = FSAC2021_DW.RateTransition25_Buffer0;

  /* RateTransition: '<S5>/Rate Transition26' */
  rtb_RateTransition26 = FSAC2021_DW.RateTransition26_Buffer0;

  /* RateTransition: '<S5>/Rate Transition22' */
  rtb_RateTransition22_m = FSAC2021_DW.RateTransition22_Buffer0;

  /* RateTransition: '<S5>/Rate Transition23' */
  rtb_RateTransition23_e = FSAC2021_DW.RateTransition23_Buffer0;

  /* RateTransition: '<S5>/Rate Transition14' */
  rtb_RateTransition14 = FSAC2021_DW.RateTransition14_Buffer0;

  /* RateTransition: '<S5>/Rate Transition24' */
  rtb_RateTransition24 = FSAC2021_DW.RateTransition24_Buffer0;
   ...
   *  Sum: '<S198>/Add3'
   */
  rtb_Gain_n = (((FSAC2021_B.LPF.Add1 + FSAC2021_B.LPF1.Add1) +
                 FSAC2021_B.LPF2.Add1) + FSAC2021_B.LPF3.Add1) * 0.25F *
    0.0882159248F;

  /* Outputs for Atomic SubSystem: '<S192>/Round' */
  FSAC2021_Round(rtb_Gain_n);
...
void FSAC2021_step5(void)              /* Sample time: [0.03s, 0.0s] */
{
  ...
  Vspd = FSAC2021_DW.UnitDelay6_DSTATE_p;
   ...
   *  Saturate: '<S33>/vspd_sat'
   */
  FSAC2021_B.vspd_Convert = (uint8_T)((uint32_T)rt_roundf_snf
    (rtb_RateTransition13) & 255U);

  /* UnitDelay: '<S1>/Unit Delay1' */
  Motor_Spd = FSAC2021_DW.UnitDelay1_DSTATE;
   ...
   */
  FSAC2021_B.mtr_rpmCOV = (uint8_T)((real_T)rtb_Battery_Volt_L / 256.0);

  /* DataTypeConversion: '<S32>/mtr_rpmBitCov' incorporates:
   *  Constant: '<S32>/mtr_rpm_And_C'
   *  S-Function (sfix_bitop): '<S32>/mtr_rpm_And'
   */
  FSAC2021_B.mtr_rpmBitCov = (uint8_T)(rtb_Battery_Volt_L & 255U);

  /* UnitDelay: '<S1>/Unit Delay2' */
  ASSI_state = FSAC2021_DW.UnitDelay2_DSTATE;
   ...
   */
  FSAC2021_B.assi_status_Convert = (uint8_T)rt_roundf_snf((real32_T)ASSI_state);

  /* UnitDelay: '<S1>/Unit Delay5' */
  Voltage = FSAC2021_DW.UnitDelay5_DSTATE;
   ...
   */
  FSAC2021_B.Battery_VoltCOV = (uint8_T)((real_T)rtb_Battery_Volt_L / 256.0);
   ...
   */
  FSAC2021_B.Battery_VoltBitCov = (uint8_T)(rtb_Battery_Volt_L & 255U);
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.vspd_Convert;
    can0buf60looptx++;
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.mtr_rpmCOV;
    can0buf60looptx++;
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.mtr_rpmBitCov;
    can0buf60looptx++;
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.assi_status_Convert;
    can0buf60looptx++;
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.Battery_VoltCOV;
    can0buf60looptx++;
    CAN0BUF60TX[can0buf60looptx]= FSAC2021_B.Battery_VoltBitCov;
    can0buf60looptx++;
  ...
  rtb_RateTransition10 = FSAC2021_DW.RateTransition10_Buffer0;

  /* RateTransition: '<S1>/Rate Transition13' */
  rtb_RateTransition13 = FSAC2021_DW.RateTransition13_Buffer0;

  /* RateTransition: '<S1>/Rate Transition14' */
  rtb_RateTransition14_o = FSAC2021_B.RateTransition41;

  /* RateTransition: '<S1>/Rate Transition16' */
  rtb_RateTransition16 = FSAC2021_B.RateTransition15;

  /* Update for UnitDelay: '<S1>/Unit Delay6' */
  FSAC2021_DW.UnitDelay6_DSTATE_p = rtb_RateTransition16;

  /* Update for UnitDelay: '<S1>/Unit Delay1' */
  FSAC2021_DW.UnitDelay1_DSTATE = rtb_RateTransition13;

  /* Update for UnitDelay: '<S1>/Unit Delay2' */
  FSAC2021_DW.UnitDelay2_DSTATE = rtb_RateTransition14_o;

  /* Update for UnitDelay: '<S1>/Unit Delay5' */
  FSAC2021_DW.UnitDelay5_DSTATE = rtb_RateTransition10;
}

/* Model step function for TID6 */
void FSAC2021_step6(void)              /* Sample time: [0.05s, 0.0s] */
{
  /* local block i/o variables */
  real32_T rtb_Gain_i;
  int8_T rtb_Gain_p;
  ...
  ACC = FSAC2021_DW.UnitDelay4_DSTATE;
   ...
   */
  FSAC2021_B.BitCov = (uint8_T)(rtb_Drive_Speed_Control_L & 255U);
   ...
   */
  FSAC2021_B.Drive_Speed_ControlCOV = (uint8_T)((real_T)
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN1BUF15TX[can1buf15looptx]= FSAC2021_B.BitCov;
    can1buf15looptx++;
    CAN1BUF15TX[can1buf15looptx]= FSAC2021_B.Drive_Speed_ControlCOV;
    can1buf15looptx++;
    To_MOTOR_OK= ec_can_transmit(1, 15, 1, 2197885092U, 2, CAN1BUF15TX);
  }

  /* RateTransition: '<S2>/Rate Transition17' */
  rtb_RateTransition17_f = FSAC2021_DW.RateTransition17_Buffer0;

  /* RateTransition: '<S2>/Rate Transition18' */
  rtb_RateTransition18_o = FSAC2021_DW.RateTransition18_Buffer0_d;

  /* RateTransition: '<S2>/Rate Transition19' */
  rtb_RateTransition19_j = FSAC2021_DW.RateTransition19_Buffer0_e;

  /* UnitDelay: '<S2>/Unit Delay4' */
  FSAC2021_B.UnitDelay4 = FSAC2021_DW.UnitDelay4_DSTATE_i;

  /* RateTransition: '<S2>/Rate Transition46' */
  rtb_RateTransition46 = Steer_sensor_angle;

  /* RateTransition: '<S2>/Rate Transition59' */
  rtb_RateTransition59 = FSAC2021_DW.RateTransition59_Buffer0;

  /* RateTransition: '<S2>/Rate Transition60' */
  rtb_RateTransition60 = FSAC2021_B.RateTransition41;

  /* RateTransition: '<S2>/Rate Transition63' */
  Brk_Enable_Flag = FSAC2021_B.UnitDelay1;

  /* RateTransition: '<S2>/Rate Transition57' */
  rtb_RateTransition57 = FSAC2021_B.RateTransition41;

  /* RateTransition: '<S5>/Rate Transition4' */
  rtb_RateTransition4 = FSAC2021_B.Add4;

  /* RateTransition: '<S5>/Rate Transition3' */
  rtb_RateTransition3 = FSAC2021_B.Add5;

  /* RateTransition: '<S5>/Rate Transition5' */
  rtb_RateTransition5 = FSAC2021_B.Add3;

  /* RateTransition: '<S2>/Rate Transition11' */
  rtb_RateTransition11 = FSAC2021_B.RateTransition15;

  /* UnitDelay: '<S9>/Unit Delay5' */
  rtb_UnitDelay5 = FSAC2021_DW.UnitDelay5_DSTATE_e;
  ...
  rtb_RateTransition31_j = FSAC2021_DW.RateTransition31_Buffer0;

  /* RateTransition: '<S2>/Rate Transition32' */
  rtb_RateTransition32_e = FSAC2021_DW.RateTransition32_Buffer0;

  /* RateTransition: '<S2>/Rate Transition50' */
  rtb_RateTransition50 = FSAC2021_DW.RateTransition50_Buffer0;

  /* RateTransition: '<S2>/Rate Transition77' */
  rtb_RateTransition77 = FSAC2021_B.DataTypeConversion22;

  /* RateTransition: '<S2>/Rate Transition78' */
  rtb_RateTransition78 = FSAC2021_B.DataTypeConversion24;

  /* RateTransition: '<S2>/Rate Transition80' */
  rtb_RateTransition80 = FSAC2021_B.DataTypeConversion23;

  /* UnitDelay: '<S3>/Unit Delay2' */
  rtb_UnitDelay5 = FSAC2021_DW.UnitDelay2_DSTATE_h;

  /* RateTransition: '<S3>/Rate Transition47' */
  rtb_RateTransition47 = FSAC2021_DW.RateTransition47_Buffer0;

  /* RateTransition: '<S3>/Rate Transition46' */
  rtb_RateTransition46_e = FSAC2021_DW.RateTransition46_Buffer0;

  /* RateTransition: '<S5>/Rate Transition6' */
  rtb_RateTransition6 = FSAC2021_B.Saturation2;

  /* UnitDelay: '<S2>/Unit Delay7' */
  Steer_Origin_Flag = FSAC2021_DW.UnitDelay7_DSTATE;

  /* RateTransition: '<S1>/Rate Transition19' */
  rtb_RateTransition19_i = FSAC2021_B.RateTransition41;

  /* DataTypeConversion: '<S13>/Data Type Conversion8' incorporates:
   *  UnitDelay: '<S13>/Unit Delay6'
   */
  FSAC2021_B.DataTypeConversion8 = (real32_T)FSAC2021_DW.UnitDelay6_DSTATE_n;

  /* UnitDelay: '<S13>/Unit Delay8' */
  FSAC2021_B.UnitDelay8 = FSAC2021_DW.UnitDelay8_DSTATE;

  /* DataTypeConversion: '<S13>/Data Type Conversion6' incorporates:
   *  UnitDelay: '<S13>/Unit Delay4'
   */
  FSAC2021_B.DataTypeConversion6 = FSAC2021_DW.UnitDelay4_DSTATE_g;

  /* DataTypeConversion: '<S13>/Data Type Conversion9' incorporates:
   *  UnitDelay: '<S13>/Unit Delay7'
   */
  FSAC2021_B.DataTypeConversion9 = FSAC2021_DW.UnitDelay7_DSTATE_g;

  /* DataTypeConversion: '<S13>/Data Type Conversion7' incorporates:
   *  UnitDelay: '<S13>/Unit Delay5'
   */
  FSAC2021_B.DataTypeConversion7 = FSAC2021_DW.UnitDelay5_DSTATE_p;

  /* DataTypeConversion: '<S13>/Data Type Conversion2' incorporates:
   *  UnitDelay: '<S13>/Unit Delay'
   */
  FSAC2021_B.DataTypeConversion2 = FSAC2021_DW.UnitDelay_DSTATE;

  /* DataTypeConversion: '<S13>/Data Type Conversion4' incorporates:
   *  UnitDelay: '<S13>/Unit Delay2'
   */
  FSAC2021_B.DataTypeConversion4 = FSAC2021_DW.UnitDelay2_DSTATE_o;

  /* DataTypeConversion: '<S13>/Data Type Conversion3' incorporates:
   *  UnitDelay: '<S13>/Unit Delay1'
   */
  FSAC2021_B.DataTypeConversion3 = FSAC2021_DW.UnitDelay1_DSTATE_n;

  /* DataTypeConversion: '<S13>/Data Type Conversion5' incorporates:
   *  UnitDelay: '<S13>/Unit Delay3'
   */
  FSAC2021_B.DataTypeConversion5 = FSAC2021_DW.UnitDelay3_DSTATE_p;
   ...
   */
  Str = (int8_T)floor(FSAC2021_DW.UnitDelay6_DSTATE);

  /* Chart: '<S66>/Chart' */
  FSAC2021_DW.presentTicks_nm = FSAC2021_M->Timing.clockTick6;
  FSAC2021_DW.elapsedTicks_c = FSAC2021_DW.presentTicks_nm -
    FSAC2021_DW.previousTicks_c;
  FSAC2021_DW.previousTicks_c = FSAC2021_DW.presentTicks_nm;
  if (FSAC2021_DW.temporalCounter_i1_m + FSAC2021_DW.elapsedTicks_c <= 31U) {
    FSAC2021_DW.temporalCounter_i1_m = (uint8_T)
      (FSAC2021_DW.temporalCounter_i1_m + FSAC2021_DW.elapsedTicks_c);
  } else {
    FSAC2021_DW.temporalCounter_i1_m = 31U;
  }

  /* Gateway: Controller/SteerCtr/Chart */
  /* During: Controller/SteerCtr/Chart */
  if (FSAC2021_DW.bitsForTID6.is_active_c14_FSAC2021 == 0U) {
    /* Entry: Controller/SteerCtr/Chart */
    FSAC2021_DW.bitsForTID6.is_active_c14_FSAC2021 = 1U;

    /* Entry Internal: Controller/SteerCtr/Chart */
    /* Transition: '<S120>:2' */
    FSAC2021_DW.bitsForTID6.is_c14_FSAC2021 = FSAC2021_IN_Init;
  } else {
    switch (FSAC2021_DW.bitsForTID6.is_c14_FSAC2021) {
     case FSAC2021_IN_Init:
      /* During 'Init': '<S120>:100' */
      /* Transition: '<S120>:101' */
      FSAC2021_DW.bitsForTID6.is_c14_FSAC2021 = FSAC2021_IN_Pre_Operation_Mode;

      /* Entry 'Pre_Operation_Mode': '<S120>:1' */
      FSAC2021_B.NMT_nodeorder = 1U;

      /* 开启远程节点。 */
      FSAC2021_B.NMT_nodectrl = 0U;
      break;

     case FSAC2021_IN_Move:
      /* During 'Move': '<S120>:233' */
      switch (FSAC2021_DW.bitsForTID6.is_Move) {
       case FSAC2021_IN_Goto:
        /* Outputs for Function Call SubSystem: '<S13>/MOTEC_CONTROL' */

        /* During 'Goto': '<S120>:13' */
        /* Event: '<S120>:165' */
        FSAC2021_MOTEC_CONTROL(FSAC2021_B.DataTypeConversion7,
          FSAC2021_B.DataTypeConversion8, FSAC2021_B.DataTypeConversion3,
          FSAC2021_B.DataTypeConversion6, FSAC2021_B.DataTypeConversion5,
          FSAC2021_B.DataTypeConversion2, FSAC2021_B.DataTypeConversion4,
          FSAC2021_B.DataTypeConversion9, FSAC2021_B.UnitDelay8,
          &FSAC2021_B.MOTEC_CONTROL);

        /* End of Outputs for SubSystem: '<S13>/MOTEC_CONTROL' */
        FSAC2021_B.Fault_Resrt = 0.0;
        FSAC2021_B.Enable_Operation_Ctrl = 1U;

        /* 允许操作。 */
        if (FSAC2021_DW.bitsForTID6.is_Goto == FSAC2021_IN_Origin_Aciton_Move) {
          /* During 'Origin_Aciton_Move': '<S120>:27' */
          if ((real32_T)fabs(Back_Angle) <= 2.0F) {
            /* Transition: '<S120>:217' */
            FSAC2021_DW.bitsForTID6.is_Goto = FSAC2021_IN_NO_ACTIVE_CHILD_b;
            FSAC2021_DW.bitsForTID6.is_Move = FSAC2021_IN_Wait_l;
            FSAC2021_DW.temporalCounter_i1_m = 0U;
          } else {
            /* Transition: '<S120>:216' */
            FSAC2021_DW.bitsForTID6.is_Goto = FSAC2021_IN_Origin_Pos_Set;

            /* Entry 'Origin_Pos_Set': '<S120>:25' */
            FSAC2021_B.Position_set = Back_Angle;

            /* 电机回位角度赋值。 */
            FSAC2021_B.New_Set_Point_Ctrl = 0U;
          }
        } else {
          /* During 'Origin_Pos_Set': '<S120>:25' */
          /* Transition: '<S120>:215' */
          FSAC2021_DW.bitsForTID6.is_Goto = FSAC2021_IN_Origin_Aciton_Move;

          /* Entry 'Origin_Aciton_Move': '<S120>:27' */
          FSAC2021_B.New_Set_Point_Ctrl = 1U;

          /* 设置新位置点。 */
          FSAC2021_B.Abs_or_Rel_Ctrl = 0U;

          /* 相对位置移动。 */
        }
        break;

       case FSAC2021_IN_Motor_Enable:
        /* Outputs for Function Call SubSystem: '<S13>/MOTEC_CONTROL' */
        ...
        /* End of Outputs for SubSystem: '<S13>/MOTEC_CONTROL' */
        if (FSAC2021_DW.bitsForTID6.is_Motor_Enable == FSAC2021_IN_First) {
          /* During 'First': '<S120>:60' */
          /* Transition: '<S120>:63' */
          FSAC2021_DW.bitsForTID6.is_Motor_Enable = FSAC2021_IN_Second;

          /* Entry 'Second': '<S120>:61' */
          FSAC2021_B.Switch_On_Ctrl = 1U;

          /*  伺服使能 */
        } else {
          /* During 'Second': '<S120>:61' */
          /* Transition: '<S120>:14' */
          FSAC2021_DW.bitsForTID6.is_Motor_Enable =
            FSAC2021_IN_NO_ACTIVE_CHILD_b;
          FSAC2021_DW.bitsForTID6.is_Move = FSAC2021_IN_Goto;
       ...
       case FSAC2021_IN_Motor_Move:
        ...
        /* End of Outputs for SubSystem: '<S13>/MOTEC_CONTROL' */
        enflag = 1.0;
        if (FSAC2021_DW.bitsForTID6.is_Motor_Move == FSAC2021_IN_Aciton_Move) {
          /* During 'Aciton_Move': '<S120>:41' */
          /* Transition: '<S120>:43' */
          FSAC2021_DW.bitsForTID6.is_Motor_Move = FSAC2021_IN_Move_Position_Set;

          /* Entry 'Move_Position_Set': '<S120>:36' */
          FSAC2021_B.Enable_Operation_Ctrl = 1U;

          /* 允许操作。 */
          FSAC2021_B.Position_set = (real32_T)Str;
          ...
          /* Transition: '<S120>:42' */
          FSAC2021_DW.bitsForTID6.is_Motor_Move = FSAC2021_IN_Aciton_Move;

          /* Entry 'Aciton_Move': '<S120>:41' */
          FSAC2021_B.New_Set_Point_Ctrl = 1U;

          /* 设置新位置点。 */
          FSAC2021_B.Abs_or_Rel_Ctrl = 1U;

          /* 绝对位置移动。 */
        }
        break;

       case FSAC2021_IN_Motor_Stanby:
        ...
        /* Event: '<S120>:166' */
        if (FSAC2021_DW.UnitDelay11_DSTATE > 255.0F) {
          rtb_RateTransition46 = 255.0F;
        } else if (FSAC2021_DW.UnitDelay11_DSTATE < 0.0F) {
          rtb_RateTransition46 = 0.0F;
        } else {
          rtb_RateTransition46 = FSAC2021_DW.UnitDelay11_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv1 = (uint8_T)((uint32_T)rt_roundf_snf
          (rtb_RateTransition46) & 255U);

        /* Saturate: '<S55>/Str_Encoder2_sat' incorporates:
         *  UnitDelay: '<S13>/Unit Delay12'
         */
        if (FSAC2021_DW.UnitDelay12_DSTATE > 255.0F) {
          rtb_RateTransition46 = 255.0F;
        } else if (FSAC2021_DW.UnitDelay12_DSTATE < 0.0F) {
          rtb_RateTransition46 = 0.0F;
        } else {
          rtb_RateTransition46 = FSAC2021_DW.UnitDelay12_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv2 = (uint8_T)((uint32_T)rt_roundf_snf
          (rtb_RateTransition46) & 255U);

        /* Saturate: '<S56>/Str_Encoder3_sat' incorporates:
         *  UnitDelay: '<S13>/Unit Delay13'
         */
        if (FSAC2021_DW.UnitDelay13_DSTATE > 255.0F) {
          rtb_RateTransition46 = 255.0F;
        } else if (FSAC2021_DW.UnitDelay13_DSTATE < 0.0F) {
          rtb_RateTransition46 = 0.0F;
        } else {
          rtb_RateTransition46 = FSAC2021_DW.UnitDelay13_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv3 = (uint8_T)((uint32_T)rt_roundf_snf
          (rtb_RateTransition46) & 255U);

        /* Saturate: '<S57>/Str_Encoder4_sat' incorporates:
         *  UnitDelay: '<S13>/Unit Delay14'
         */
        if (FSAC2021_DW.UnitDelay14_DSTATE > 255.0F) {
          rtb_RateTransition46 = 255.0F;
        } else if (FSAC2021_DW.UnitDelay14_DSTATE < 0.0F) {
          rtb_RateTransition46 = 0.0F;
        } else {
          rtb_RateTransition46 = FSAC2021_DW.UnitDelay14_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv4 = (uint8_T)((uint32_T)rt_roundf_snf
          (rtb_RateTransition46) & 255U);
        ...
        if (rtb_RateTransition19_i >= 3) {
          ...
          rtb_RateTransition19_i = FSAC2021_DW.UnitDelay15_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv5 = (uint8_T)rt_roundf_snf((real32_T)
          rtb_RateTransition19_i);

        /* Saturate: '<S59>/Str_Encoder6_sat' incorporates:
         *  UnitDelay: '<S13>/Unit Delay16'
         */
        if (FSAC2021_DW.UnitDelay16_DSTATE > 255.0F) {
          rtb_RateTransition46 = 255.0F;
        } else if (FSAC2021_DW.UnitDelay16_DSTATE < 0.0F) {
          rtb_RateTransition46 = 0.0F;
        } else {
          rtb_RateTransition46 = FSAC2021_DW.UnitDelay16_DSTATE;
        }
         ...
         */
        FSAC2021_B.Conv6 = (uint8_T)((uint32_T)rt_roundf_snf
          (rtb_RateTransition46) & 255U);

        /* End of Outputs for SubSystem: '<S13>/MOTEC_ENCODER1' */
        FSAC2021_B.Original_Flag = 1.0;

        /* During 'Encoder1': '<S120>:69' */
        if (rtb_RateTransition60 == 3) {
          /* Transition: '<S120>:37' */
          /* Exit 'Encoder1': '<S120>:69' */
          FSAC2021_B.Encoder_Msg_Data[4] = (uint8_T)0x00;
          FSAC2021_DW.bitsForTID6.is_Motor_Stanby =
            FSAC2021_IN_NO_ACTIVE_CHILD_b;
          FSAC2021_DW.bitsForTID6.is_Move = FSAC2021_IN_Motor_Move;
          ...
          FSAC2021_B.Encoder_Msg_Data[0] = (uint8_T)0x2B;
          FSAC2021_B.Encoder_Msg_Data[1] = (uint8_T)0x04;

          /* 2004对象字典 */
          FSAC2021_B.Encoder_Msg_Data[2] = (uint8_T)0x20;
          FSAC2021_B.Encoder_Msg_Data[3] = (uint8_T)0x00;
          FSAC2021_B.Encoder_Msg_Data[4] = (uint8_T)0x01;

          /* 编码器清零标志位为1 */
          FSAC2021_B.Encoder_Msg_Data[5] = (uint8_T)0x00;
       ...
       default:
        ...
        if ((real32_T)fabs(Back_Angle) > 2.0F) {
          ...
          if (FSAC2021_DW.temporalCounter_i1_m >= 20U) {
            /* Transition: '<S120>:241' */
            FSAC2021_DW.bitsForTID6.is_Move = FSAC2021_IN_Motor_Stanby;

            /* Entry Internal 'Motor_Stanby': '<S120>:35' */
            /* Transition: '<S120>:171' */
            FSAC2021_DW.bitsForTID6.is_Motor_Stanby = FSAC2021_IN_Encoder1;
          }
        }
        break;
      }
     ...
     default:
      ...
      if (rtb_RateTransition59 != 0) {
        /* Transition: '<S120>:8' */
        FSAC2021_DW.bitsForTID6.is_c14_FSAC2021 = FSAC2021_IN_Move;

        /* Entry Internal 'Move': '<S120>:233' */
        /* Transition: '<S120>:80' */
        FSAC2021_DW.bitsForTID6.is_Move = FSAC2021_IN_Motor_Enable;

        /* Entry Internal 'Motor_Enable': '<S120>:65' */
        /* Transition: '<S120>:64' */
        FSAC2021_DW.bitsForTID6.is_Motor_Enable = FSAC2021_IN_First;

        /* Entry 'First': '<S120>:60' */
        FSAC2021_B.Switch_On_Ctrl = 0U;

        /*   */
        FSAC2021_B.Enable_Voltage_Ctrl = 1U;

        /* 允许通电。 */
        FSAC2021_B.Quick_Stop_Ctrl = 1U;
        ...
        /* 连接所有节点。 */
        /* Event: '<S120>:164' */
        FSAC2021_B.Conv1_p = (uint8_T)rt_roundf_snf((real32_T)
          FSAC2021_DW.UnitDelay10_DSTATE);
         ...
         */
        FSAC2021_B.Conv2_l = (uint8_T)rt_roundf_snf((real32_T)
          FSAC2021_DW.UnitDelay9_DSTATE);
  ...
  FSAC2021_B.Read_RL_WhlSpd= ec_etpu_get_ppa_freq(13);

  /* S-Function (ec55xx_ffrslb): '<S554>/Read_RR_WhlSpd' */

  /* Read the last frequency */
  FSAC2021_B.Read_RR_WhlSpd= ec_etpu_get_ppa_freq(14);

  /* S-Function (fcncallgen): '<S8>/Function-Call Generator1' incorporates:
   *  SubSystem: '<S2>/BCU_Controller'
   */
  /* Chart: '<S64>/BCU_Strategy' */
  FSAC2021_DW.presentTicks_c = FSAC2021_M->Timing.clockTick6;
  FSAC2021_DW.elapsedTicks_f = FSAC2021_DW.presentTicks_c -
    FSAC2021_DW.previousTicks_i;
  FSAC2021_DW.previousTicks_i = FSAC2021_DW.presentTicks_c;
  if (FSAC2021_DW.temporalCounter_i1_o + FSAC2021_DW.elapsedTicks_f <= 15U) {
    FSAC2021_DW.temporalCounter_i1_o = (uint8_T)
      (FSAC2021_DW.temporalCounter_i1_o + FSAC2021_DW.elapsedTicks_f);
  } else {
    FSAC2021_DW.temporalCounter_i1_o = 15U;
  }

  /* Gateway: Controller/BCU_Controller/BCU_Strategy */
  /* During: Controller/BCU_Controller/BCU_Strategy */
  if (FSAC2021_DW.bitsForTID6.is_active_c22_FSAC2021 == 0U) {
    /* Entry: Controller/BCU_Controller/BCU_Strategy */
    FSAC2021_DW.bitsForTID6.is_active_c22_FSAC2021 = 1U;

    /* Entry Internal: Controller/BCU_Controller/BCU_Strategy */
    /* Transition: '<S111>:38' */
    FSAC2021_DW.bitsForTID6.is_c22_FSAC2021 = FSAC2021_IN_Idle;
  } else if (FSAC2021_DW.bitsForTID6.is_c22_FSAC2021 == FSAC2021_IN_Idle) {
    /* During 'Idle': '<S111>:63' */
    /* Transition: '<S111>:31' */
    FSAC2021_DW.bitsForTID6.is_c22_FSAC2021 = FSAC2021_IN_RunMode;

    /* Entry Internal 'RunMode': '<S111>:9' */
    /* Transition: '<S111>:64' */
    FSAC2021_DW.bitsForTID6.is_RunMode = FSAC2021_IN_Init_g;
    ...
    switch (FSAC2021_DW.bitsForTID6.is_RunMode) {
     case FSAC2021_IN_BackOrigin:
      /* During 'BackOrigin': '<S111>:6' */
      if (rtb_RateTransition57 == 3) {
        /* Transition: '<S111>:86' */
        FSAC2021_DW.bitsForTID6.is_RunMode = FSAC2021_IN_Tozeros;
        FSAC2021_DW.temporalCounter_i1_o = 0U;

        /* Entry 'Tozeros': '<S111>:88' */
        FSAC2021_B.Brk_Ctrl_State = 2U;

        /* 制动占用 */
      }
      break;

     case FSAC2021_IN_Init_g:
      /* During 'Init': '<S111>:1' */
      if ((Brk_Enable_Flag != 0) && (rtb_RateTransition57 == 2)) {
        /* Transition: '<S111>:8' */
        FSAC2021_DW.bitsForTID6.is_RunMode = FSAC2021_IN_BackOrigin;

        /* Entry 'BackOrigin': '<S111>:6' */
        /* Event: '<S111>:11' */
        /* /转向电机回位 */
        FSAC2021_B.Brk_Ctrl_State = 1U;

        /* 制动占用 */
      }
      break;

     case FSAC2021_IN_Move_k:
      /* During 'Move': '<S111>:75' */
      break;

     default:
      /* During 'Tozeros': '<S111>:88' */
      if (FSAC2021_DW.temporalCounter_i1_o >= 10U) {
        /* Transition: '<S111>:89' */
        FSAC2021_DW.bitsForTID6.is_RunMode = FSAC2021_IN_Move_k;

        /* Entry 'Move': '<S111>:75' */
        FSAC2021_B.Allow_Ctrl_Flg = 1U;
        FSAC2021_B.Brk_Ctrl_State = 3U;
      }
      break;
    }
  }
   ...
   */
  if (FSAC2021_B.Brk_Ctrl_State == 1) {
    /* SignalConversion: '<S114>/OutportBufferForEngaged_Angle' */
    FSAC2021_B.OutportBufferForEngaged_Angle = 5;
  }
   ...
   */
  if (FSAC2021_B.Brk_Ctrl_State == 2) {
    /* Gain: '<S115>/Gain' */
    rtb_Gain_p = (int8_T)-FSAC2021_B.OutportBufferForEngaged_Angle;
  }
   ...
   */
  rtb_Equal2 = (FSAC2021_B.Brk_Ctrl_State == 3);
  ...
  if (rtb_Equal2) {
     ...
     */
    rtb_Gain_i = -((real32_T)(FSAC2021_B.DataTypeConversion9_l << 7) *
                   0.0078125F);
  }
   ...
   */
  TS_Flag = (uint8_T)(Compare_Voltage && ((FSAC2021_B.DataTypeConversion26_g !=
    0) && (FSAC2021_B.DataTypeConversion1_j != 0) &&
    ((FSAC2021_B.DataTypeConversion15 != 0) ||
     (FSAC2021_B.DataTypeConversion24_k != 0))));

  /* Chart: '<S63>/AS_Machine' incorporates:
   *  UnitDelay: '<S63>/Unit Delay5'
   */
  FSAC2021_DW.presentTicks_b = FSAC2021_M->Timing.clockTick6;
  FSAC2021_DW.elapsedTicks_l = FSAC2021_DW.presentTicks_b -
    FSAC2021_DW.previousTicks_a;
  FSAC2021_DW.previousTicks_a = FSAC2021_DW.presentTicks_b;
  if (FSAC2021_DW.temporalCounter_i1_p + FSAC2021_DW.elapsedTicks_l <= 127U) {
    FSAC2021_DW.temporalCounter_i1_p = (uint8_T)
      (FSAC2021_DW.temporalCounter_i1_p + FSAC2021_DW.elapsedTicks_l);
  } else {
    FSAC2021_DW.temporalCounter_i1_p = 127U;
  }

  /* Gateway: Controller/50ms_Duty/AS_Machine */
  /* During: Controller/50ms_Duty/AS_Machine */
  if (FSAC2021_DW.bitsForTID6.is_active_c3_FSAC2021 == 0U) {
    /* Entry: Controller/50ms_Duty/AS_Machine */
    FSAC2021_DW.bitsForTID6.is_active_c3_FSAC2021 = 1U;

    /* Entry Internal: Controller/50ms_Duty/AS_Machine */
    /* Transition: '<S82>:85' */
    FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Off;

    /* Entry 'AS_Off': '<S82>:2' */
    FSAC2021_B.ASSI_State = 1U;
    FSAC2021_B.System_48V_Relay = 0U;
    FSAC2021_B.Blue_Light = 0U;
    FSAC2021_B.Yellow_Light = 0U;
    FSAC2021_B.VCU_Valve = 1U;
  } else {
    switch (FSAC2021_DW.bitsForTID6.is_c3_FSAC2021) {
     case FSAC2021_IN_AS_Driving:
      /* During 'AS_Driving': '<S82>:7' */
      if ((rtb_RateTransition11 <= 1.0F) && (FSAC2021_DW.UnitDelay5_DSTATE_h !=
           0)) {
        /* Transition: '<S82>:10' */
        FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Finished;

        /* Entry 'AS_Finished': '<S82>:9' */
        FSAC2021_B.ASSI_State = 4U;
        FSAC2021_B.R2D = 0U;
        FSAC2021_B.Safety_Circuit_Relay = 1U;
        FSAC2021_B.System_48V_Relay = 0U;
        FSAC2021_B.Blue_Light = 1U;
        FSAC2021_B.Yellow_Light = 0U;
      }
      break;

     case FSAC2021_IN_AS_Emergency:
      /* During 'AS_Emergency': '<S82>:11' */
      break;

     case FSAC2021_IN_AS_Finished:
      /* During 'AS_Finished': '<S82>:9' */
      /* Transition: '<S82>:14' */
      FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Emergency;

      /* Entry 'AS_Emergency': '<S82>:11' */
      FSAC2021_B.ASSI_State = 5U;
      FSAC2021_B.R2D = 0U;
      FSAC2021_B.Yellow_Light = 0U;
      FSAC2021_B.Blue_Light = 2U;
      FSAC2021_B.Buzzer = 2U;
      break;

     case FSAC2021_IN_AS_Off:
      /* During 'AS_Off': '<S82>:2' */
      if ((AMI_State == 6) && (TS_Flag != 0) &&
          (!(FSAC2021_B.DataTypeConversion4_f != 0)) &&
          (FSAC2021_B.DataTypeConversion25_m != 0)) {
        /* Transition: '<S82>:16' */
        FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_Manual_Driving;

        /* Entry 'Manual_Driving': '<S82>:12' */
        FSAC2021_B.R2D = 1U;
        FSAC2021_B.ASSI_State = 6U;
      } else if ((FSAC2021_B.DataTypeConversion19 != 0) &&
                 (FSAC2021_B.DataTypeConversion4_f != 0) && (TS_Flag != 0) &&
                 (AMI_State != 0)) {
        /* Transition: '<S82>:5' */
        FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Ready;
        FSAC2021_DW.temporalCounter_i1_p = 0U;

        /* Entry 'AS_Ready': '<S82>:3' */
        FSAC2021_B.ASSI_State = 2U;
        FSAC2021_B.System_48V_Relay = 1U;
        FSAC2021_B.Yellow_Light = 1U;
        FSAC2021_B.Blue_Light = 0U;
      } else {
        ...
        /* Event: '<S82>:79' */
        /* Event: '<S82>:87' */
        FSAC2021_DW.presentTicks_n = FSAC2021_M->Timing.clockTick6;
        FSAC2021_DW.elapsedTicks_d = FSAC2021_DW.presentTicks_n -
          FSAC2021_DW.previousTicks_l;
        FSAC2021_DW.previousTicks_l = FSAC2021_DW.presentTicks_n;
        if (FSAC2021_DW.temporalCounter_i1_e + FSAC2021_DW.elapsedTicks_d <= 63U)
        {
          FSAC2021_DW.temporalCounter_i1_e = (uint8_T)
            (FSAC2021_DW.temporalCounter_i1_e + FSAC2021_DW.elapsedTicks_d);
        } else {
          FSAC2021_DW.temporalCounter_i1_e = 63U;
        }

        /* Gateway: Controller/50ms_Duty/Visuality Check/Chart */
        /* During: Controller/50ms_Duty/Visuality Check/Chart */
        if (FSAC2021_DW.bitsForTID6.is_active_c2_FSAC2021 == 0U) {
          /* Entry: Controller/50ms_Duty/Visuality Check/Chart */
          FSAC2021_DW.bitsForTID6.is_active_c2_FSAC2021 = 1U;

          /* Entry Internal: Controller/50ms_Duty/Visuality Check/Chart */
          /* Transition: '<S110>:2' */
          FSAC2021_DW.bitsForTID6.is_c2_FSAC2021 = FSAC2021_IN_Visuality_On;
          FSAC2021_DW.temporalCounter_i1_e = 0U;

          /* Entry 'Visuality_On': '<S110>:1' */
          FSAC2021_B.Visual_Lights[0] = 1U;
          FSAC2021_B.Visual_Lights[1] = 1U;
          FSAC2021_B.Visual_Lights[2] = 1U;
          FSAC2021_B.Visual_Flag = 1U;
        } else if ((FSAC2021_DW.bitsForTID6.is_c2_FSAC2021 !=
                    FSAC2021_IN_Visuality_Off) &&
                   (FSAC2021_DW.temporalCounter_i1_e >= 40U)) {
          /* During 'Visuality_On': '<S110>:1' */
          /* Transition: '<S110>:4' */
          FSAC2021_DW.bitsForTID6.is_c2_FSAC2021 = FSAC2021_IN_Visuality_Off;

          /* Entry 'Visuality_Off': '<S110>:3' */
          FSAC2021_B.Visual_Lights[0] = 0U;
          FSAC2021_B.Visual_Lights[1] = 0U;
          FSAC2021_B.Visual_Lights[2] = 0U;
          FSAC2021_B.Visual_Flag = 0U;
        } else {
     ...
     case FSAC2021_IN_AS_Ready:
      /* During 'AS_Ready': '<S82>:3' */
      if ((FSAC2021_DW.temporalCounter_i1_p >= 100U) &&
          (FSAC2021_B.DataTypeConversion25_m != 0)) {
        /* Transition: '<S82>:8' */
        FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Driving;

        /* Entry 'AS_Driving': '<S82>:7' */
        FSAC2021_B.R2D = 1U;
        FSAC2021_B.ASSI_State = 3U;
        FSAC2021_B.Yellow_Light = 2U;
        FSAC2021_B.Blue_Light = 0U;
        FSAC2021_B.Buzzer = 1U;
      } else {
        if (!(FSAC2021_B.DataTypeConversion4_f != 0)) {
          /* Transition: '<S82>:6' */
          FSAC2021_DW.bitsForTID6.is_c3_FSAC2021 = FSAC2021_IN_AS_Off;
  ...
  LogicalOperator_p = (FSAC2021_B.System_48V_Relay != 0);

  /* Switch: '<S85>/Switch' */
  if (FSAC2021_B.Visual_Flag > 0) {
    rtb_RateTransition47 = FSAC2021_B.Visual_Lights[0];
  }

  if (FSAC2021_B.Visual_Flag > 0) {
    rtb_UnitDelay5 = FSAC2021_B.Visual_Lights[1];
  }

  if (FSAC2021_B.Visual_Flag > 0) {
    rtb_RateTransition46_e = FSAC2021_B.Visual_Lights[2];
  }
   ...
   */
  LogicalOperator_nw = ((FSAC2021_B.R2D != 0) && (!rtb_RateTransition50));

  /* Logic: '<S91>/Logical Operator' */
  rtb_RateTransition50 = ((FSAC2021_B.Safety_Circuit_Relay != 0) ||
  ...
  if (FSAC2021_DW.bitsForTID6.is_active_c5_FSAC2021 == 0U) {
    /* Entry: Controller/50ms_Duty/Subsystem/Chart */
    FSAC2021_DW.bitsForTID6.is_active_c5_FSAC2021 = 1U;

    /* Entry Internal: Controller/50ms_Duty/Subsystem/Chart */
    /* Transition: '<S97>:7' */
    FSAC2021_DW.bitsForTID6.is_c5_FSAC2021 = FSAC2021_IN_init;
  } else {
    switch (FSAC2021_DW.bitsForTID6.is_c5_FSAC2021) {
     case FSAC2021_IN_Driverless:
     ...
     case FSAC2021_IN_Manul:
      /* During 'Manul': '<S97>:2' */
      /* Transition: '<S97>:9' */
      if ((AMI_State == 1) || (AMI_State == 2) || (AMI_State == 3) || (AMI_State
           == 5)) {
        /* Transition: '<S97>:11' */
        FSAC2021_DW.bitsForTID6.is_c5_FSAC2021 = FSAC2021_IN_Driverless;
      } else {
        MODE = 1.0;
     ...
     default:
      ...
      if (AMI_State == 6) {
        /* Transition: '<S97>:3' */
        FSAC2021_DW.bitsForTID6.is_c5_FSAC2021 = FSAC2021_IN_Manul;
        ...
        if (AMI_State == 4) {
          /* Transition: '<S97>:16' */
          /* Transition: '<S97>:17' */
          FSAC2021_DW.bitsForTID6.is_c5_FSAC2021 = FSAC2021_IN_Task;
        }
      }
      break;
    }
   ...
   */
  /* Logic: '<S92>/Logical Operator1' incorporates:
   *  Constant: '<S99>/Constant'
   *  Inport: '<S107>/IPC_Brk_Cmd'
   *  Inport: '<S107>/IPC_Str_Cmd'
   *  RelationalOperator: '<S99>/Compare'
   */
  if ((MODE == 2.0) && (FSAC2021_B.Allow_Ctrl_Flg != 0)) {
    FSAC2021_B.IPC_Brk_Cmd = rtb_RateTransition78;
     ...
     *  Inport: '<S107>/IPC_Str_Cmd'
     */
    FSAC2021_B.Merge = 15.0 * rtb_RateTransition80;
  }

  /* End of Logic: '<S92>/Logical Operator1' */
  ...
  if (MODE == 1.0) {
    ...
    if (rtb_RateTransition77 > 1500.0) {
      FSAC2021_B.Merge = 1500.0;
    } else if (rtb_RateTransition77 < 0.0) {
      FSAC2021_B.Merge = 0.0;
    } else {
      FSAC2021_B.Merge = rtb_RateTransition77;
    }
  ...
  enable = ((MODE == 3.0) && (Steer_Origin_Flag == 1.0) &&
            (FSAC2021_B.Allow_Ctrl_Flg == 1));

  /* Outputs for Enabled SubSystem: '<S92>/Subsystem2' incorporates:
   *  EnablePort: '<S108>/Enable'
   */
  if (enable) {
    if (!FSAC2021_DW.Subsystem2_MODE) {
      /* Enable for Chart: '<S108>/Chart' */
      FSAC2021_DW.presentTicks = FSAC2021_M->Timing.clockTick6;
      FSAC2021_DW.previousTicks = FSAC2021_DW.presentTicks;
      FSAC2021_DW.Subsystem2_MODE = true;
    }

    /* Chart: '<S108>/Chart' */
    FSAC2021_DW.presentTicks = FSAC2021_M->Timing.clockTick6;
    FSAC2021_DW.elapsedTicks = FSAC2021_DW.presentTicks -
      FSAC2021_DW.previousTicks;
    FSAC2021_DW.previousTicks = FSAC2021_DW.presentTicks;
    if (FSAC2021_DW.temporalCounter_i1 + FSAC2021_DW.elapsedTicks <= 1023U) {
      FSAC2021_DW.temporalCounter_i1 = (uint16_T)(FSAC2021_DW.temporalCounter_i1
        + FSAC2021_DW.elapsedTicks);
    } else {
      FSAC2021_DW.temporalCounter_i1 = 1023U;
    }

    /* Gateway: Controller/50ms_Duty/Subsystem/Subsystem2/Chart */
    /* During: Controller/50ms_Duty/Subsystem/Subsystem2/Chart */
    if (FSAC2021_DW.bitsForTID6.is_active_c9_FSAC2021 == 0U) {
      /* Entry: Controller/50ms_Duty/Subsystem/Subsystem2/Chart */
      FSAC2021_DW.bitsForTID6.is_active_c9_FSAC2021 = 1U;

      /* Entry Internal: Controller/50ms_Duty/Subsystem/Subsystem2/Chart */
      /* Transition: '<S109>:33' */
      FSAC2021_DW.bitsForTID6.is_c9_FSAC2021 = FSAC2021_IN_init_g;

      /* Entry 'init': '<S109>:26' */
      FSAC2021_B.SteerCmd = 0.0;
      FSAC2021_B.ACC_b = 200.0;
    } else {
      switch (FSAC2021_DW.bitsForTID6.is_c9_FSAC2021) {
       case FSAC2021_IN_IN:
        /* During 'IN': '<S109>:30' */
        if (FSAC2021_DW.temporalCounter_i1 >= 540U) {
          /* Transition: '<S109>:32' */
          /* Exit Internal 'IN': '<S109>:30' */
          FSAC2021_DW.bitsForTID6.is_IN = FSAC2021_IN_NO_ACTIVE_CHILD_b;
          FSAC2021_DW.bitsForTID6.is_c9_FSAC2021 = FSAC2021_IN_end;

          /* Entry 'end': '<S109>:34' */
          FSAC2021_B.ACC_b = 0.0;
          FSAC2021_B.SteerCmd = 0.0;
          FSAC2021_B.Mission_Flag = 1U;
        } else if (FSAC2021_DW.bitsForTID6.is_IN == FSAC2021_IN_Move_c) {
          /* During 'Move': '<S109>:28' */
          if (FSAC2021_B.SteerCmd >= 110.0) {
            /* Transition: '<S109>:25' */
            FSAC2021_DW.bitsForTID6.is_IN = FSAC2021_IN_Second;
          } else {
            FSAC2021_B.SteerCmd += 5.0;
          }
        } else {
          /* During 'Second': '<S109>:27' */
          if (FSAC2021_B.SteerCmd <= -110.0) {
            /* Transition: '<S109>:29' */
            FSAC2021_DW.bitsForTID6.is_IN = FSAC2021_IN_Move_c;
          } else {
            FSAC2021_B.SteerCmd -= 5.0;
          }
        }
       ...
       default:
        /* During 'init': '<S109>:26' */
        /* Transition: '<S109>:35' */
        FSAC2021_DW.bitsForTID6.is_c9_FSAC2021 = FSAC2021_IN_IN;
        FSAC2021_DW.temporalCounter_i1 = 0U;
    ...
    FSAC2021_B.Merge = FSAC2021_B.ACC_b;

    /* SignalConversion: '<S108>/OutportBufferForSteerCmd' */
    ipc_strr = FSAC2021_B.SteerCmd;
  } else {
    if (FSAC2021_DW.Subsystem2_MODE) {
      ...
      FSAC2021_DW.previousTicks = FSAC2021_DW.presentTicks;
      if (FSAC2021_DW.temporalCounter_i1 + FSAC2021_DW.elapsedTicks <= 1023U) {
        FSAC2021_DW.temporalCounter_i1 = (uint16_T)
          (FSAC2021_DW.temporalCounter_i1 + FSAC2021_DW.elapsedTicks);
      } else {
        FSAC2021_DW.temporalCounter_i1 = 1023U;
      }

      /* End of Disable for Chart: '<S108>/Chart' */
      FSAC2021_DW.Subsystem2_MODE = false;
    }
  }
  ...
  rtb_RateTransition46 = (real32_T)FSAC2021_B.Merge;

  /* DataTypeConversion: '<S92>/Data Type Conversion9' */
  FSAC2021_B.DataTypeConversion9_l = (uint8_T)FSAC2021_B.IPC_Brk_Cmd;
  ...
  FSAC2021_DW.UnitDelay5_DSTATE_h = FSAC2021_B.Mission_Flag;
  ...
  FSAC2021_B.DataTypeConversion19 = (uint8_T)LVMS_Read;
  ...
  FSAC2021_B.DataTypeConversion1_j = (uint8_T)HVMS_Read;
  ...
  FSAC2021_B.DataTypeConversion4_f = (uint8_T)ASMS_Read;
  ...
  FSAC2021_B.DataTypeConversion15 = (uint8_T)On_Out_Switch;
  ...
  FSAC2021_B.DataTypeConversion25_m = (uint8_T)START;
  ...
  FSAC2021_B.DataTypeConversion24_k = (uint8_T)On_IN_Switch;
  ...
  FSAC2021_B.DataTypeConversion26_g = (uint8_T)HV_LIGHT;
  ...
  /* Read the ADC conversion result of the analog signal */
  FSAC2021_B.Read_Compare= ec_adc_readresult(5);

  /* Gain: '<S552>/Gain' */
  Read_compare_OutVolt = 0.001F * (real32_T)FSAC2021_B.Read_Compare;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_HCU_MAXT_o3= -1738391309;
    FSAC2021_B.BMS_HCU_MAXT_o5= 8;
    FSAC2021_B.BMS_HCU_MAXT_o2= ec_can_receive(1,18, CAN1BUF18RX);
    FSAC2021_B.BMS_HCU_MAXT_o4[0]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[1]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[2]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[3]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[4]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[5]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[6]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
    FSAC2021_B.BMS_HCU_MAXT_o4[7]= CAN1BUF18RX[can1buf18looprx];
    can1buf18looprx++;
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_HCU_MAXV_o3= -1738456845;
    FSAC2021_B.BMS_HCU_MAXV_o5= 8;
    FSAC2021_B.BMS_HCU_MAXV_o2= ec_can_receive(1,16, CAN1BUF16RX);
    FSAC2021_B.BMS_HCU_MAXV_o4[0]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[1]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[2]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[3]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[4]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[5]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[6]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
    FSAC2021_B.BMS_HCU_MAXV_o4[7]= CAN1BUF16RX[can1buf16looprx];
    can1buf16looprx++;
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_RELAY_o3= -1738325773;
    FSAC2021_B.BMS_RELAY_o5= 8;
    FSAC2021_B.BMS_RELAY_o2= ec_can_receive(1,51, CAN1BUF51RX);
    FSAC2021_B.BMS_RELAY_o4[0]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[1]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[2]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[3]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[4]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[5]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[6]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
    FSAC2021_B.BMS_RELAY_o4[7]= CAN1BUF51RX[can1buf51looprx];
    can1buf51looprx++;
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_HCU_POWER_o3= -1738260237;
    FSAC2021_B.BMS_HCU_POWER_o5= 8;
    FSAC2021_B.BMS_HCU_POWER_o2= ec_can_receive(1,52, CAN1BUF52RX);
    FSAC2021_B.BMS_HCU_POWER_o4[0]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[1]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[2]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[3]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[4]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[5]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[6]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
    FSAC2021_B.BMS_HCU_POWER_o4[7]= CAN1BUF52RX[can1buf52looprx];
    can1buf52looprx++;
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.Motor_Current_Speed_o3= -2147413853;
    FSAC2021_B.Motor_Current_Speed_o5= 2;
    motor_node= ec_can_receive(1,21, CAN1BUF21RX);
    FSAC2021_B.Motor_Current_Speed_o4[0]= CAN1BUF21RX[can1buf21looprx];
    can1buf21looprx++;
    FSAC2021_B.Motor_Current_Speed_o4[1]= CAN1BUF21RX[can1buf21looprx];
    can1buf21looprx++;
  }
  ...
  /* Output and update for function-call system: '<S392>/MOTOR_CURRENT_SPEED' */
  {
     ...
     */
    u0 = (real32_T)((FSAC2021_B.Motor_Current_Speed_o4[1] << 8) +
                    FSAC2021_B.Motor_Current_Speed_o4[0]);
    if (u0 > 2500.0F) {
      FSAC2021_B.Motor_Currt_Speed_sat = 2500.0F;
    } else {
      FSAC2021_B.Motor_Currt_Speed_sat = u0;
    }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_ALARM_o3= -1738194701;
    FSAC2021_B.BMS_ALARM_o5= 8;
    FSAC2021_B.BMS_ALARM_o2= ec_can_receive(1,50, CAN1BUF50RX);
    FSAC2021_B.BMS_ALARM_o4[0]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[1]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[2]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[3]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[4]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[5]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[6]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
    FSAC2021_B.BMS_ALARM_o4[7]= CAN1BUF50RX[can1buf50looprx];
    can1buf50looprx++;
  }
   ...
   */
  FSAC2021_B.DataTypeConversion39 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[4] & 96U) >> 5);
   ...
   */
  FSAC2021_B.DataTypeConversion40 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[4] & 16U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion41 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[5] & 128U) >> 7);
   ...
   */
  FSAC2021_B.DataTypeConversion43 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[3] & 12U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion47 = (uint8_T)(real32_T)(FSAC2021_B.BMS_ALARM_o4
    [3] & 3);
   ...
   */
  FSAC2021_B.DataTypeConversion48 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[4] & 128U) >> 7);
   ...
   */
  FSAC2021_B.DataTypeConversion49 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[4] & 4U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion50 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[2] & 12U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion51 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[2] & 48U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion52 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[4] & 8U) >> 3);
   ...
   */
  FSAC2021_B.DataTypeConversion53 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[2] & 192U) >> 6);
   ...
   */
  FSAC2021_B.DataTypeConversion54 = (uint8_T)(real32_T)(FSAC2021_B.BMS_ALARM_o4
    [1] & 3);
   ...
   */
  FSAC2021_B.DataTypeConversion55 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[1] & 12U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion56 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[1] & 48U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion57 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[1] & 64U) >> 6);
   ...
   */
  FSAC2021_B.DataTypeConversion58 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[1] & 128U) >> 7);
   ...
   */
  FSAC2021_B.DataTypeConversion59 = (uint8_T)(real32_T)(FSAC2021_B.BMS_ALARM_o4
    [0] & 3);
   ...
   */
  FSAC2021_B.DataTypeConversion60 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[0] & 12U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion61 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[0] & 48U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion62 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.BMS_ALARM_o4[0] & 192U) >> 6);
  ...
  FSAC2021_B.DataTypeConversion1_h = (rtb_RateTransition18_o != 0);

  /* S-Function (ec55xx_pdsslb): '<S175>/Yellow_Pin' */

  /* Set level FSAC2021_B.DataTypeConversion1_h for the specified power driver switch */
  ec_gpio_write(198,FSAC2021_B.DataTypeConversion1_h);
  ...
  V48_relay = FSAC2021_B.UnitDelay4;
  ...
  FSAC2021_B.DataTypeConversion5_i = (FSAC2021_B.VCU_Valve != 0);

  /* S-Function (ec55xx_pdsslb): '<S175>/VCU_Valve' */

  /* Set level FSAC2021_B.DataTypeConversion5_i for the specified power driver switch */
  ec_gpio_write(182,FSAC2021_B.DataTypeConversion5_i);
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv1;
    can0buf63looptx++;
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv2;
    can0buf63looptx++;
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv3;
    can0buf63looptx++;
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv4;
    can0buf63looptx++;
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv5;
    can0buf63looptx++;
    CAN0BUF63TX[can0buf63looptx]= FSAC2021_B.MOTEC_CONTROL.Conv6;
    can0buf63looptx++;
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN0BUF62TX[can0buf62looptx]= FSAC2021_B.Conv1_p;
    can0buf62looptx++;
    CAN0BUF62TX[can0buf62looptx]= FSAC2021_B.Conv2_l;
    can0buf62looptx++;
  ...
  /*Transmit CAN message*/
  {
    ...
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv1;
    can0buf61looptx++;
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv2;
    can0buf61looptx++;
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv3;
    can0buf61looptx++;
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv4;
    can0buf61looptx++;
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv5;
    can0buf61looptx++;
    CAN0BUF61TX[can0buf61looptx]= FSAC2021_B.Conv6;
    can0buf61looptx++;
    ENCODER_SEND= ec_can_transmit(0, 61, 0, 1537U, 6, CAN0BUF61TX);
  }

  /* DataTypeConversion: '<S13>/Data Type Conversion11' */
  rtb_RateTransition11 = FSAC2021_B.Encoder_Msg_Data[0];

  /* DataTypeConversion: '<S13>/Data Type Conversion12' */
  rtb_Drive_Speed_Control_L = FSAC2021_B.Encoder_Msg_Data[1];

  /* DataTypeConversion: '<S13>/Data Type Conversion13' */
  rtb_DataTypeConversion13 = FSAC2021_B.Encoder_Msg_Data[2];

  /* DataTypeConversion: '<S13>/Data Type Conversion14' */
  rtb_DataTypeConversion14 = FSAC2021_B.Encoder_Msg_Data[3];

  /* DataTypeConversion: '<S13>/Data Type Conversion16' */
  rtb_DataTypeConversion16 = FSAC2021_B.Encoder_Msg_Data[5];
  ...
  rtb_UnitDelay5 = FSAC2021_DW.RateTransition15_Buffer0_e;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.AMI1_o3= 1168;
    FSAC2021_B.AMI1_o5= 1;
    AMI_HEART= ec_can_receive(0,26, CAN0BUF26RX);
    FSAC2021_B.AMI1_o4= CAN0BUF26RX[can0buf26looprx];
    can0buf26looprx++;
  }
  ...
  if (FSAC2021_M->Timing.RateInteraction.TID6_7) {
    FSAC2021_B.RateTransition21 = FSAC2021_B.DataTypeConversion51;

    /* RateTransition: '<S3>/RateTransition17' */
    FSAC2021_B.RateTransition17 = FSAC2021_B.DataTypeConversion52;

    /* RateTransition: '<S3>/RateTransition16' */
    FSAC2021_B.RateTransition16 = FSAC2021_B.DataTypeConversion53;

    /* RateTransition: '<S3>/RateTransition2' */
    FSAC2021_B.RateTransition2 = FSAC2021_B.DataTypeConversion54;

    /* RateTransition: '<S3>/RateTransition18' */
    FSAC2021_B.RateTransition18 = FSAC2021_B.DataTypeConversion55;

    /* RateTransition: '<S3>/RateTransition19' */
    FSAC2021_B.RateTransition19 = FSAC2021_B.DataTypeConversion56;

    /* RateTransition: '<S3>/RateTransition20' */
    FSAC2021_B.RateTransition20 = FSAC2021_B.DataTypeConversion57;

    /* RateTransition: '<S3>/RateTransition9' */
    FSAC2021_B.RateTransition9 = FSAC2021_B.DataTypeConversion58;

    /* RateTransition: '<S3>/RateTransition7' */
    FSAC2021_B.RateTransition7 = FSAC2021_B.DataTypeConversion59;

    /* RateTransition: '<S3>/RateTransition6' */
    FSAC2021_B.RateTransition6 = FSAC2021_B.DataTypeConversion60;

    /* RateTransition: '<S3>/RateTransition11' */
    FSAC2021_B.RateTransition11 = FSAC2021_B.DataTypeConversion61;

    /* RateTransition: '<S3>/RateTransition8' */
    FSAC2021_B.RateTransition8 = FSAC2021_B.DataTypeConversion62;

    /* RateTransition: '<S3>/RateTransition10' */
    FSAC2021_B.RateTransition10 = FSAC2021_B.DataTypeConversion50;

    /* RateTransition: '<S3>/RateTransition3' */
    FSAC2021_B.RateTransition3 = FSAC2021_B.DataTypeConversion40;

    /* RateTransition: '<S3>/RateTransition13' */
    FSAC2021_B.RateTransition13 = FSAC2021_B.DataTypeConversion39;

    /* RateTransition: '<S3>/RateTransition12' */
    FSAC2021_B.RateTransition12 = FSAC2021_B.DataTypeConversion41;

    /* RateTransition: '<S3>/RateTransition5' */
    FSAC2021_B.RateTransition5 = FSAC2021_B.DataTypeConversion43;

    /* RateTransition: '<S3>/RateTransition4' */
    FSAC2021_B.RateTransition4 = FSAC2021_B.DataTypeConversion47;

    /* RateTransition: '<S3>/RateTransition14' */
    FSAC2021_B.RateTransition14 = FSAC2021_B.DataTypeConversion48;

    /* RateTransition: '<S3>/RateTransition15' */
    FSAC2021_B.RateTransition15_b = FSAC2021_B.DataTypeConversion49;

    /* RateTransition: '<S3>/RateTransition23' */
    FSAC2021_B.RateTransition23 = rtb_RateTransition59;

    /* RateTransition: '<S3>/RateTransition1' */
    FSAC2021_B.RateTransition1 = Read_compare_OutVolt;
  }

  /* End of RateTransition: '<S3>/RateTransition21' */

  /* RateTransition: '<S3>/Rate Transition44' */
  rtb_RateTransition59 = FSAC2021_DW.RateTransition44_Buffer0;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.AMI_o3= 1169;
    FSAC2021_B.AMI_o5= 1;
    FSAC2021_B.AMI_o2= ec_can_receive(0,16, CAN0BUF16RX);
    FSAC2021_B.AMI_o4= CAN0BUF16RX[can0buf16looprx];
    can0buf16looprx++;
  }
   ...
   */
  FSAC2021_B.assi_status_sat = FSAC2021_B.AMI_o4;

  /* DataTypeConversion: '<S391>/Data Type Conversion' */
  AMI = (uint8_T)FSAC2021_B.assi_status_sat;

  /* Update for UnitDelay: '<S1>/Unit Delay4' */
  FSAC2021_DW.UnitDelay4_DSTATE = rtb_RateTransition46;

  /* Update for RateTransition: '<S1>/Rate Transition13' */
  FSAC2021_DW.RateTransition13_Buffer0 = FSAC2021_B.Motor_Currt_Speed_sat;

  /* Update for RateTransition: '<S2>/Rate Transition41' */
  FSAC2021_DW.RateTransition41_Buffer0 = FSAC2021_B.ASSI_State;

  /* Update for UnitDelay: '<S2>/Unit Delay4' */
  FSAC2021_DW.UnitDelay4_DSTATE_i = LogicalOperator_p;

  /* Update for UnitDelay: '<S2>/Unit Delay6' */
  FSAC2021_DW.UnitDelay6_DSTATE = ipc_strr;

  /* Update for RateTransition: '<S5>/Rate Transition18' */
  FSAC2021_DW.RateTransition18_Buffer0 = FSAC2021_B.Read_RL_WhlSpd;

  /* Update for RateTransition: '<S5>/Rate Transition19' */
  FSAC2021_DW.RateTransition19_Buffer0 = FSAC2021_B.Read_RR_WhlSpd;

  /* Update for RateTransition: '<S5>/Rate Transition25' */
  FSAC2021_DW.RateTransition25_Buffer0 = FSAC2021_B.Read_RL_WhlSpd;

  /* Update for RateTransition: '<S5>/Rate Transition26' */
  FSAC2021_DW.RateTransition26_Buffer0 = FSAC2021_B.Read_RR_WhlSpd;

  /* Update for RateTransition: '<S5>/Rate Transition22' */
  FSAC2021_DW.RateTransition22_Buffer0 = Read_Right_Acc_Disp1;

  /* Update for RateTransition: '<S5>/Rate Transition23' */
  FSAC2021_DW.RateTransition23_Buffer0 = Read_Brk_Liquid_Prs;

  /* Update for RateTransition: '<S5>/Rate Transition14' */
  FSAC2021_DW.RateTransition14_Buffer0 = Read_EBS_Gas_Prs1;

  /* Update for RateTransition: '<S5>/Rate Transition24' */
  FSAC2021_DW.RateTransition24_Buffer0 = Read_EBS_Gas_Prs2;

  /* Update for UnitDelay: '<S9>/Unit Delay5' */
  FSAC2021_DW.UnitDelay5_DSTATE_e = AMI;

  /* Update for UnitDelay: '<S2>/Unit Delay3' */
  FSAC2021_DW.UnitDelay3_DSTATE = rtb_UnitDelay5;

  /* Update for UnitDelay: '<S3>/Unit Delay2' */
  FSAC2021_DW.UnitDelay2_DSTATE_h = rtb_RateTransition59;

  /* Update for UnitDelay: '<S2>/Unit Delay7' */
  FSAC2021_DW.UnitDelay7_DSTATE = FSAC2021_B.Original_Flag;

  /* Update for UnitDelay: '<S13>/Unit Delay10' */
  FSAC2021_DW.UnitDelay10_DSTATE = FSAC2021_B.NMT_nodeorder;

  /* Update for UnitDelay: '<S13>/Unit Delay9' */
  FSAC2021_DW.UnitDelay9_DSTATE = FSAC2021_B.NMT_nodectrl;

  /* Update for UnitDelay: '<S13>/Unit Delay11' */
  FSAC2021_DW.UnitDelay11_DSTATE = rtb_RateTransition11;

  /* Update for UnitDelay: '<S13>/Unit Delay12' */
  FSAC2021_DW.UnitDelay12_DSTATE = (real32_T)rtb_Drive_Speed_Control_L;

  /* Update for UnitDelay: '<S13>/Unit Delay13' */
  FSAC2021_DW.UnitDelay13_DSTATE = (real32_T)rtb_DataTypeConversion13;

  /* Update for UnitDelay: '<S13>/Unit Delay14' */
  FSAC2021_DW.UnitDelay14_DSTATE = (real32_T)rtb_DataTypeConversion14;

  /* Update for UnitDelay: '<S13>/Unit Delay15' */
  FSAC2021_DW.UnitDelay15_DSTATE = FSAC2021_B.Encoder_Msg_Data[4];

  /* Update for UnitDelay: '<S13>/Unit Delay16' */
  FSAC2021_DW.UnitDelay16_DSTATE = (real32_T)rtb_DataTypeConversion16;

  /* Update for UnitDelay: '<S13>/Unit Delay6' */
  FSAC2021_DW.UnitDelay6_DSTATE_n = FSAC2021_B.Fault_Resrt;

  /* Update for UnitDelay: '<S13>/Unit Delay8' */
  FSAC2021_DW.UnitDelay8_DSTATE = FSAC2021_B.Position_set;

  /* Update for UnitDelay: '<S13>/Unit Delay4' */
  FSAC2021_DW.UnitDelay4_DSTATE_g = FSAC2021_B.New_Set_Point_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay7' */
  FSAC2021_DW.UnitDelay7_DSTATE_g = FSAC2021_B.Halt_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay5' */
  FSAC2021_DW.UnitDelay5_DSTATE_p = FSAC2021_B.Abs_or_Rel_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay' */
  FSAC2021_DW.UnitDelay_DSTATE = FSAC2021_B.Switch_On_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay2' */
  FSAC2021_DW.UnitDelay2_DSTATE_o = FSAC2021_B.Quick_Stop_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay1' */
  FSAC2021_DW.UnitDelay1_DSTATE_n = FSAC2021_B.Enable_Voltage_Ctrl;

  /* Update for UnitDelay: '<S13>/Unit Delay3' */
  FSAC2021_DW.UnitDelay3_DSTATE_p = FSAC2021_B.Enable_Operation_Ctrl;
   ...
   */
  FSAC2021_M->Timing.clockTick6++;
}

/* Model step function for TID7 */
void FSAC2021_step7(void)              /* Sample time: [0.1s, 0.0s] */
{
  /* local block i/o variables */
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.Str_Error_o3= 129;
    FSAC2021_B.Str_Error_o5= 8;
    FSAC2021_B.Str_Error_o2= ec_can_receive(0,4, CAN0BUF4RX);
    FSAC2021_B.Str_Error_o4[0]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[1]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[2]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[3]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[4]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[5]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[6]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
    FSAC2021_B.Str_Error_o4[7]= CAN0BUF4RX[can0buf4looprx];
    can0buf4looprx++;
  }
   ...
   */
  FSAC2021_B.DataTypeConversion22_b = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 8U) >> 3);
   ...
   */
  FSAC2021_B.DataTypeConversion23_i = (uint8_T)(real32_T)
    (FSAC2021_B.Str_Error_o4[1] & 1);
   ...
   */
  FSAC2021_B.DataTypeConversion24_f = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 16U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion25 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 4U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion26 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 8U) >> 3);
   ...
   */
  FSAC2021_B.DataTypeConversion27 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 4U) >> 2);
   ...
   */
  FSAC2021_B.DataTypeConversion28 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 16U) >> 4);
   ...
   */
  FSAC2021_B.DataTypeConversion29 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 64U) >> 6);
   ...
   */
  FSAC2021_B.DataTypeConversion30 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 2U) >> 1);
   ...
   */
  FSAC2021_B.DataTypeConversion31 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 128U) >> 7);
   ...
   */
  FSAC2021_B.DataTypeConversion32 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 128U) >> 7);
   ...
   */
  FSAC2021_B.DataTypeConversion33 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 2U) >> 1);
   ...
   */
  FSAC2021_B.DataTypeConversion34 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[1] & 32U) >> 5);
   ...
   */
  FSAC2021_B.DataTypeConversion35 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 32U) >> 5);
   ...
   */
  FSAC2021_B.DataTypeConversion36 = (uint8_T)(real32_T)(FSAC2021_B.Str_Error_o4
    [0] & 1);
   ...
   */
  FSAC2021_B.DataTypeConversion37 = (uint8_T)(real32_T)(int32_T)
    ((FSAC2021_B.Str_Error_o4[0] & 64U) >> 6);

  /* RateTransition: '<S3>/Rate Transition17' */
  rtb_RateTransition17 = FSAC2021_B.DataTypeConversion10;

  /* RateTransition: '<S3>/Rate Transition18' */
  rtb_RateTransition18 = FSAC2021_B.DataTypeConversion11;

  /* RateTransition: '<S3>/Rate Transition19' */
  rtb_RateTransition19 = FSAC2021_B.DataTypeConversion12;

  /* RateTransition: '<S3>/Rate Transition20' */
  rtb_RateTransition20 = FSAC2021_B.DataTypeConversion17;

  /* RateTransition: '<S3>/Rate Transition21' */
  rtb_RateTransition21 = FSAC2021_B.DataTypeConversion18;

  /* RateTransition: '<S3>/Rate Transition22' */
  rtb_RateTransition22 = FSAC2021_B.DataTypeConversion20;

  /* RateTransition: '<S3>/Rate Transition23' */
  rtb_RateTransition23 = FSAC2021_B.DataTypeConversion21;
  ...
  rtb_RateTransition43 = FSAC2021_B.UnitDelay4;
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.BMS_HCU_INFO_o3= -1738522381;
    FSAC2021_B.BMS_HCU_INFO_o5= 8;
    bms_node= ec_can_receive(1,54, CAN1BUF54RX);
    FSAC2021_B.BMS_HCU_INFO_o4[0]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[1]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[2]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[3]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[4]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[5]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[6]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
    FSAC2021_B.BMS_HCU_INFO_o4[7]= CAN1BUF54RX[can1buf54looprx];
    can1buf54looprx++;
  }
  ...
  /* Output and update for function-call system: '<S393>/BMS_HCU_INFO ' */
  {
     ...
     */
    u0 = (real32_T)((FSAC2021_B.BMS_HCU_INFO_o4[0] << 8) +
                    FSAC2021_B.BMS_HCU_INFO_o4[1]) * 0.1F;

    /* Saturate: '<S528>/BatVoltage_sat' */
    if (u0 > 900.0F) {
      /* DataTypeConversion: '<S526>/Data Type Conversion84' */
      FSAC2021_B.DataTypeConversion84 = 900.0;
    } else {
      /* DataTypeConversion: '<S526>/Data Type Conversion84' */
      FSAC2021_B.DataTypeConversion84 = u0;
    }
  ...
  if (FSAC2021_M->Timing.RateInteraction.TID7_9) {
    FSAC2021_B.RateTransition25 = FSAC2021_DW.RateTransition25_Buffer0_d;
  }
  ...
  /* Chart: '<S127>/Chart2' */
  FSAC2021_Chart2(FSAC2021_M, rtb_DataTypeConversion1, &FSAC2021_B.sf_Chart2,
                  &FSAC2021_DW.sf_Chart2);
  ...
  /* Chart: '<S127>/Chart3' */
  FSAC2021_Chart2(FSAC2021_M, rtb_DataTypeConversion2, &FSAC2021_B.sf_Chart3,
                  &FSAC2021_DW.sf_Chart3);
  ...
  /* Chart: '<S127>/Chart4' */
  FSAC2021_Chart2(FSAC2021_M, rtb_DataTypeConversion3, &FSAC2021_B.sf_Chart4,
                  &FSAC2021_DW.sf_Chart4);
  ...
  /* Chart: '<S127>/Chart5' */
  FSAC2021_Chart2(FSAC2021_M, rtb_DataTypeConversion4, &FSAC2021_B.sf_Chart5,
                  &FSAC2021_DW.sf_Chart5);
  ...
  /* Chart: '<S127>/Chart6' */
  FSAC2021_Chart2(FSAC2021_M, rtb_DataTypeConversion5, &FSAC2021_B.sf_Chart6,
                  &FSAC2021_DW.sf_Chart6);

  /* Logic: '<S127>/Logical Operator8' */
  sensor_erroe = ((FSAC2021_B.sf_Chart2.Debounce != 0) ||
                  (FSAC2021_B.sf_Chart3.Debounce != 0) ||
                  (FSAC2021_B.sf_Chart4.Debounce != 0) ||
                  (FSAC2021_B.sf_Chart5.Debounce != 0) ||
                  (FSAC2021_B.sf_Chart6.Debounce != 0));

  /* Outputs for Enabled SubSystem: '<S130>/B_M_S_Check' incorporates:
   *  EnablePort: '<S147>/Enable'
   */
  if (rtb_RateTransition43) {
    if (!FSAC2021_DW.B_M_S_Check_MODE) {
      /* Enable for Chart: '<S147>/Chart' */
      FSAC2021_Chart_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart_o4);

      /* Enable for Chart: '<S147>/Chart1' */
      FSAC2021_Chart1_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart1);
      FSAC2021_DW.B_M_S_Check_MODE = true;
    }

    /* Chart: '<S147>/Chart' */
    FSAC2021_Chart(FSAC2021_M, FSAC2021_B.RateTransition25,
                   &FSAC2021_B.sf_Chart_o4, &FSAC2021_DW.sf_Chart_o4);

    /* Chart: '<S147>/Chart1' */
    FSAC2021_Chart1(FSAC2021_M, rtb_RateTransition32, &FSAC2021_B.sf_Chart1,
                    &FSAC2021_DW.sf_Chart1);

    /* SignalConversion: '<S147>/TmpSignal ConversionAtChart1Outport1' */
    BRAKE = FSAC2021_B.sf_Chart1.Output;

    /* SignalConversion: '<S147>/TmpSignal ConversionAtChartOutport1' */
    MOTEC = FSAC2021_B.sf_Chart_o4.Output;

    /* Logic: '<S147>/Logical Operator' */
    FSAC2021_B.LogicalOperator_n = ((BRAKE != 0) && (MOTEC != 0));
  } else {
    if (FSAC2021_DW.B_M_S_Check_MODE) {
      /* Disable for Chart: '<S147>/Chart' */
      FSAC2021_Chart_Disable(FSAC2021_M, &FSAC2021_DW.sf_Chart_o4);

      /* Disable for Chart: '<S147>/Chart1' */
      FSAC2021_Chart1_Disable(FSAC2021_M, &FSAC2021_DW.sf_Chart1);
      FSAC2021_DW.B_M_S_Check_MODE = false;
    }
  }
   ...
   */
  rtb_Compare_hp = (FSAC2021_B.RateTransition24 >= 3);

  /* RelationalOperator: '<S149>/Compare' incorporates:
   *  Constant: '<S149>/Constant'
   */
  rtb_Compare_b = (FSAC2021_B.RateTransition24 <= 5);

  /* Switch: '<S130>/Switch' incorporates:
   *  Constant: '<S130>/Constant2'
   */
  if (rtb_RateTransition43) {
    rtb_Switch = (int32_T)FSAC2021_B.LogicalOperator_n;
  } else {
    rtb_Switch = 1;
  }
  ...
  /* Chart: '<S152>/Chart2' */
  FSAC2021_Chart1(FSAC2021_M, rtb_RateTransition42, &FSAC2021_B.sf_Chart2_h,
                  &FSAC2021_DW.sf_Chart2_h);

  /* SignalConversion: '<S152>/TmpSignal ConversionAtChart2Outport1' */
  STRSNR = FSAC2021_B.sf_Chart2_h.Output;

  /* Chart: '<S152>/Chart3' */
  FSAC2021_Chart1(FSAC2021_M, rtb_RateTransition41, &FSAC2021_B.sf_Chart3_h,
                  &FSAC2021_DW.sf_Chart3_h);

  /* SignalConversion: '<S152>/TmpSignal ConversionAtChart3Outport1' */
  BMS = FSAC2021_B.sf_Chart3_h.Output;

  /* Chart: '<S152>/Chart4' */
  FSAC2021_Chart1(FSAC2021_M, rtb_RateTransition31, &FSAC2021_B.sf_Chart4_k,
                  &FSAC2021_DW.sf_Chart4_k);

  /* SignalConversion: '<S152>/TmpSignal ConversionAtChart4Outport1' */
  AMI_NODE = FSAC2021_B.sf_Chart4_k.Output;
   ...
   */
  if (rtb_RateTransition43) {
    if (!FSAC2021_DW.Subsystem_MODE) {
      /* Enable for Chart: '<S151>/Chart4' */
      FSAC2021_Chart4_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart4_p);
      FSAC2021_DW.Subsystem_MODE = true;
    }

    /* Chart: '<S151>/Chart4' */
    FSAC2021_Chart4(FSAC2021_M, rtb_RateTransition30, &FSAC2021_DW.sf_Chart4_p);
    rtb_RateTransition43_0 = motor;
  } else {
    if (FSAC2021_DW.Subsystem_MODE) {
      /* Disable for Chart: '<S151>/Chart4' */
      FSAC2021_Chart4_Disable(FSAC2021_M, &FSAC2021_DW.sf_Chart4_p);
      FSAC2021_DW.Subsystem_MODE = false;
    }
  ...
  /*  Ready or Driving */
  if ((FSAC2021_B.RateTransition24 == 2) || (FSAC2021_B.RateTransition24 == 3))
  {
   ...
   */
  rtb_HiddenBuf_InsertedFor_Subsy = (FSAC2021_B.RateTransition24 == 3);

  /* SignalConversion: '<S134>/HiddenBuf_InsertedFor_Subsystem2_at_inport_1' incorporates:
   *  Constant: '<S168>/Constant'
   *  RelationalOperator: '<S168>/Compare'
   */
  rtb_HiddenBuf_InsertedFor_Sub_m = (FSAC2021_B.RateTransition24 == 6);

  /* SignalConversion: '<S134>/HiddenBuf_InsertedFor_Subsystem_at_inport_1' incorporates:
   *  Constant: '<S166>/Constant'
   *  RelationalOperator: '<S166>/Compare'
   */
  rtb_HiddenBuf_InsertedFor_Sub_i = (FSAC2021_B.RateTransition24 == 2);

  /* Outputs for Enabled SubSystem: '<S134>/Subsystem' */
  FSAC2021_Subsystem(rtb_HiddenBuf_InsertedFor_Sub_i, FSAC2021_B.RateTransition1,
                     &FSAC2021_B.Merge_j);

  /* End of Outputs for SubSystem: '<S134>/Subsystem' */

  /* Outputs for Enabled SubSystem: '<S134>/Subsystem1' */
  FSAC2021_Subsystem(rtb_HiddenBuf_InsertedFor_Subsy, FSAC2021_B.RateTransition1,
                     &FSAC2021_B.Merge_j);

  /* End of Outputs for SubSystem: '<S134>/Subsystem1' */

  /* Outputs for Enabled SubSystem: '<S134>/Subsystem2' */
  FSAC2021_Subsystem(rtb_HiddenBuf_InsertedFor_Sub_m, FSAC2021_B.RateTransition1,
                     &FSAC2021_B.Merge_j);

  /* End of Outputs for SubSystem: '<S134>/Subsystem2' */

  /* Logic: '<S133>/Logical Operator' */
  rtb_RateTransition43 = ((FSAC2021_B.DataTypeConversion22_b != 0) ||
    (FSAC2021_B.DataTypeConversion23_i != 0) || (FSAC2021_B.DataTypeConversion36
    != 0) || (FSAC2021_B.DataTypeConversion37 != 0) ||
    (FSAC2021_B.DataTypeConversion24_f != 0) || (FSAC2021_B.DataTypeConversion25
    != 0) || (FSAC2021_B.DataTypeConversion26 != 0) ||
    (FSAC2021_B.DataTypeConversion27 != 0) || (FSAC2021_B.DataTypeConversion28
    != 0) || (FSAC2021_B.DataTypeConversion29 != 0) ||
    (FSAC2021_B.DataTypeConversion30 != 0) || (FSAC2021_B.DataTypeConversion31
    != 0) || (FSAC2021_B.DataTypeConversion32 != 0) ||
    (FSAC2021_B.DataTypeConversion33 != 0) || (FSAC2021_B.DataTypeConversion34
    != 0) || (FSAC2021_B.DataTypeConversion35 != 0));
   ...
   */
  rtb_Compare_hp = ((FSAC2021_B.RateTransition3 != 0) ||
                    (FSAC2021_B.RateTransition13 != 0) ||
                    (FSAC2021_B.RateTransition12 != 0) ||
                    (FSAC2021_B.RateTransition5 != 0) ||
                    (FSAC2021_B.RateTransition4 != 0) ||
                    (FSAC2021_B.RateTransition14 != 0) ||
                    (FSAC2021_B.RateTransition15_b != 0) ||
                    (FSAC2021_B.RateTransition10 != 0) ||
                    (FSAC2021_B.RateTransition21 != 0) ||
                    (FSAC2021_B.RateTransition17 != 0) ||
                    (FSAC2021_B.RateTransition16 != 0) ||
                    (FSAC2021_B.RateTransition2 != 0) ||
                    (FSAC2021_B.RateTransition18 != 0) ||
                    (FSAC2021_B.RateTransition19 != 0) ||
                    (FSAC2021_B.RateTransition20 != 0) ||
                    (FSAC2021_B.RateTransition9 != 0) ||
                    (FSAC2021_B.RateTransition7 != 0) ||
                    (FSAC2021_B.RateTransition6 != 0) ||
                    (FSAC2021_B.RateTransition11 != 0) ||
                    (FSAC2021_B.RateTransition8 != 0));

  /* Logic: '<S135>/Logical Operator' */
  rtb_Compare_b = ((FSAC2021_B.RateTransition22 != 0) &&
                   (FSAC2021_B.RateTransition23 != 0));
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.MOTEC_STATUS_o3= 385;
    FSAC2021_B.MOTEC_STATUS_o5= 2;
    Steer_Status= ec_can_receive(0,6, CAN0BUF6RX);
    FSAC2021_B.MOTEC_STATUS_o4[0]= CAN0BUF6RX[can0buf6looprx];
    can0buf6looprx++;
    FSAC2021_B.MOTEC_STATUS_o4[1]= CAN0BUF6RX[can0buf6looprx];
    can0buf6looprx++;
  }
  ...
  FSAC2021_DW.RateTransition10_Buffer0 = FSAC2021_B.DataTypeConversion84;

  /* Update for RateTransition: '<S2>/Rate Transition59' */
  FSAC2021_DW.RateTransition59_Buffer0 = Steer_Status;

  /* Update for RateTransition: '<S2>/Rate Transition31' */
  FSAC2021_DW.RateTransition31_Buffer0 = rtb_RateTransition43;
   ...
   */
  FSAC2021_DW.RateTransition32_Buffer0 = ((rtb_RateTransition17 != 0.0) ||
  ...
  FSAC2021_DW.RateTransition50_Buffer0 = FSAC2021_B.Merge_j;
   ...
   */
  FSAC2021_DW.RateTransition47_Buffer0 = rtb_Compare_b;

  /* Update for RateTransition: '<S3>/Rate Transition46' incorporates:
   *  DataTypeConversion: '<S128>/Data Type Conversion17'
   */
  FSAC2021_DW.RateTransition46_Buffer0 = rtb_Compare_hp;

  /* Update for RateTransition: '<S3>/Rate Transition44' */
  FSAC2021_DW.RateTransition44_Buffer0 = EBS_Failure_Flag;
   ...
   * application lifespan selected.
   */
  FSAC2021_M->Timing.clockTick7++;
}

/* Model step function for TID8 */
void FSAC2021_step8(void)              /* Sample time: [0.2s, 0.0s] */
{
  /* local block i/o variables */
  ...
  FSAC2021_Light_Subsystem(rtb_RateTransition20_o, &FSAC2021_B.Light_Subsystem,
    &FSAC2021_DW.Light_Subsystem);

  /* End of Outputs for SubSystem: '<S62>/Light_Subsystem' */

  /* Outputs for Atomic SubSystem: '<S62>/Light_Subsystem1' */
  FSAC2021_Light_Subsystem1(rtb_RateTransition21_m, &FSAC2021_B.Light_Subsystem1,
    &FSAC2021_DW.Light_Subsystem1);

  /* End of Outputs for SubSystem: '<S62>/Light_Subsystem1' */

  /* Outputs for Atomic SubSystem: '<S62>/Light_Subsystem2' */
  FSAC2021_Light_Subsystem2(FSAC2021_M, rtb_RateTransition22_g,
    &FSAC2021_B.Light_Subsystem2, &FSAC2021_DW.Light_Subsystem2);

  /* End of Outputs for SubSystem: '<S62>/Light_Subsystem2' */

  /* RateTransition: '<S2>/Rate Transition12' */
  rtb_UnitDelay = FSAC2021_B.Yellow_Light;

  /* RateTransition: '<S2>/Rate Transition13' */
  rtb_RateTransition13 = FSAC2021_B.Buzzer;

  /* RateTransition: '<S2>/Rate Transition6' */
  rtb_RateTransition6 = FSAC2021_B.Blue_Light;

  /* Update for RateTransition: '<S2>/Rate Transition17' */
  FSAC2021_DW.RateTransition17_Buffer0 =
    FSAC2021_B.Light_Subsystem.DataTypeConversion;

  /* Update for RateTransition: '<S2>/Rate Transition18' */
  FSAC2021_DW.RateTransition18_Buffer0_d =
    FSAC2021_B.Light_Subsystem1.DataTypeConversion;

  /* Update for RateTransition: '<S2>/Rate Transition19' */
  FSAC2021_DW.RateTransition19_Buffer0_e =
    FSAC2021_B.Light_Subsystem2.DataTypeConversion;

  /* Update for UnitDelay: '<S2>/Unit Delay' */
  FSAC2021_DW.UnitDelay_DSTATE_d = rtb_RateTransition6;

  /* Update for UnitDelay: '<S2>/Unit Delay1' */
  FSAC2021_DW.UnitDelay1_DSTATE_c = rtb_UnitDelay;

  /* Update for UnitDelay: '<S2>/Unit Delay2' */
  FSAC2021_DW.UnitDelay2_DSTATE_i = rtb_RateTransition13;

  /* Update for RateTransition: '<S2>/Rate Transition15' */
  FSAC2021_DW.RateTransition15_Buffer0_e =
    FSAC2021_B.Light_Subsystem2.Buzzer_Overflag;
   ...
   * application lifespan selected.
   */
  FSAC2021_M->Timing.clockTick8++;
}

/* Model step function for TID9 */
void FSAC2021_step9(void)              /* Sample time: [0.5s, 0.0s] */
{
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.HEARTBEAT_o3= 1793;
    FSAC2021_B.HEARTBEAT_o5= 1;
    motec_node= ec_can_receive(0,3, CAN0BUF3RX);
    FSAC2021_B.HEARTBEAT_o4= CAN0BUF3RX[can0buf3looprx];
    can0buf3looprx++;
  }
  ...
  /* Receive CAN message */
  {
    ...
    FSAC2021_B.MOTEC_MOTION_o3= 641;
    FSAC2021_B.MOTEC_MOTION_o5= 8;
    FSAC2021_B.MOTEC_MOTION_o2= ec_can_receive(0,5, CAN0BUF5RX);
    FSAC2021_B.MOTEC_MOTION_o4[0]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[1]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[2]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[3]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[4]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[5]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[6]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
    FSAC2021_B.MOTEC_MOTION_o4[7]= CAN0BUF5RX[can0buf5looprx];
    can0buf5looprx++;
  }
  ...
  FSAC2021_DW.RateTransition25_Buffer0_d = motec_node;
}

/* Model step wrapper function for compatibility with a static main program */
void FSAC2021_step(int_T tid)
{
  switch (tid) {
   case 0 :
    FSAC2021_step0();
...
void FSAC2021_initialize(void)
{
  ...
  FSA_Light_Subsystem2_Start(&FSAC2021_DW.Light_Subsystem2);
  ...
  FSAC2021_Chart2_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart2);

  /* Enable for Chart: '<S127>/Chart3' */
  FSAC2021_Chart2_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart3);

  /* Enable for Chart: '<S127>/Chart4' */
  FSAC2021_Chart2_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart4);

  /* Enable for Chart: '<S127>/Chart5' */
  FSAC2021_Chart2_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart5);

  /* Enable for Chart: '<S127>/Chart6' */
  FSAC2021_Chart2_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart6);

  /* Enable for Chart: '<S152>/Chart2' */
  FSAC2021_Chart1_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart2_h);

  /* Enable for Chart: '<S152>/Chart3' */
  FSAC2021_Chart1_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart3_h);

  /* Enable for Chart: '<S152>/Chart4' */
  FSAC2021_Chart1_Enable(FSAC2021_M, &FSAC2021_DW.sf_Chart4_k);
}

/* File trailer for ECUCoder generated file FSAC2021.c.
 *
 * [EOF]
 */
