...
static void initialize_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c20_FSAC2021(SFc20_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance);
static void disable_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c20_FSAC2021(SFc20_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c20_FSAC2021(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_st);
static void c20_set_sim_state_side_effects_c20_FSAC2021
  (SFc20_FSAC2021InstanceStruct *chartInstance);
static void finalize_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance);
static void c20_chartstep_c20_FSAC2021(SFc20_FSAC2021InstanceStruct
  *chartInstance);
static void initSimStructsc20_FSAC2021(SFc20_FSAC2021InstanceStruct
  *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct *chartInstance,
...
static const mxArray *c20_b_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static boolean_T c20_b_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_c_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static uint8_T c20_d_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_b_tp_Normal, const char_T *c20_identifier);
static uint8_T c20_e_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static uint32_T c20_f_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_b_previousTicks, const char_T
  *c20_identifier);
static uint32_T c20_g_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static const mxArray *c20_h_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_b_setSimStateSideEffectsInfo, const char_T *
  c20_identifier);
static const mxArray *c20_i_emlrt_marshallIn(SFc20_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_updateDataWrittenToVector(SFc20_FSAC2021InstanceStruct
  *chartInstance, uint32_T c20_vectorIndex);
static void init_dsm_address_info(SFc20_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_tp_On = 0U;
  chartInstance->c20_is_active_c20_FSAC2021 = 0U;
  chartInstance->c20_is_c20_FSAC2021 = c20_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  c20_b_hoistedGlobal = chartInstance->c20_is_active_c20_FSAC2021;
  ...
  c20_c_hoistedGlobal = chartInstance->c20_is_c20_FSAC2021;
  ...
  *chartInstance, const mxArray *c20_st)
{
  ...
  *c20_Output = c20_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c20_u, 0)), "Output");
  chartInstance->c20_is_active_c20_FSAC2021 = c20_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 1)),
     "is_active_c20_FSAC2021");
  chartInstance->c20_is_c20_FSAC2021 = c20_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c20_u, 2)), "is_c20_FSAC2021");
  ...
  c20_update_debugger_state_c20_FSAC2021(chartInstance);
...
static void sf_gateway_c20_FSAC2021(SFc20_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c20_set_sim_state_side_effects_c20_FSAC2021(chartInstance);
  ...
  chartInstance->c20_sfEvent = CALL_EVENT;
  c20_chartstep_c20_FSAC2021(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c20_is_active_c20_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 18U, chartInstance->c20_sfEvent);
    chartInstance->c20_is_active_c20_FSAC2021 = 1U;
    ...
    chartInstance->c20_is_c20_FSAC2021 = c20_IN_Normal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c20_sfEvent);
    chartInstance->c20_tp_Normal = 1U;
    ...
    *c20_Output = 1U;
    ...
    switch (chartInstance->c20_is_c20_FSAC2021) {
     case c20_IN_Normal:
      ...
      if (c20_out) {
        ...
        chartInstance->c20_tp_Normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c20_sfEvent);
        chartInstance->c20_is_c20_FSAC2021 = c20_IN_ON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c20_sfEvent);
        chartInstance->c20_temporalCounter_i1 = 0U;
        chartInstance->c20_tp_ON = 1U;
      } else {
     ...
     case c20_IN_ON:
      ...
      if (c20_b_out) {
        ...
        chartInstance->c20_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c20_sfEvent);
        chartInstance->c20_is_c20_FSAC2021 = c20_IN_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c20_sfEvent);
        chartInstance->c20_tp_Off = 1U;
      } else {
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc20_FSAC2021InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c20_FSAC2021_get_eml_resolved_functions_info(void)
{
...
void sf_c20_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c20_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c20_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c20_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[24],T\"Output\",},{M[8],M[0],T\"is_active_c20_FSAC2021\",},{M[9],M[0],T\"is_c20_FSAC2021\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc20_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c20_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_FSAC2021InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*)
    chartInstanceVar);
  initialize_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_FSAC2021(void *chartInstanceVar)
{
  enable_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_FSAC2021(void *chartInstanceVar)
{
  disable_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c20_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c20_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c20_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c20_FSAC2021();/* state var info */
  ...
  set_sim_state_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c20_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c20_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c20_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c20_FSAC2021(S, st);
}

static void sf_opaque_terminate_c20_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_FSAC2021((SFc20_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_FSAC2021(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c20_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c20_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_FSAC2021(SimStruct *S)
{
  SFc20_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc20_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc20_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c20_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c20_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c20_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c20_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c20_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c20_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c20_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c20_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c20_FSAC2021;
...
void c20_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_FSAC2021_method_dispatcher.\n"
