...
static void initialize_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c3_FSAC2021(SFc3_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void disable_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_FSAC2021(SFc3_FSAC2021InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_FSAC2021(SFc3_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_FSAC2021
  (SFc3_FSAC2021InstanceStruct *chartInstance);
static void finalize_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void c3_chartstep_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void initSimStructsc3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance);
static void c3_AS_Driving(SFc3_FSAC2021InstanceStruct *chartInstance);
static void c3_AS_Emergency(SFc3_FSAC2021InstanceStruct *chartInstance);
static void c3_AS_Finished(SFc3_FSAC2021InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_b_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_b_tp_AS_Driving, const char_T *c3_identifier);
static uint8_T c3_c_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint32_T c3_d_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_b_previousTicks, const char_T *c3_identifier);
static uint32_T c3_e_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static const mxArray *c3_f_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_FSAC2021 = 0U;
  chartInstance->c3_is_c3_FSAC2021 = c3_IN_NO_ACTIVE_CHILD;
  ...
  const mxArray *c3_st)
{
  ...
  *c3_Yellow_Light = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_FSAC2021 = c3_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 8)), "is_active_c3_FSAC2021");
  chartInstance->c3_is_c3_FSAC2021 = c3_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 9)), "is_c3_FSAC2021");
  ...
  c3_update_debugger_state_c3_FSAC2021(chartInstance);
...
static void sf_gateway_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c3_Yellow_Light = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_Blue_Light = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_set_sim_state_side_effects_c3_FSAC2021(chartInstance);
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_FSAC2021(chartInstance);
...
static void c3_chartstep_c3_FSAC2021(SFc3_FSAC2021InstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_FSAC2021 = 1U;
    ...
    chartInstance->c3_is_c3_FSAC2021 = c3_IN_AS_Off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_AS_Off = 1U;
    ...
    *c3_VCU_Valve = chartInstance->c3_ON;
    ...
    switch (chartInstance->c3_is_c3_FSAC2021) {
     ...
     case c3_IN_AS_Off:
      ...
      if (c3_out) {
        ...
        chartInstance->c3_tp_AS_Off = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_FSAC2021 = c3_IN_Manual_Driving;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_Manual_Driving = 1U;
        ...
        *c3_ASSI_State = chartInstance->c3_MANUAL_DRIVING;
        ...
        if (c3_b_out) {
          ...
          chartInstance->c3_tp_AS_Off = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_FSAC2021 = c3_IN_AS_Ready;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
          chartInstance->c3_temporalCounter_i1 = 0U;
          chartInstance->c3_tp_AS_Ready = 1U;
     ...
     case c3_IN_AS_Ready:
      ...
      if (c3_c_out) {
        ...
        chartInstance->c3_tp_AS_Ready = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_FSAC2021 = c3_IN_AS_Driving;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_AS_Driving = 1U;
        *c3_R2D = chartInstance->c3_ON;
        _SFD_DATA_RANGE_CHECK((real_T)*c3_R2D, 24U);
        ...
        if (c3_d_out) {
          ...
          *c3_VCU_Valve = chartInstance->c3_ON;
          ...
          if (c3_e_out) {
            ...
            chartInstance->c3_tp_AS_Ready = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
            chartInstance->c3_is_c3_FSAC2021 = c3_IN_AS_Emergency;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
            chartInstance->c3_tp_AS_Emergency = 1U;
...
static void c3_AS_Driving(SFc3_FSAC2021InstanceStruct *chartInstance)
{
  ...
  if (c3_out) {
    ...
    chartInstance->c3_tp_AS_Driving = 0U;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_FSAC2021 = c3_IN_AS_Finished;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_AS_Finished = 1U;
...
const mxArray *sf_c3_FSAC2021_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc3_FSAC2021InstanceStruct *)chartInstanceVoid;
...
void sf_c3_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[25],T\"ASSI_State\",},{M[1],M[24],T\"Blue_Light\",},{M[1],M[26],T\"Buzzer\",},{M[1],M[61],T\"R2D\",},{M[1],M[21],T\"Safety_Circuit_Relay\",},{M[1],M[23],T\"System_48V_Relay\",},{M[1],M[60],T\"VCU_Valve\",},{M[1],M[22],T\"Yellow_Light\",},{M[8],M[0],T\"is_active_c3_FSAC2021\",},{M[9],M[0],T\"is_c3_FSAC2021\",}}",
  ...
  sf_c3_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_FSAC2021InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
  initialize_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_FSAC2021(void *chartInstanceVar)
{
  enable_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_FSAC2021(void *chartInstanceVar)
{
  disable_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c3_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_FSAC2021();/* state var info */
  ...
  set_sim_state_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c3_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_FSAC2021(S, st);
}

static void sf_opaque_terminate_c3_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_FSAC2021((SFc3_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_FSAC2021(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_FSAC2021((SFc3_FSAC2021InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c3_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_FSAC2021(SimStruct *S)
{
  SFc3_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc3_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_FSAC2021;
...
void c3_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_FSAC2021_method_dispatcher.\n"
