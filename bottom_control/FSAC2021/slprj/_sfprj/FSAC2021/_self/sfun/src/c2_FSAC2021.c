...
static void initialize_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c2_FSAC2021(SFc2_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void disable_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_FSAC2021(SFc2_FSAC2021InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_FSAC2021(SFc2_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_FSAC2021
  (SFc2_FSAC2021InstanceStruct *chartInstance);
static void finalize_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void initSimStructsc2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int32_T c2_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_b_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_b_tp_Visuality_On, const char_T *c2_identifier);
static uint8_T c2_c_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_Visual_Lights, const char_T *c2_identifier, uint8_T c2_y[3]);
static void c2_e_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, uint8_T c2_y[3]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint32_T c2_f_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_b_previousTicks, const char_T *c2_identifier);
static uint32_T c2_g_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *c2_h_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c2_b_setSimStateSideEffectsInfo, const char_T
  *c2_identifier);
static const mxArray *c2_i_emlrt_marshallIn(SFc2_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_FSAC2021 = 0U;
  chartInstance->c2_is_c2_FSAC2021 = c2_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_FSAC2021;
  c2_c_u = c2_b_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 2, c2_d_y);
  c2_c_hoistedGlobal = chartInstance->c2_is_c2_FSAC2021;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_Visual_Flag = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_FSAC2021 = c2_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_active_c2_FSAC2021");
  chartInstance->c2_is_c2_FSAC2021 = c2_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "is_c2_FSAC2021");
  ...
  c2_update_debugger_state_c2_FSAC2021(chartInstance);
...
static void sf_gateway_c2_FSAC2021(SFc2_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c2_Visual_Flag = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c2_Visual_Lights = (uint8_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_set_sim_state_side_effects_c2_FSAC2021(chartInstance);
  ...
  if (chartInstance->c2_is_active_c2_FSAC2021 == 0U) {
    ...
    *c2_Visual_Flag = 1U;
    ...
    switch (chartInstance->c2_is_c2_FSAC2021) {
     ...
     case c2_IN_Visuality_On:
      ...
      if (c2_out) {
        ...
        chartInstance->c2_tp_Visuality_On = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_FSAC2021 = c2_IN_Visuality_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_tp_Visuality_Off = 1U;
...
const mxArray *sf_c2_FSAC2021_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc2_FSAC2021InstanceStruct *)chartInstanceVoid;
...
void sf_c2_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[6],T\"Visual_Flag\",},{M[1],M[5],T\"Visual_Lights\",},{M[8],M[0],T\"is_active_c2_FSAC2021\",},{M[9],M[0],T\"is_c2_FSAC2021\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[1],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_FSAC2021InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
  initialize_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_FSAC2021(void *chartInstanceVar)
{
  enable_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_FSAC2021(void *chartInstanceVar)
{
  disable_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c2_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_FSAC2021();/* state var info */
  ...
  set_sim_state_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c2_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_FSAC2021(S, st);
}

static void sf_opaque_terminate_c2_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_FSAC2021((SFc2_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_FSAC2021(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_FSAC2021((SFc2_FSAC2021InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c2_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_FSAC2021(SimStruct *S)
{
  SFc2_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc2_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_FSAC2021;
...
void c2_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_FSAC2021_method_dispatcher.\n"
