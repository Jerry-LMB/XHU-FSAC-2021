...
static void initialize_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c22_FSAC2021(SFc22_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance);
static void disable_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance);
static void c22_update_debugger_state_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c22_FSAC2021(SFc22_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c22_FSAC2021(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_st);
static void c22_set_sim_state_side_effects_c22_FSAC2021
  (SFc22_FSAC2021InstanceStruct *chartInstance);
static void finalize_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance);
static void initSimStructsc22_FSAC2021(SFc22_FSAC2021InstanceStruct
  *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct *chartInstance,
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static uint8_T c22_b_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_b_tp_RunMode, const char_T *c22_identifier);
static uint8_T c22_c_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
...
static const mxArray *c22_c_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real32_T c22_d_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
...
static const mxArray *c22_d_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static uint32_T c22_e_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_b_previousTicks, const char_T
  *c22_identifier);
static uint32_T c22_f_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static const mxArray *c22_g_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_b_setSimStateSideEffectsInfo, const char_T *
  c22_identifier);
static const mxArray *c22_h_emlrt_marshallIn(SFc22_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void init_dsm_address_info(SFc22_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_FSAC2021 = 0U;
  chartInstance->c22_is_c22_FSAC2021 = c22_IN_NO_ACTIVE_CHILD;
  ...
  chartInstance)
{
  ...
  if (chartInstance->c22_is_active_c22_FSAC2021 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 20U, chartInstance->c22_sfEvent);
  }

  if (chartInstance->c22_is_c22_FSAC2021 == c22_IN_RunMode) {
  ...
  if (chartInstance->c22_is_c22_FSAC2021 == c22_IN_Idle) {
  ...
  *chartInstance)
{
  ...
  c22_c_hoistedGlobal = chartInstance->c22_is_active_c22_FSAC2021;
  ...
  c22_d_hoistedGlobal = chartInstance->c22_is_c22_FSAC2021;
  ...
  *chartInstance, const mxArray *c22_st)
{
  ...
  *c22_Brk_Ctrl_State = c22_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c22_is_active_c22_FSAC2021 = c22_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 2)),
     "is_active_c22_FSAC2021");
  chartInstance->c22_is_c22_FSAC2021 = c22_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c22_u, 3)), "is_c22_FSAC2021");
  ...
  c22_update_debugger_state_c22_FSAC2021(chartInstance);
...
static void sf_gateway_c22_FSAC2021(SFc22_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c22_set_sim_state_side_effects_c22_FSAC2021(chartInstance);
  ...
  if (chartInstance->c22_is_active_c22_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 20U, chartInstance->c22_sfEvent);
    chartInstance->c22_is_active_c22_FSAC2021 = 1U;
    ...
    chartInstance->c22_is_c22_FSAC2021 = c22_IN_Idle;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
    chartInstance->c22_tp_Idle = 1U;
  } else {
    switch (chartInstance->c22_is_c22_FSAC2021) {
     case c22_IN_Idle:
      CV_CHART_EVAL(20, 0, 1);
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, chartInstance->c22_sfEvent);
      chartInstance->c22_tp_Idle = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
      chartInstance->c22_is_c22_FSAC2021 = c22_IN_RunMode;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c22_sfEvent);
      chartInstance->c22_tp_RunMode = 1U;
...
const mxArray *sf_c22_FSAC2021_get_eml_resolved_functions_info(void)
{
  ...
  *c22_inData)
{
  ...
  const mxArray *c22_y = NULL;
  SFc22_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc22_FSAC2021InstanceStruct *)chartInstanceVoid;
...
void sf_c22_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c22_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c22_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c22_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c22_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[54],T\"Allow_Ctrl_Flg\",},{M[1],M[57],T\"Brk_Ctrl_State\",},{M[8],M[0],T\"is_active_c22_FSAC2021\",},{M[9],M[0],T\"is_c22_FSAC2021\",},{M[9],M[9],T\"is_RunMode\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[88],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc22_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c22_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_FSAC2021InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*)
    chartInstanceVar);
  initialize_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c22_FSAC2021(void *chartInstanceVar)
{
  enable_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_FSAC2021(void *chartInstanceVar)
{
  disable_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c22_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c22_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c22_FSAC2021();/* state var info */
  ...
  set_sim_state_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c22_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c22_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c22_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c22_FSAC2021(S, st);
}

static void sf_opaque_terminate_c22_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc22_FSAC2021((SFc22_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_FSAC2021(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c22_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c22_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_FSAC2021(SimStruct *S)
{
  SFc22_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc22_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc22_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c22_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c22_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c22_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c22_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c22_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c22_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_FSAC2021;
...
void c22_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_FSAC2021_method_dispatcher.\n"
