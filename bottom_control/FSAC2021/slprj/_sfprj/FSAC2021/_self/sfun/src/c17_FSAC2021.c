...
static void initialize_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c17_FSAC2021(SFc17_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance);
static void disable_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c17_FSAC2021(SFc17_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c17_FSAC2021(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_st);
static void c17_set_sim_state_side_effects_c17_FSAC2021
  (SFc17_FSAC2021InstanceStruct *chartInstance);
static void finalize_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance);
static void c17_chartstep_c17_FSAC2021(SFc17_FSAC2021InstanceStruct
  *chartInstance);
static void initSimStructsc17_FSAC2021(SFc17_FSAC2021InstanceStruct
  *chartInstance);
static void c17_enter_atomic_Off(SFc17_FSAC2021InstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct *chartInstance,
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static boolean_T c17_b_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_c_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
...
static const mxArray *c17_d_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static uint8_T c17_d_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_b_tp_On, const char_T *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint32_T c17_f_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_b_previousTicks, const char_T
  *c17_identifier);
static uint32_T c17_g_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static const mxArray *c17_h_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_b_setSimStateSideEffectsInfo, const char_T *
  c17_identifier);
static const mxArray *c17_i_emlrt_marshallIn(SFc17_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_updateDataWrittenToVector(SFc17_FSAC2021InstanceStruct
  *chartInstance, uint32_T c17_vectorIndex);
static void c17_errorIfDataNotWrittenToFcn(SFc17_FSAC2021InstanceStruct
  *chartInstance, uint32_T c17_vectorIndex, uint32_T c17_dataNumber);
static void init_dsm_address_info(SFc17_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_FSAC2021 = 0U;
  chartInstance->c17_is_c17_FSAC2021 = c17_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  c17_b_hoistedGlobal = chartInstance->c17_is_active_c17_FSAC2021;
  ...
  c17_c_hoistedGlobal = chartInstance->c17_is_c17_FSAC2021;
  ...
  *chartInstance, const mxArray *c17_st)
{
  ...
  *c17_Debounce = c17_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c17_is_active_c17_FSAC2021 = c17_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_FSAC2021");
  chartInstance->c17_is_c17_FSAC2021 = c17_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c17_u, 2)), "is_c17_FSAC2021");
  ...
  c17_update_debugger_state_c17_FSAC2021(chartInstance);
...
static void sf_gateway_c17_FSAC2021(SFc17_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c17_set_sim_state_side_effects_c17_FSAC2021(chartInstance);
  ...
  chartInstance->c17_sfEvent = CALL_EVENT;
  c17_chartstep_c17_FSAC2021(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c17_is_active_c17_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 15U, chartInstance->c17_sfEvent);
    chartInstance->c17_is_active_c17_FSAC2021 = 1U;
    ...
    chartInstance->c17_is_c17_FSAC2021 = c17_IN_Off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c17_sfEvent);
    chartInstance->c17_tp_Off = 1U;
    c17_enter_atomic_Off(chartInstance);
  } else {
    switch (chartInstance->c17_is_c17_FSAC2021) {
     case c17_IN_Off:
      ...
      if (c17_out) {
        ...
        chartInstance->c17_tp_Off = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c17_sfEvent);
        chartInstance->c17_is_c17_FSAC2021 = c17_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c17_sfEvent);
        chartInstance->c17_temporalCounter_i1 = 0U;
        chartInstance->c17_tp_Wait = 1U;
      } else {
     ...
     case c17_IN_Wait:
      ...
      if (c17_c_out) {
        ...
        if (c17_d_out) {
          ...
          chartInstance->c17_tp_Wait = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c17_sfEvent);
          chartInstance->c17_is_c17_FSAC2021 = c17_IN_On;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c17_sfEvent);
          chartInstance->c17_tp_On = 1U;
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc17_FSAC2021InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_FSAC2021_get_eml_resolved_functions_info(void)
{
...
void sf_c17_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c17_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c17_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c17_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[2],T\"Debounce\",},{M[8],M[0],T\"is_active_c17_FSAC2021\",},{M[9],M[0],T\"is_c17_FSAC2021\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[6],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c17_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_FSAC2021InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*)
    chartInstanceVar);
  initialize_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_FSAC2021(void *chartInstanceVar)
{
  enable_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_FSAC2021(void *chartInstanceVar)
{
  disable_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c17_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c17_FSAC2021();/* state var info */
  ...
  set_sim_state_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c17_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c17_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c17_FSAC2021(S, st);
}

static void sf_opaque_terminate_c17_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_FSAC2021((SFc17_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_FSAC2021(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c17_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c17_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_FSAC2021(SimStruct *S)
{
  SFc17_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc17_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c17_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c17_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c17_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c17_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c17_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c17_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c17_FSAC2021;
...
void c17_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_FSAC2021_method_dispatcher.\n"
