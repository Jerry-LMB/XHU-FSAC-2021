...
static void initialize_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c5_FSAC2021(SFc5_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void disable_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_FSAC2021(SFc5_FSAC2021InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_FSAC2021(SFc5_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_st);
static void c5_set_sim_state_side_effects_c5_FSAC2021
  (SFc5_FSAC2021InstanceStruct *chartInstance);
static void finalize_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void c5_chartstep_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void initSimStructsc5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_nargout, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static boolean_T c5_c_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_b_tp_Task, const char_T *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_g_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_h_emlrt_marshallIn(SFc5_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_updateDataWrittenToVector(SFc5_FSAC2021InstanceStruct
  *chartInstance, uint32_T c5_vectorIndex);
static void init_dsm_address_info(SFc5_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_FSAC2021 = 0U;
  chartInstance->c5_is_c5_FSAC2021 = c5_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_FSAC2021;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = chartInstance->c5_is_c5_FSAC2021;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_MODE = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "MODE");
  chartInstance->c5_is_active_c5_FSAC2021 = c5_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_FSAC2021");
  chartInstance->c5_is_c5_FSAC2021 = c5_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 2)), "is_c5_FSAC2021");
  ...
  c5_update_debugger_state_c5_FSAC2021(chartInstance);
...
static void sf_gateway_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c5_set_sim_state_side_effects_c5_FSAC2021(chartInstance);
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_FSAC2021(chartInstance);
...
static void c5_chartstep_c5_FSAC2021(SFc5_FSAC2021InstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c5_is_active_c5_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 3U, chartInstance->c5_sfEvent);
    chartInstance->c5_is_active_c5_FSAC2021 = 1U;
    ...
    chartInstance->c5_is_c5_FSAC2021 = c5_IN_init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c5_sfEvent);
    chartInstance->c5_tp_init = 1U;
  } else {
    switch (chartInstance->c5_is_c5_FSAC2021) {
     ...
     case c5_IN_Manul:
      ...
      if (c5_out) {
        ...
        chartInstance->c5_tp_Manul = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c5_sfEvent);
        chartInstance->c5_is_c5_FSAC2021 = c5_IN_Driverless;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c5_sfEvent);
        chartInstance->c5_tp_Driverless = 1U;
      } else {
     ...
     case c5_IN_init:
      ...
      if (c5_b_out) {
        ...
        chartInstance->c5_tp_init = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c5_sfEvent);
        chartInstance->c5_is_c5_FSAC2021 = c5_IN_Manul;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c5_sfEvent);
        chartInstance->c5_tp_Manul = 1U;
      } else {
        ...
        if (c5_c_out) {
          ...
          if (c5_d_out) {
            ...
            chartInstance->c5_tp_init = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c5_sfEvent);
            chartInstance->c5_is_c5_FSAC2021 = c5_IN_Task;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c5_sfEvent);
            chartInstance->c5_tp_Task = 1U;
          } else {
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc5_FSAC2021InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_FSAC2021_get_eml_resolved_functions_info(void)
{
...
void sf_c5_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[13],T\"MODE\",},{M[8],M[0],T\"is_active_c5_FSAC2021\",},{M[9],M[0],T\"is_c5_FSAC2021\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c5_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_FSAC2021InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
  initialize_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_FSAC2021(void *chartInstanceVar)
{
  enable_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_FSAC2021(void *chartInstanceVar)
{
  disable_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c5_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_FSAC2021();/* state var info */
  ...
  set_sim_state_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c5_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_FSAC2021(S, st);
}

static void sf_opaque_terminate_c5_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_FSAC2021((SFc5_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_FSAC2021(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_FSAC2021((SFc5_FSAC2021InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_FSAC2021(SimStruct *S)
{
  SFc5_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc5_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_FSAC2021;
...
void c5_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_FSAC2021_method_dispatcher.\n"
