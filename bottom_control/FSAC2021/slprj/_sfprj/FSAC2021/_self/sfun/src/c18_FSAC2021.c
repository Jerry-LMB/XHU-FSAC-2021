...
static void initialize_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance);
static void initialize_params_c18_FSAC2021(SFc18_FSAC2021InstanceStruct
  *chartInstance);
static void enable_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance);
static void disable_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c18_FSAC2021(SFc18_FSAC2021InstanceStruct
  *chartInstance);
static void set_sim_state_c18_FSAC2021(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_st);
static void c18_set_sim_state_side_effects_c18_FSAC2021
  (SFc18_FSAC2021InstanceStruct *chartInstance);
static void finalize_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance);
static void sf_gateway_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance);
static void c18_chartstep_c18_FSAC2021(SFc18_FSAC2021InstanceStruct
  *chartInstance);
static void initSimStructsc18_FSAC2021(SFc18_FSAC2021InstanceStruct
  *chartInstance);
static void c18_enter_atomic_Off(SFc18_FSAC2021InstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct *chartInstance,
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static boolean_T c18_b_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
...
static const mxArray *c18_c_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
...
static const mxArray *c18_d_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_b_tp_On, const char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint32_T c18_f_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_b_previousTicks, const char_T
  *c18_identifier);
static uint32_T c18_g_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static const mxArray *c18_h_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_b_setSimStateSideEffectsInfo, const char_T *
  c18_identifier);
static const mxArray *c18_i_emlrt_marshallIn(SFc18_FSAC2021InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_updateDataWrittenToVector(SFc18_FSAC2021InstanceStruct
  *chartInstance, uint32_T c18_vectorIndex);
static void c18_errorIfDataNotWrittenToFcn(SFc18_FSAC2021InstanceStruct
  *chartInstance, uint32_T c18_vectorIndex, uint32_T c18_dataNumber);
static void init_dsm_address_info(SFc18_FSAC2021InstanceStruct *chartInstance);
...
static void initialize_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_FSAC2021 = 0U;
  chartInstance->c18_is_c18_FSAC2021 = c18_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_FSAC2021;
  ...
  c18_c_hoistedGlobal = chartInstance->c18_is_c18_FSAC2021;
  ...
  *chartInstance, const mxArray *c18_st)
{
  ...
  *c18_Debounce = c18_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c18_is_active_c18_FSAC2021 = c18_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_FSAC2021");
  chartInstance->c18_is_c18_FSAC2021 = c18_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c18_u, 2)), "is_c18_FSAC2021");
  ...
  c18_update_debugger_state_c18_FSAC2021(chartInstance);
...
static void sf_gateway_c18_FSAC2021(SFc18_FSAC2021InstanceStruct *chartInstance)
{
  ...
  c18_set_sim_state_side_effects_c18_FSAC2021(chartInstance);
  ...
  chartInstance->c18_sfEvent = CALL_EVENT;
  c18_chartstep_c18_FSAC2021(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c18_is_active_c18_FSAC2021 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U, chartInstance->c18_sfEvent);
    chartInstance->c18_is_active_c18_FSAC2021 = 1U;
    ...
    chartInstance->c18_is_c18_FSAC2021 = c18_IN_Off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c18_sfEvent);
    chartInstance->c18_tp_Off = 1U;
    c18_enter_atomic_Off(chartInstance);
  } else {
    switch (chartInstance->c18_is_c18_FSAC2021) {
     case c18_IN_Off:
      ...
      if (c18_out) {
        ...
        chartInstance->c18_tp_Off = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c18_sfEvent);
        chartInstance->c18_is_c18_FSAC2021 = c18_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c18_sfEvent);
        chartInstance->c18_temporalCounter_i1 = 0U;
        chartInstance->c18_tp_Wait = 1U;
      } else {
     ...
     case c18_IN_Wait:
      ...
      if (c18_c_out) {
        ...
        if (c18_d_out) {
          ...
          chartInstance->c18_tp_Wait = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c18_sfEvent);
          chartInstance->c18_is_c18_FSAC2021 = c18_IN_On;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c18_sfEvent);
          chartInstance->c18_tp_On = 1U;
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_FSAC2021InstanceStruct *chartInstance;
  chartInstance = (SFc18_FSAC2021InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_FSAC2021_get_eml_resolved_functions_info(void)
{
...
void sf_c18_FSAC2021_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_FSAC2021_get_autoinheritance_info(void)
{
...
mxArray *sf_c18_FSAC2021_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_FSAC2021_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c18_FSAC2021(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[2],T\"Debounce\",},{M[8],M[0],T\"is_active_c18_FSAC2021\",},{M[9],M[0],T\"is_c18_FSAC2021\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[6],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_FSAC2021_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_FSAC2021InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c18_FSAC2021(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_FSAC2021InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*)
    chartInstanceVar);
  initialize_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_FSAC2021(void *chartInstanceVar)
{
  enable_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_FSAC2021(void *chartInstanceVar)
{
  disable_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c18_FSAC2021(void *chartInstanceVar)
{
  sf_gateway_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_FSAC2021(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_FSAC2021();/* state var info */
...
extern void sf_internal_set_sim_state_c18_FSAC2021(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c18_FSAC2021();/* state var info */
  ...
  set_sim_state_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_FSAC2021(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_FSAC2021(S);
}

static void sf_opaque_set_sim_state_c18_FSAC2021(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c18_FSAC2021(S, st);
}

static void sf_opaque_terminate_c18_FSAC2021(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_FSAC2021InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_FSAC2021((SFc18_FSAC2021InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_FSAC2021(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_FSAC2021(SimStruct *S)
{
...
static void mdlRTW_c18_FSAC2021(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_FSAC2021(SimStruct *S)
{
  SFc18_FSAC2021InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_FSAC2021InstanceStruct *)utMalloc(sizeof
    (SFc18_FSAC2021InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_FSAC2021InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c18_FSAC2021;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c18_FSAC2021;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c18_FSAC2021;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_FSAC2021;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_FSAC2021;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c18_FSAC2021;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c18_FSAC2021;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c18_FSAC2021;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_FSAC2021;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_FSAC2021;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c18_FSAC2021;
...
void c18_FSAC2021_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_FSAC2021(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_FSAC2021(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_FSAC2021(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_FSAC2021_method_dispatcher.\n"
