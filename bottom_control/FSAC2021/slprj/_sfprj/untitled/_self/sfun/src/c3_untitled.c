...
#define c3_IN_B                        ((uint8_T)2U)
#define c3_IN_E                        ((uint8_T)3U)
#define c3_IN_F                        ((uint8_T)4U)
#define c3_IN_C                        ((uint8_T)1U)
#define c3_IN_D                        ((uint8_T)2U)
...
static void c3_exit_internal_B(SFc3_untitledInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static boolean_T c3_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_b_tp_C, const char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_f_emlrt_marshallIn(SFc3_untitledInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_untitledInstanceStruct
...
static void initialize_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_B = c3_IN_NO_ACTIVE_CHILD;
  chartInstance->c3_tp_B = 0U;
  chartInstance->c3_tp_C = 0U;
  chartInstance->c3_tp_D = 0U;
  chartInstance->c3_tp_E = 0U;
  chartInstance->c3_tp_F = 0U;
  ...
  *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_c3_untitled;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = chartInstance->c3_is_B;
  ...
  const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_untitled = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 0)), "is_active_c3_untitled");
  chartInstance->c3_is_c3_untitled = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_c3_untitled");
  chartInstance->c3_is_B = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 2)), "is_B");
  ...
  (SFc3_untitledInstanceStruct *chartInstance)
{
  if (chartInstance->c3_doSetSimStateSideEffects != 0) {
    ...
    if (chartInstance->c3_is_B == c3_IN_C) {
      chartInstance->c3_tp_C = 1U;
    } else {
      chartInstance->c3_tp_C = 0U;
    }

    if (chartInstance->c3_is_B == c3_IN_D) {
      chartInstance->c3_tp_D = 1U;
    } else {
      chartInstance->c3_tp_D = 0U;
    }

    if (chartInstance->c3_is_c3_untitled == c3_IN_E) {
      chartInstance->c3_tp_E = 1U;
    } else {
      chartInstance->c3_tp_E = 0U;
    }

    if (chartInstance->c3_is_c3_untitled == c3_IN_F) {
      chartInstance->c3_tp_F = 1U;
    } else {
      chartInstance->c3_tp_F = 0U;
    }
...
{
  real_T *c3_a;
  c3_a = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c3_set_sim_state_side_effects_c3_untitled(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_a, 0U);
  chartInstance->c3_sfEvent = CALL_EVENT;
...
static void c3_chartstep_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_untitled == 0U) {
    ...
    chartInstance->c3_is_c3_untitled = c3_IN_A;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_A = 1U;
  } else {
    switch (chartInstance->c3_is_c3_untitled) {
     case c3_IN_A:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_out, 2U, c3_sf_marshallOut,
        c3_sf_marshallIn);
      c3_out = CV_EML_IF(0, 0, 0, *c3_a == 0.0);
      _SFD_SYMBOL_SCOPE_POP();
      if (c3_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_A = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_untitled = c3_IN_B;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_B = 1U;
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_B = c3_IN_C;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_C = 1U;
      } else {
     ...
     case c3_IN_B:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_out, 2U, c3_sf_marshallOut,
        c3_sf_marshallIn);
      c3_b_out = CV_EML_IF(6, 0, 0, *c3_a == 1.0);
      _SFD_SYMBOL_SCOPE_POP();
      guard1 = false;
      if (c3_b_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 6U, chartInstance->c3_sfEvent);
        c3_exit_internal_B(chartInstance);
        chartInstance->c3_tp_B = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_untitled = c3_IN_A;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        ...
        switch (chartInstance->c3_is_B) {
         case c3_IN_C:
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_c_out, 2U, c3_sf_marshallOut,
            c3_sf_marshallIn);
          c3_c_out = CV_EML_IF(2, 0, 0, *c3_a == 4.0);
          _SFD_SYMBOL_SCOPE_POP();
          if (c3_c_out) {
            _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
            chartInstance->c3_tp_C = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
            chartInstance->c3_is_B = c3_IN_D;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
            chartInstance->c3_tp_D = 1U;
          } else {
         ...
         case c3_IN_D:
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_d_out, 2U, c3_sf_marshallOut,
            c3_sf_marshallIn);
          c3_d_out = CV_EML_IF(3, 0, 0, *c3_a == 3.0);
          _SFD_SYMBOL_SCOPE_POP();
          if (c3_d_out) {
            ...
            chartInstance->c3_tp_B = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
            chartInstance->c3_is_c3_untitled = c3_IN_E;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
            chartInstance->c3_tp_E = 1U;
          } else {
            ...
            c3_e_out = CV_EML_IF(4, 0, 0, *c3_a == 2.0);
            _SFD_SYMBOL_SCOPE_POP();
            if (c3_e_out) {
              ...
              chartInstance->c3_tp_B = 0U;
              _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
              chartInstance->c3_is_c3_untitled = c3_IN_F;
              _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c3_sfEvent);
              chartInstance->c3_tp_F = 1U;
            } else {
  ...
  const mxArray *c3_b_tp_C, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_C), &c3_thisId);
  sf_mex_destroy(&c3_b_tp_C);
  return c3_y;
}
...
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_b_tp_C;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_y;
  SFc3_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc3_untitledInstanceStruct *)chartInstanceVoid;
  c3_b_tp_C = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_C), &c3_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1071151372U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3250800361U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2352326925U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1465276905U);
}
...
mxArray *sf_c3_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("i6Y3dGpFxfNqlBkyuCdF8D");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c3_untitled\",},{M[9],M[0],T\"is_c3_untitled\",},{M[9],M[3],T\"is_B\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_untitledInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,0,0,1,7,1,7);
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_untitled();/* state var info */
...
static void mdlSetWorkWidths_c3_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2439342999U));
  ssSetChecksum1(S,(2467203821U));
  ssSetChecksum2(S,(2627772193U));
  ssSetChecksum3(S,(4293810073U));
