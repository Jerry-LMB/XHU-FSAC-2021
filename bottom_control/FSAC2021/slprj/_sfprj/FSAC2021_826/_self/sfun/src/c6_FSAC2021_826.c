...
static void initialize_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void initialize_params_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void enable_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void disable_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_FSAC2021_826
  (SFc6_FSAC2021_826InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_FSAC2021_826
  (SFc6_FSAC2021_826InstanceStruct *chartInstance);
static void set_sim_state_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_st);
static void c6_set_sim_state_side_effects_c6_FSAC2021_826
  (SFc6_FSAC2021_826InstanceStruct *chartInstance);
static void finalize_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void sf_gateway_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void c6_chartstep_c6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void initSimStructsc6_FSAC2021_826(SFc6_FSAC2021_826InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static boolean_T c6_b_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_b_tp_Normal, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint32_T c6_f_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_b_previousTicks, const char_T *c6_identifier);
static uint32_T c6_g_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static const mxArray *c6_h_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_b_setSimStateSideEffectsInfo, const char_T
  *c6_identifier);
static const mxArray *c6_i_emlrt_marshallIn(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_updateDataWrittenToVector(SFc6_FSAC2021_826InstanceStruct
  *chartInstance, uint32_T c6_vectorIndex);
static void init_dsm_address_info(SFc6_FSAC2021_826InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_tp_On = 0U;
  chartInstance->c6_is_active_c6_FSAC2021_826 = 0U;
  chartInstance->c6_is_c6_FSAC2021_826 = c6_IN_NO_ACTIVE_CHILD;
  ...
  (SFc6_FSAC2021_826InstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_FSAC2021_826;
  c6_b_u = c6_b_hoistedGlobal;
  c6_c_y = NULL;
  sf_mex_assign(&c6_c_y, sf_mex_create("y", &c6_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c6_y, 1, c6_c_y);
  c6_c_hoistedGlobal = chartInstance->c6_is_c6_FSAC2021_826;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_Output = c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c6_u, 0)), "Output");
  chartInstance->c6_is_active_c6_FSAC2021_826 = c6_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_FSAC2021_826");
  chartInstance->c6_is_c6_FSAC2021_826 = c6_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 2)), "is_c6_FSAC2021_826");
  ...
  c6_update_debugger_state_c6_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  c6_set_sim_state_side_effects_c6_FSAC2021_826(chartInstance);
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c6_is_active_c6_FSAC2021_826 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 4U, chartInstance->c6_sfEvent);
    chartInstance->c6_is_active_c6_FSAC2021_826 = 1U;
    ...
    chartInstance->c6_is_c6_FSAC2021_826 = c6_IN_Normal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c6_sfEvent);
    chartInstance->c6_tp_Normal = 1U;
    ...
    *c6_Output = 1U;
    ...
    switch (chartInstance->c6_is_c6_FSAC2021_826) {
     case c6_IN_Normal:
      CV_CHART_EVAL(4, 0, 1);
      ...
      if (c6_out) {
        ...
        chartInstance->c6_tp_Normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c6_sfEvent);
        chartInstance->c6_is_c6_FSAC2021_826 = c6_IN_ON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c6_sfEvent);
        chartInstance->c6_temporalCounter_i1 = 0U;
        chartInstance->c6_tp_ON = 1U;
      } else {
     ...
     case c6_IN_ON:
      ...
      if (c6_b_out) {
        ...
        chartInstance->c6_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c6_sfEvent);
        chartInstance->c6_is_c6_FSAC2021_826 = c6_IN_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c6_sfEvent);
        chartInstance->c6_tp_Off = 1U;
      } else {
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_FSAC2021_826InstanceStruct *chartInstance;
  chartInstance = (SFc6_FSAC2021_826InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_FSAC2021_826_get_eml_resolved_functions_info(void)
{
...
void sf_c6_FSAC2021_826_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_FSAC2021_826_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_FSAC2021_826_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_FSAC2021_826_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_FSAC2021_826(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[24],T\"Output\",},{M[8],M[0],T\"is_active_c6_FSAC2021_826\",},{M[9],M[0],T\"is_c6_FSAC2021_826\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_FSAC2021_826_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_FSAC2021_826InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c6_FSAC2021_826(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_FSAC2021_826InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
  initialize_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_FSAC2021_826(void *chartInstanceVar)
{
  enable_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_FSAC2021_826(void *chartInstanceVar)
{
  disable_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_FSAC2021_826(void *chartInstanceVar)
{
  sf_gateway_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_FSAC2021_826(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_FSAC2021_826
    ((SFc6_FSAC2021_826InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_FSAC2021_826();/* state var info */
...
extern void sf_internal_set_sim_state_c6_FSAC2021_826(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_FSAC2021_826();/* state var info */
  ...
  set_sim_state_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_FSAC2021_826(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_FSAC2021_826(S);
}

static void sf_opaque_set_sim_state_c6_FSAC2021_826(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c6_FSAC2021_826(S, st);
}

static void sf_opaque_terminate_c6_FSAC2021_826(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_FSAC2021_826((SFc6_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_FSAC2021_826(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_FSAC2021_826(SimStruct *S)
{
...
static void mdlRTW_c6_FSAC2021_826(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_FSAC2021_826(SimStruct *S)
{
  SFc6_FSAC2021_826InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_FSAC2021_826InstanceStruct *)utMalloc(sizeof
    (SFc6_FSAC2021_826InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_FSAC2021_826InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_FSAC2021_826;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_FSAC2021_826;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_FSAC2021_826;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_FSAC2021_826;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_FSAC2021_826;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_FSAC2021_826;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_FSAC2021_826;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_FSAC2021_826;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_FSAC2021_826;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_FSAC2021_826;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_FSAC2021_826;
...
void c6_FSAC2021_826_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_FSAC2021_826(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_FSAC2021_826_method_dispatcher.\n"
