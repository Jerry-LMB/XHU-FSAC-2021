...
#define c22_IN_BRK_ENGAGED             ((uint8_T)1U)
#define c22_IN_Back                    ((uint8_T)2U)
#define c22_IN_BackOrigin              ((uint8_T)3U)
#define c22_IN_Init                    ((uint8_T)4U)
#define c22_IN_Move                    ((uint8_T)5U)
#define c22_IN_Stop                    ((uint8_T)6U)
...
static void initialize_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void initialize_params_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct *
  chartInstance);
static void enable_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void disable_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void c22_update_debugger_state_c22_FSAC2021_826
  (SFc22_FSAC2021_826InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c22_FSAC2021_826
  (SFc22_FSAC2021_826InstanceStruct *chartInstance);
static void set_sim_state_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_st);
static void c22_set_sim_state_side_effects_c22_FSAC2021_826
  (SFc22_FSAC2021_826InstanceStruct *chartInstance);
static void finalize_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void sf_gateway_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void c22_chartstep_c22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
static void initSimStructsc22_FSAC2021_826(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static uint8_T c22_b_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_b_tp_Idle, const char_T *c22_identifier);
static uint8_T c22_c_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
...
static const mxArray *c22_c_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real32_T c22_d_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
...
static const mxArray *c22_d_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static uint32_T c22_e_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_b_previousTicks, const char_T
  *c22_identifier);
static uint32_T c22_f_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static const mxArray *c22_g_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_b_setSimStateSideEffectsInfo, const char_T *
  c22_identifier);
static const mxArray *c22_h_emlrt_marshallIn(SFc22_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void init_dsm_address_info(SFc22_FSAC2021_826InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c22_tp_BRK_ENGAGED = 0U;
  chartInstance->c22_tp_Back = 0U;
  ...
  chartInstance->c22_tp_Stop = 0U;
  chartInstance->c22_is_active_c22_FSAC2021_826 = 0U;
  chartInstance->c22_is_c22_FSAC2021_826 = c22_IN_NO_ACTIVE_CHILD;
  ...
  (SFc22_FSAC2021_826InstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c22_is_active_c22_FSAC2021_826 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 20U, chartInstance->c22_sfEvent);
  }

  if (chartInstance->c22_is_c22_FSAC2021_826 == c22_IN_Idle) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
  }

  if (chartInstance->c22_is_c22_FSAC2021_826 == c22_IN_RunMode) {
  ...
  if (chartInstance->c22_is_RunMode == c22_IN_Stop) {
  ...
  if (chartInstance->c22_is_RunMode == c22_IN_BRK_ENGAGED) {
  ...
  if (chartInstance->c22_is_RunMode == c22_IN_Back) {
  ...
  (SFc22_FSAC2021_826InstanceStruct *chartInstance)
{
  ...
  c22_c_hoistedGlobal = chartInstance->c22_is_active_c22_FSAC2021_826;
  ...
  c22_d_hoistedGlobal = chartInstance->c22_is_c22_FSAC2021_826;
  ...
  *chartInstance, const mxArray *c22_st)
{
  ...
  *c22_Brk_Ctrl_State = c22_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c22_is_active_c22_FSAC2021_826 = c22_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 2)),
     "is_active_c22_FSAC2021_826");
  chartInstance->c22_is_c22_FSAC2021_826 = c22_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c22_u, 3)), "is_c22_FSAC2021_826");
  ...
  c22_update_debugger_state_c22_FSAC2021_826(chartInstance);
  ...
  (SFc22_FSAC2021_826InstanceStruct *chartInstance)
{
  if (chartInstance->c22_doSetSimStateSideEffects != 0) {
    ...
    if (chartInstance->c22_is_RunMode == c22_IN_BRK_ENGAGED) {
      chartInstance->c22_tp_BRK_ENGAGED = 1U;
    } else {
      chartInstance->c22_tp_BRK_ENGAGED = 0U;
    }

    if (chartInstance->c22_is_RunMode == c22_IN_Back) {
      chartInstance->c22_tp_Back = 1U;
  ...
  *chartInstance)
{
  ...
  c22_set_sim_state_side_effects_c22_FSAC2021_826(chartInstance);
  ...
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, chartInstance->c22_sfEvent);
  ...
  chartInstance->c22_sfEvent = CALL_EVENT;
  c22_chartstep_c22_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  c22_Allow_Ctrl_Flg = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c22_Brk_Mtr_Enable_Flg = (uint8_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, chartInstance->c22_sfEvent);
  if (chartInstance->c22_is_active_c22_FSAC2021_826 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 20U, chartInstance->c22_sfEvent);
    chartInstance->c22_is_active_c22_FSAC2021_826 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, chartInstance->c22_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 3U, chartInstance->c22_sfEvent);
    chartInstance->c22_is_c22_FSAC2021_826 = c22_IN_Idle;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
    chartInstance->c22_tp_Idle = 1U;
  } else {
    switch (chartInstance->c22_is_c22_FSAC2021_826) {
     case c22_IN_Idle:
      CV_CHART_EVAL(20, 0, 1);
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c22_sfEvent);
      chartInstance->c22_tp_Idle = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c22_sfEvent);
      chartInstance->c22_is_c22_FSAC2021_826 = c22_IN_RunMode;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c22_sfEvent);
      chartInstance->c22_tp_RunMode = 1U;
      ...
      switch (chartInstance->c22_is_RunMode) {
       case c22_IN_BRK_ENGAGED:
        ...
        if (c22_out) {
          ...
          chartInstance->c22_tp_BRK_ENGAGED = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c22_sfEvent);
          chartInstance->c22_is_RunMode = c22_IN_Back;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c22_sfEvent);
          chartInstance->c22_temporalCounter_i1 = 0U;
          chartInstance->c22_tp_Back = 1U;
          *c22_Brk_Ctrl_State = 0U;
          _SFD_DATA_RANGE_CHECK((real_T)*c22_Brk_Ctrl_State, 4U);
          c22_u0 = *c22_Brk_Ctrl_State;
          sf_mex_printf("%s =\\n", "Brk_Ctrl_State");
          sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 9,
                            c22_u0);
        } else {
       ...
       case c22_IN_Back:
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 1U,
                     chartInstance->c22_sfEvent);
        c22_temp = (_SFD_CCP_CALL(1U, 0, 1 != 0U, chartInstance->c22_sfEvent) !=
                    0);
        if (c22_temp) {
          c22_temp = (_SFD_CCP_CALL(1U, 1, chartInstance->c22_temporalCounter_i1
            >= 2U != 0U, chartInstance->c22_sfEvent) != 0);
        }

        c22_b_out = (CV_TRANSITION_EVAL(1U, (int32_T)c22_temp) != 0);
        if (c22_b_out) {
       ...
       case c22_IN_BackOrigin:
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 5U,
                     chartInstance->c22_sfEvent);
        c22_b_temp = (_SFD_CCP_CALL(5U, 0, *c22_ASSI_State == 2 != 0U,
          chartInstance->c22_sfEvent) != 0);
        if (c22_b_temp) {
          c22_b_temp = (_SFD_CCP_CALL(5U, 1, *c22_Brk_Mtr_Origin_Flag == 1.0 !=
            0U, chartInstance->c22_sfEvent) != 0);
        }
        ...
        if (c22_c_out) {
          ...
          chartInstance->c22_tp_BackOrigin = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c22_sfEvent);
          chartInstance->c22_is_RunMode = c22_IN_Stop;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c22_sfEvent);
          chartInstance->c22_tp_Stop = 1U;
        } else {
          ...
          if (c22_d_out) {
            ...
            chartInstance->c22_tp_BackOrigin = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c22_sfEvent);
            chartInstance->c22_is_RunMode = c22_IN_BRK_ENGAGED;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c22_sfEvent);
            chartInstance->c22_tp_BRK_ENGAGED = 1U;
            *c22_Brk_Ctrl_State = 0U;
            _SFD_DATA_RANGE_CHECK((real_T)*c22_Brk_Ctrl_State, 4U);
            c22_u1 = *c22_Brk_Ctrl_State;
            sf_mex_printf("%s =\\n", "Brk_Ctrl_State");
            sf_mex_call_debug(sfGlobalDebugInstanceStruct, "disp", 0U, 1U, 9,
                              c22_u1);
          } else {
       ...
       case c22_IN_Init:
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U,
                     chartInstance->c22_sfEvent);
        c22_e_out = (CV_TRANSITION_EVAL(0U, (int32_T)_SFD_CCP_CALL(0U, 0,
          *c22_Brk_Mtr_Enable_Flg != 0U, chartInstance->c22_sfEvent)) != 0);
        if (c22_e_out) {
...
const mxArray *sf_c22_FSAC2021_826_get_eml_resolved_functions_info(void)
{
  ...
  *c22_inData)
{
  ...
  const mxArray *c22_y = NULL;
  SFc22_FSAC2021_826InstanceStruct *chartInstance;
  chartInstance = (SFc22_FSAC2021_826InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c22_b_tp_Idle, const char_T *c22_identifier)
{
  ...
  c22_thisId.fIdentifier = c22_identifier;
  c22_thisId.fParent = NULL;
  c22_y = c22_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c22_b_tp_Idle),
    &c22_thisId);
  sf_mex_destroy(&c22_b_tp_Idle);
  return c22_y;
}
  ...
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId)
{
  ...
  uint8_T c22_u2;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), &c22_u2, 1, 3, 0U, 0, 0U, 0);
  c22_y = c22_u2;
  sf_mex_destroy(&c22_u);
  return c22_y;
}
...
static void c22_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData)
{
  const mxArray *c22_b_tp_Idle;
  const char_T *c22_identifier;
  emlrtMsgIdentifier c22_thisId;
  uint8_T c22_y;
  SFc22_FSAC2021_826InstanceStruct *chartInstance;
  chartInstance = (SFc22_FSAC2021_826InstanceStruct *)chartInstanceVoid;
  c22_b_tp_Idle = sf_mex_dup(c22_mxArrayInData);
  c22_identifier = c22_varName;
  c22_thisId.fIdentifier = c22_identifier;
  c22_thisId.fParent = NULL;
  c22_y = c22_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c22_b_tp_Idle),
  ...
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId)
{
  ...
  uint32_T c22_u3;
  (void)chartInstance;
  sf_mex_import(c22_parentId, sf_mex_dup(c22_u), &c22_u3, 1, 7, 0U, 0, 0U, 0);
  c22_y = c22_u3;
  sf_mex_destroy(&c22_u);
  return c22_y;
}
...
void sf_c22_FSAC2021_826_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(302801772U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2474276252U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1797687493U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3558741245U);
}

mxArray *sf_c22_FSAC2021_826_get_autoinheritance_info(void)
{
...
mxArray *sf_c22_FSAC2021_826_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c22_FSAC2021_826_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c22_FSAC2021_826(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[54],T\"Allow_Ctrl_Flg\",},{M[1],M[57],T\"Brk_Ctrl_State\",},{M[8],M[0],T\"is_active_c22_FSAC2021_826\",},{M[9],M[0],T\"is_c22_FSAC2021_826\",},{M[9],M[9],T\"is_RunMode\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[82],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_FSAC2021_826_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc22_FSAC2021_826InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static unsigned int sEndGuardMap[] = { 14, 41 };
        ...
        {
          static unsigned int sStartGuardMap[] = { 11, 1 };
...
{
  return "eDqQnPlccJNwgyNBzKSYyC";
}

static void sf_opaque_initialize_c22_FSAC2021_826(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_FSAC2021_826InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
  initialize_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c22_FSAC2021_826(void *chartInstanceVar)
{
  enable_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_FSAC2021_826(void *chartInstanceVar)
{
  disable_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_FSAC2021_826(void *chartInstanceVar)
{
  sf_gateway_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c22_FSAC2021_826(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_FSAC2021_826
    ((SFc22_FSAC2021_826InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_FSAC2021_826();/* state var info */
...
extern void sf_internal_set_sim_state_c22_FSAC2021_826(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c22_FSAC2021_826();/* state var info */
  ...
  set_sim_state_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c22_FSAC2021_826(SimStruct* S)
{
  return sf_internal_get_sim_state_c22_FSAC2021_826(S);
}

static void sf_opaque_set_sim_state_c22_FSAC2021_826(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c22_FSAC2021_826(S, st);
}

static void sf_opaque_terminate_c22_FSAC2021_826(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_FSAC2021_826InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc22_FSAC2021_826((SFc22_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_FSAC2021_826(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c22_FSAC2021_826(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3128917977U));
  ssSetChecksum1(S,(389496227U));
  ssSetChecksum2(S,(1859483289U));
  ssSetChecksum3(S,(3793649522U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c22_FSAC2021_826(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_FSAC2021_826(SimStruct *S)
{
  SFc22_FSAC2021_826InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc22_FSAC2021_826InstanceStruct *)utMalloc(sizeof
    (SFc22_FSAC2021_826InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_FSAC2021_826InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c22_FSAC2021_826;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c22_FSAC2021_826;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c22_FSAC2021_826;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_FSAC2021_826;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_FSAC2021_826;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c22_FSAC2021_826;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c22_FSAC2021_826;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c22_FSAC2021_826;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_FSAC2021_826;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_FSAC2021_826;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_FSAC2021_826;
...
void c22_FSAC2021_826_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_FSAC2021_826(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_FSAC2021_826_method_dispatcher.\n"
