...
static void initialize_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void initialize_params_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct *
  chartInstance);
static void enable_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void disable_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void c21_update_debugger_state_c21_FSAC2021_826
  (SFc21_FSAC2021_826InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_FSAC2021_826
  (SFc21_FSAC2021_826InstanceStruct *chartInstance);
static void set_sim_state_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_st);
static void c21_set_sim_state_side_effects_c21_FSAC2021_826
  (SFc21_FSAC2021_826InstanceStruct *chartInstance);
static void finalize_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void sf_gateway_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void c21_chartstep_c21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
static void initSimStructsc21_FSAC2021_826(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static boolean_T c21_b_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
...
static const mxArray *c21_d_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_b_tp_Normal, const char_T *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint32_T c21_f_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_b_previousTicks, const char_T
  *c21_identifier);
static uint32_T c21_g_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static const mxArray *c21_h_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_b_setSimStateSideEffectsInfo, const char_T *
  c21_identifier);
static const mxArray *c21_i_emlrt_marshallIn(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_updateDataWrittenToVector(SFc21_FSAC2021_826InstanceStruct
  *chartInstance, uint32_T c21_vectorIndex);
static void init_dsm_address_info(SFc21_FSAC2021_826InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_tp_On = 0U;
  chartInstance->c21_is_active_c21_FSAC2021_826 = 0U;
  chartInstance->c21_is_c21_FSAC2021_826 = c21_IN_NO_ACTIVE_CHILD;
  ...
  (SFc21_FSAC2021_826InstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_FSAC2021_826;
  ...
  c21_c_hoistedGlobal = chartInstance->c21_is_c21_FSAC2021_826;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_Output = c21_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c21_u, 0)), "Output");
  chartInstance->c21_is_active_c21_FSAC2021_826 = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_FSAC2021_826");
  chartInstance->c21_is_c21_FSAC2021_826 = c21_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c21_u, 2)), "is_c21_FSAC2021_826");
  ...
  c21_update_debugger_state_c21_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  c21_set_sim_state_side_effects_c21_FSAC2021_826(chartInstance);
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c21_is_active_c21_FSAC2021_826 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 19U, chartInstance->c21_sfEvent);
    chartInstance->c21_is_active_c21_FSAC2021_826 = 1U;
    ...
    chartInstance->c21_is_c21_FSAC2021_826 = c21_IN_Normal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c21_sfEvent);
    chartInstance->c21_tp_Normal = 1U;
    ...
    *c21_Output = 1U;
    ...
    switch (chartInstance->c21_is_c21_FSAC2021_826) {
     case c21_IN_Normal:
      ...
      if (c21_out) {
        ...
        chartInstance->c21_tp_Normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c21_sfEvent);
        chartInstance->c21_is_c21_FSAC2021_826 = c21_IN_ON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c21_sfEvent);
        chartInstance->c21_temporalCounter_i1 = 0U;
        chartInstance->c21_tp_ON = 1U;
      } else {
     ...
     case c21_IN_ON:
      ...
      if (c21_b_out) {
        ...
        chartInstance->c21_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c21_sfEvent);
        chartInstance->c21_is_c21_FSAC2021_826 = c21_IN_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c21_sfEvent);
        chartInstance->c21_tp_Off = 1U;
      } else {
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_FSAC2021_826InstanceStruct *chartInstance;
  chartInstance = (SFc21_FSAC2021_826InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_FSAC2021_826_get_eml_resolved_functions_info(void)
{
...
void sf_c21_FSAC2021_826_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_FSAC2021_826_get_autoinheritance_info(void)
{
...
mxArray *sf_c21_FSAC2021_826_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c21_FSAC2021_826_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c21_FSAC2021_826(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[24],T\"Output\",},{M[8],M[0],T\"is_active_c21_FSAC2021_826\",},{M[9],M[0],T\"is_c21_FSAC2021_826\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_FSAC2021_826_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc21_FSAC2021_826InstanceStruct *)
...
static void sf_opaque_initialize_c21_FSAC2021_826(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_FSAC2021_826InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
  initialize_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c21_FSAC2021_826(void *chartInstanceVar)
{
  enable_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_FSAC2021_826(void *chartInstanceVar)
{
  disable_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_FSAC2021_826(void *chartInstanceVar)
{
  sf_gateway_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_FSAC2021_826(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_FSAC2021_826
    ((SFc21_FSAC2021_826InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_FSAC2021_826();/* state var info */
...
extern void sf_internal_set_sim_state_c21_FSAC2021_826(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c21_FSAC2021_826();/* state var info */
  ...
  set_sim_state_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_FSAC2021_826(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_FSAC2021_826(S);
}

static void sf_opaque_set_sim_state_c21_FSAC2021_826(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c21_FSAC2021_826(S, st);
}

static void sf_opaque_terminate_c21_FSAC2021_826(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_FSAC2021_826InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc21_FSAC2021_826((SFc21_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_FSAC2021_826(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_FSAC2021_826(SimStruct *S)
{
...
static void mdlRTW_c21_FSAC2021_826(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_FSAC2021_826(SimStruct *S)
{
  SFc21_FSAC2021_826InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc21_FSAC2021_826InstanceStruct *)utMalloc(sizeof
    (SFc21_FSAC2021_826InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_FSAC2021_826InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_FSAC2021_826;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_FSAC2021_826;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_FSAC2021_826;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_FSAC2021_826;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_FSAC2021_826;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_FSAC2021_826;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_FSAC2021_826;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_FSAC2021_826;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_FSAC2021_826;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_FSAC2021_826;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_FSAC2021_826;
...
void c21_FSAC2021_826_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_FSAC2021_826(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_FSAC2021_826_method_dispatcher.\n"
