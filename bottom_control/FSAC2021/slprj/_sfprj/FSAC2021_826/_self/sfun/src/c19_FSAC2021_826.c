...
static void initialize_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void initialize_params_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct *
  chartInstance);
static void enable_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void disable_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void c19_update_debugger_state_c19_FSAC2021_826
  (SFc19_FSAC2021_826InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_FSAC2021_826
  (SFc19_FSAC2021_826InstanceStruct *chartInstance);
static void set_sim_state_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_st);
static void c19_set_sim_state_side_effects_c19_FSAC2021_826
  (SFc19_FSAC2021_826InstanceStruct *chartInstance);
static void finalize_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void sf_gateway_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void c19_chartstep_c19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void initSimStructsc19_FSAC2021_826(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
static void c19_enter_atomic_Off(SFc19_FSAC2021_826InstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static boolean_T c19_b_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_c_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static uint8_T c19_d_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_b_tp_On, const char_T *c19_identifier);
static uint8_T c19_e_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint32_T c19_f_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_b_previousTicks, const char_T
  *c19_identifier);
static uint32_T c19_g_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static const mxArray *c19_h_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_b_setSimStateSideEffectsInfo, const char_T *
  c19_identifier);
static const mxArray *c19_i_emlrt_marshallIn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_updateDataWrittenToVector(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, uint32_T c19_vectorIndex);
static void c19_errorIfDataNotWrittenToFcn(SFc19_FSAC2021_826InstanceStruct
  *chartInstance, uint32_T c19_vectorIndex, uint32_T c19_dataNumber);
static void init_dsm_address_info(SFc19_FSAC2021_826InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_FSAC2021_826 = 0U;
  chartInstance->c19_is_c19_FSAC2021_826 = c19_IN_NO_ACTIVE_CHILD;
  ...
  (SFc19_FSAC2021_826InstanceStruct *chartInstance)
{
  ...
  c19_b_hoistedGlobal = chartInstance->c19_is_active_c19_FSAC2021_826;
  ...
  c19_c_hoistedGlobal = chartInstance->c19_is_c19_FSAC2021_826;
  ...
  *chartInstance, const mxArray *c19_st)
{
  ...
  *c19_Debounce = c19_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c19_is_active_c19_FSAC2021_826 = c19_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
     "is_active_c19_FSAC2021_826");
  chartInstance->c19_is_c19_FSAC2021_826 = c19_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c19_u, 2)), "is_c19_FSAC2021_826");
  ...
  c19_update_debugger_state_c19_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  c19_set_sim_state_side_effects_c19_FSAC2021_826(chartInstance);
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_FSAC2021_826(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c19_is_active_c19_FSAC2021_826 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 17U, chartInstance->c19_sfEvent);
    chartInstance->c19_is_active_c19_FSAC2021_826 = 1U;
    ...
    chartInstance->c19_is_c19_FSAC2021_826 = c19_IN_Off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
    chartInstance->c19_tp_Off = 1U;
    c19_enter_atomic_Off(chartInstance);
  } else {
    switch (chartInstance->c19_is_c19_FSAC2021_826) {
     case c19_IN_Off:
      ...
      if (c19_out) {
        ...
        chartInstance->c19_tp_Off = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
        chartInstance->c19_is_c19_FSAC2021_826 = c19_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
        chartInstance->c19_temporalCounter_i1 = 0U;
        chartInstance->c19_tp_Wait = 1U;
      } else {
     ...
     case c19_IN_Wait:
      ...
      if (c19_c_out) {
        ...
        if (c19_d_out) {
          ...
          chartInstance->c19_tp_Wait = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
          chartInstance->c19_is_c19_FSAC2021_826 = c19_IN_On;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
          chartInstance->c19_tp_On = 1U;
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_FSAC2021_826InstanceStruct *chartInstance;
  chartInstance = (SFc19_FSAC2021_826InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_FSAC2021_826_get_eml_resolved_functions_info(void)
{
...
void sf_c19_FSAC2021_826_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_FSAC2021_826_get_autoinheritance_info(void)
{
...
mxArray *sf_c19_FSAC2021_826_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_FSAC2021_826_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c19_FSAC2021_826(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[2],T\"Debounce\",},{M[8],M[0],T\"is_active_c19_FSAC2021_826\",},{M[9],M[0],T\"is_c19_FSAC2021_826\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[6],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_FSAC2021_826_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_FSAC2021_826InstanceStruct *)
...
static void sf_opaque_initialize_c19_FSAC2021_826(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_FSAC2021_826InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
  initialize_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c19_FSAC2021_826(void *chartInstanceVar)
{
  enable_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_FSAC2021_826(void *chartInstanceVar)
{
  disable_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_FSAC2021_826(void *chartInstanceVar)
{
  sf_gateway_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_FSAC2021_826(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_FSAC2021_826
    ((SFc19_FSAC2021_826InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_FSAC2021_826();/* state var info */
...
extern void sf_internal_set_sim_state_c19_FSAC2021_826(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c19_FSAC2021_826();/* state var info */
  ...
  set_sim_state_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_FSAC2021_826(SimStruct* S)
{
  return sf_internal_get_sim_state_c19_FSAC2021_826(S);
}

static void sf_opaque_set_sim_state_c19_FSAC2021_826(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c19_FSAC2021_826(S, st);
}

static void sf_opaque_terminate_c19_FSAC2021_826(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_FSAC2021_826InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc19_FSAC2021_826((SFc19_FSAC2021_826InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_FSAC2021_826(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_FSAC2021_826(SimStruct *S)
{
...
static void mdlRTW_c19_FSAC2021_826(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_FSAC2021_826(SimStruct *S)
{
  SFc19_FSAC2021_826InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_FSAC2021_826InstanceStruct *)utMalloc(sizeof
    (SFc19_FSAC2021_826InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_FSAC2021_826InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_FSAC2021_826;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_FSAC2021_826;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_FSAC2021_826;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_FSAC2021_826;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_FSAC2021_826;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_FSAC2021_826;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_FSAC2021_826;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_FSAC2021_826;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_FSAC2021_826;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_FSAC2021_826;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_FSAC2021_826;
...
void c19_FSAC2021_826_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_FSAC2021_826(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_FSAC2021_826(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_FSAC2021_826_method_dispatcher.\n"
