...
static void initialize_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initialize_params_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void enable_c7_FSAC2021_V1_Running(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
static void disable_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void set_sim_state_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c7_st);
static void c7_set_sim_state_side_effects_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void finalize_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void sf_gateway_c7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initSimStructsc7_FSAC2021_V1_Running
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static boolean_T c7_b_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_b_tp_Start_Horn_ON, const char_T
  *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint32_T c7_f_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_b_previousTicks, const char_T *c7_identifier);
static uint32_T c7_g_emlrt_marshallIn(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static const mxArray *c7_h_emlrt_marshallIn
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray
   *c7_b_setSimStateSideEffectsInfo, const char_T *c7_identifier);
static const mxArray *c7_i_emlrt_marshallIn
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c7_u,
   const emlrtMsgIdentifier *c7_parentId);
static void c7_updateDataWrittenToVector(SFc7_FSAC2021_V1_RunningInstanceStruct *
  chartInstance, uint32_T c7_vectorIndex);
static void init_dsm_address_info(SFc7_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
  ...
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_FSAC2021_V1_Running = 0U;
  chartInstance->c7_is_c7_FSAC2021_V1_Running = c7_IN_NO_ACTIVE_CHILD;
  ...
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c7_is_active_c7_FSAC2021_V1_Running == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 6U, chartInstance->c7_sfEvent);
  }

  if (chartInstance->c7_is_c7_FSAC2021_V1_Running == c7_IN_Start_Horn_ON) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c7_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c7_sfEvent);
  }

  if (chartInstance->c7_is_c7_FSAC2021_V1_Running == c7_IN_Start_Horn_OFF) {
  ...
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_FSAC2021_V1_Running;
  c7_b_u = c7_b_hoistedGlobal;
  c7_c_y = NULL;
  sf_mex_assign(&c7_c_y, sf_mex_create("y", &c7_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c7_y, 1, c7_c_y);
  c7_c_hoistedGlobal = chartInstance->c7_is_c7_FSAC2021_V1_Running;
  ...
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *c7_Buzzer_Pin = c7_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c7_is_active_c7_FSAC2021_V1_Running = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_FSAC2021_V1_Running");
  chartInstance->c7_is_c7_FSAC2021_V1_Running = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 2)),
     "is_c7_FSAC2021_V1_Running");
  ...
  c7_update_debugger_state_c7_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  uint8_T *c7_Buzzer_Pin;
  c7_Buzzer_Pin = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c7_set_sim_state_side_effects_c7_FSAC2021_V1_Running(chartInstance);
  ...
  if (chartInstance->c7_is_active_c7_FSAC2021_V1_Running == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 6U, chartInstance->c7_sfEvent);
    chartInstance->c7_is_active_c7_FSAC2021_V1_Running = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 6U, chartInstance->c7_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c7_sfEvent);
    chartInstance->c7_is_c7_FSAC2021_V1_Running = c7_IN_Start_Horn_ON;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c7_sfEvent);
    chartInstance->c7_temporalCounter_i1 = 0U;
    chartInstance->c7_tp_Start_Horn_ON = 1U;
    ...
    *c7_Buzzer_Pin = chartInstance->c7_ON;
    ...
    switch (chartInstance->c7_is_c7_FSAC2021_V1_Running) {
     ...
     case c7_IN_Start_Horn_ON:
      ...
      if (c7_out) {
        ...
        chartInstance->c7_tp_Start_Horn_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c7_sfEvent);
        chartInstance->c7_is_c7_FSAC2021_V1_Running = c7_IN_Start_Horn_OFF;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c7_sfEvent);
        chartInstance->c7_tp_Start_Horn_OFF = 1U;
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  chartInstance = (SFc7_FSAC2021_V1_RunningInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_FSAC2021_V1_Running_get_eml_resolved_functions_info(void)
{
...
void sf_c7_FSAC2021_V1_Running_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_FSAC2021_V1_Running_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_FSAC2021_V1_Running_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_FSAC2021_V1_Running_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_FSAC2021_V1_Running(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"Buzzer_Pin\",},{M[8],M[0],T\"is_active_c7_FSAC2021_V1_Running\",},{M[9],M[0],T\"is_c7_FSAC2021_V1_Running\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[3],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_FSAC2021_V1_Running_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_FSAC2021_V1_RunningInstanceStruct *)
...
static void sf_opaque_initialize_c7_FSAC2021_V1_Running(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_FSAC2021_V1_Running
    ((SFc7_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar);
  initialize_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_FSAC2021_V1_Running(void *chartInstanceVar)
{
  enable_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_FSAC2021_V1_Running(void *chartInstanceVar)
{
  disable_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_FSAC2021_V1_Running(void *chartInstanceVar)
{
  sf_gateway_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_FSAC2021_V1_Running(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_FSAC2021_V1_Running
    ((SFc7_FSAC2021_V1_RunningInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_FSAC2021_V1_Running();/* state var info */
...
extern void sf_internal_set_sim_state_c7_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_FSAC2021_V1_Running();/* state var info */
  ...
  set_sim_state_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_FSAC2021_V1_Running(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c7_FSAC2021_V1_Running(S);
}

static void sf_opaque_set_sim_state_c7_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_FSAC2021_V1_Running(S, st);
}

static void sf_opaque_terminate_c7_FSAC2021_V1_Running(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_FSAC2021_V1_Running((SFc7_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_FSAC2021_V1_Running(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_FSAC2021_V1_Running
      ((SFc7_FSAC2021_V1_RunningInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_FSAC2021_V1_Running(SimStruct *S)
{
...
static void mdlRTW_c7_FSAC2021_V1_Running(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_FSAC2021_V1_Running(SimStruct *S)
{
  SFc7_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_FSAC2021_V1_RunningInstanceStruct *)utMalloc(sizeof
    (SFc7_FSAC2021_V1_RunningInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_FSAC2021_V1_RunningInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_FSAC2021_V1_Running;
...
void c7_FSAC2021_V1_Running_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_FSAC2021_V1_Running(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_FSAC2021_V1_Running_method_dispatcher.\n"
