...
static void initialize_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initialize_params_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void enable_c3_FSAC2021_V1_Running(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
static void disable_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void set_sim_state_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void finalize_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void sf_gateway_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c3_chartstep_c3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initSimStructsc3_FSAC2021_V1_Running
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c3_AS_Driving(SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c3_AS_Finished(SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_b_emlrt_marshallIn(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c3_b_tp_AS_Driving, const char_T *c3_identifier);
static uint8_T c3_c_emlrt_marshallIn(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint32_T c3_d_emlrt_marshallIn(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c3_b_previousTicks, const char_T *c3_identifier);
static uint32_T c3_e_emlrt_marshallIn(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static const mxArray *c3_f_emlrt_marshallIn
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray
   *c3_b_setSimStateSideEffectsInfo, const char_T *c3_identifier);
static const mxArray *c3_g_emlrt_marshallIn
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c3_u,
   const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
  ...
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  uint8_T *c3_System_48V_Relay;
  uint8_T *c3_ASSI_State;
  uint8_T *c3_VCU_Valve;
  uint8_T *c3_R2D;
  c3_R2D = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 8);
  c3_VCU_Valve = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 7);
  c3_ASSI_State = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 6);
  c3_System_48V_Relay = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 5);
  ...
  chartInstance->c3_is_active_c3_FSAC2021_V1_Running = 0U;
  chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_NO_ACTIVE_CHILD;
  ...
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_System_48V_Relay = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 5)), "System_48V_Relay");
  *c3_VCU_Valve = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 6)), "VCU_Valve");
  *c3_Yellow_Light = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 7)), "Yellow_Light");
  chartInstance->c3_is_active_c3_FSAC2021_V1_Running = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 8)),
     "is_active_c3_FSAC2021_V1_Running");
  chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 9)),
     "is_c3_FSAC2021_V1_Running");
  chartInstance->c3_temporalCounter_i1 = c3_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 10)), "temporalCounter_i1");
  chartInstance->c3_previousTicks = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 11)), "previousTicks");
  sf_mex_assign(&chartInstance->c3_setSimStateSideEffectsInfo,
                c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 12)), "setSimStateSideEffectsInfo"), true);
  sf_mex_destroy(&c3_u);
  chartInstance->c3_doSetSimStateSideEffects = 1U;
  c3_update_debugger_state_c3_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  uint8_T *c3_Res_Origin_Flag;
  c3_Res_Origin_Flag = (uint8_T *)ssGetInputPortSignal(chartInstance->S, 11);
  ...
  c3_Yellow_Light = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_Blue_Light = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_set_sim_state_side_effects_c3_FSAC2021_V1_Running(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c3_System_48V_Relay, 6U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_ASSI_State, 7U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Veh_Spd, 8U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_ASMS, 9U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_ON, 10U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_OFF, 11U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_ENABLE, 12U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_DISABLE, 13U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_AS_OFF, 14U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_AS_READY, 15U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_AS_DRIVING, 16U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_AS_FINISH, 17U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_AS_EMERGENCY, 18U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_BLINK, 19U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_EBS_DISABLE, 20U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_EBS_ARMED, 21U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_EBS_ENABLE, 22U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_VCU_Valve, 23U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_R2D, 24U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_MANUAL_DRIVING, 25U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_MANUAL_MODE, 26U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_LVMS, 27U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_AMI_State, 28U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Res_EBS, 29U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Res_GO, 30U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_START_Flag, 31U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Misson_Finished, 32U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Buzzer_Overflag, 33U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_BUZZER_START, 34U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_BUZZER_EBS, 35U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance->c3_TRACKDRIVE, 36U);
  _SFD_DATA_RANGE_CHECK((real_T)*c3_Res_Origin_Flag, 37U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_FSAC2021_V1_Running == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_FSAC2021_V1_Running = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 14U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_AS_Off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_AS_Off = 1U;
    *c3_ASSI_State = chartInstance->c3_AS_OFF;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_ASSI_State, 7U);
    *c3_System_48V_Relay = chartInstance->c3_DISABLE;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_System_48V_Relay, 6U);
    *c3_Blue_Light = chartInstance->c3_OFF;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_Blue_Light, 0U);
    *c3_Yellow_Light = chartInstance->c3_OFF;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_Yellow_Light, 1U);
    *c3_VCU_Valve = chartInstance->c3_ON;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_VCU_Valve, 23U);
  } else {
    switch (chartInstance->c3_is_c3_FSAC2021_V1_Running) {
     ...
     case c3_IN_AS_Off:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 7U,
                   chartInstance->c3_sfEvent);
      c3_c_temp = (_SFD_CCP_CALL(7U, 0, *c3_AMI_State ==
        chartInstance->c3_MANUAL_MODE != 0U, chartInstance->c3_sfEvent) != 0);
      if (c3_c_temp) {
        c3_c_temp = (_SFD_CCP_CALL(7U, 1, *c3_TS_Flag != 0U,
          chartInstance->c3_sfEvent) != 0);
      }

      c3_d_temp = c3_c_temp;
      if (c3_d_temp) {
        c3_d_temp = !(_SFD_CCP_CALL(7U, 2, *c3_ASMS != 0U,
          chartInstance->c3_sfEvent) != 0);
      }

      c3_e_temp = c3_d_temp;
      if (c3_e_temp) {
        c3_e_temp = (_SFD_CCP_CALL(7U, 3, *c3_START_Flag != 0U,
          chartInstance->c3_sfEvent) != 0);
      }

      c3_b_out = (CV_TRANSITION_EVAL(7U, (int32_T)c3_e_temp) != 0);
      if (c3_b_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 7U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_AS_Off = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_Manual_Driving;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_Manual_Driving = 1U;
        ...
        *c3_ASSI_State = chartInstance->c3_MANUAL_DRIVING;
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U,
                     chartInstance->c3_sfEvent);
        c3_f_temp = (_SFD_CCP_CALL(0U, 0, *c3_LVMS != 0U,
          chartInstance->c3_sfEvent) != 0);
        if (c3_f_temp) {
          c3_f_temp = (_SFD_CCP_CALL(0U, 1, *c3_ASMS != 0U,
            chartInstance->c3_sfEvent) != 0);
        }

        c3_g_temp = c3_f_temp;
        if (c3_g_temp) {
          c3_g_temp = (_SFD_CCP_CALL(0U, 2, *c3_TS_Flag != 0U,
            chartInstance->c3_sfEvent) != 0);
        }

        c3_h_temp = c3_g_temp;
        if (c3_h_temp) {
          c3_h_temp = (_SFD_CCP_CALL(0U, 3, *c3_AMI_State != 0U,
            chartInstance->c3_sfEvent) != 0);
        }

        c3_i_temp = c3_h_temp;
        if (c3_i_temp) {
          c3_i_temp = (_SFD_CCP_CALL(0U, 4, *c3_Res_Origin_Flag != 0U,
            chartInstance->c3_sfEvent) != 0);
        }

        c3_c_out = (CV_TRANSITION_EVAL(0U, (int32_T)c3_i_temp) != 0);
        if (c3_c_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
          chartInstance->c3_tp_AS_Off = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_AS_Ready;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
          chartInstance->c3_temporalCounter_i1 = 0U;
          chartInstance->c3_tp_AS_Ready = 1U;
          *c3_ASSI_State = chartInstance->c3_AS_READY;
          _SFD_DATA_RANGE_CHECK((real_T)*c3_ASSI_State, 7U);
          *c3_System_48V_Relay = chartInstance->c3_ENABLE;
          _SFD_DATA_RANGE_CHECK((real_T)*c3_System_48V_Relay, 6U);
     ...
     case c3_IN_AS_Ready:
      ...
      c3_d_out = (CV_TRANSITION_EVAL(2U, (int32_T)c3_j_temp) != 0);
      if (c3_d_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_AS_Ready = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_AS_Driving;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_AS_Driving = 1U;
        *c3_R2D = chartInstance->c3_ON;
        _SFD_DATA_RANGE_CHECK((real_T)*c3_R2D, 24U);
        ...
        *c3_Buzzer = chartInstance->c3_BUZZER_START;
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 1U,
                     chartInstance->c3_sfEvent);
        c3_e_out = (CV_TRANSITION_EVAL(1U, !(_SFD_CCP_CALL(1U, 0, *c3_ASMS != 0U,
        ...
        if (c3_e_out) {
          ...
          *c3_VCU_Valve = chartInstance->c3_ON;
          ...
          if (c3_f_out) {
            ...
            chartInstance->c3_tp_AS_Ready = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
            chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_AS_Emergency;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
            chartInstance->c3_tp_AS_Emergency = 1U;
...
static void c3_AS_Driving(SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  if (c3_out) {
    ...
    chartInstance->c3_tp_AS_Driving = 0U;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_FSAC2021_V1_Running = c3_IN_AS_Finished;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_AS_Finished = 1U;
    ...
    *c3_Safety_Circuit_Relay = chartInstance->c3_ON;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_Safety_Circuit_Relay, 5U);
    *c3_System_48V_Relay = chartInstance->c3_OFF;
    _SFD_DATA_RANGE_CHECK((real_T)*c3_System_48V_Relay, 6U);
    ...
    *c3_Yellow_Light = chartInstance->c3_OFF;
    ...
    c3_b_out = (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4U, 0,
      *c3_EBS_Flag == 1 != 0U, chartInstance->c3_sfEvent)) != 0);
    if (c3_b_out) {
...
const mxArray *sf_c3_FSAC2021_V1_Running_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  chartInstance = (SFc3_FSAC2021_V1_RunningInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_b_tp_AS_Driving, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_AS_Driving),
    &c3_thisId);
  sf_mex_destroy(&c3_b_tp_AS_Driving);
  return c3_y;
}
...
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_b_tp_AS_Driving;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  uint8_T c3_y;
  SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  chartInstance = (SFc3_FSAC2021_V1_RunningInstanceStruct *)chartInstanceVoid;
  c3_b_tp_AS_Driving = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_tp_AS_Driving),
...
void sf_c3_FSAC2021_V1_Running_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3108577725U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3375612429U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2891482746U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3023396184U);
}

mxArray *sf_c3_FSAC2021_V1_Running_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pGuZfgrfpJIYPMrfpYo9CD");
...
mxArray *sf_c3_FSAC2021_V1_Running_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_FSAC2021_V1_Running_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_FSAC2021_V1_Running(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[25],T\"ASSI_State\",},{M[1],M[24],T\"Blue_Light\",},{M[1],M[26],T\"Buzzer\",},{M[1],M[61],T\"R2D\",},{M[1],M[21],T\"Safety_Circuit_Relay\",},{M[1],M[23],T\"System_48V_Relay\",},{M[1],M[60],T\"VCU_Valve\",},{M[1],M[22],T\"Yellow_Light\",},{M[8],M[0],T\"is_active_c3_FSAC2021_V1_Running\",},{M[9],M[0],T\"is_c3_FSAC2021_V1_Running\",}}",
    "100 S1x2'type','srcId','name','auxInfo'{{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[3],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 12, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_FSAC2021_V1_Running_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_FSAC2021_V1_RunningInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(6,2,0,1,"System_48V_Relay");
          _SFD_SET_DATA_PROPS(7,2,0,1,"ASSI_State");
          _SFD_SET_DATA_PROPS(8,1,1,0,"Veh_Spd");
          _SFD_SET_DATA_PROPS(9,1,1,0,"ASMS");
          _SFD_SET_DATA_PROPS(10,10,0,0,"ON");
          _SFD_SET_DATA_PROPS(11,10,0,0,"OFF");
          _SFD_SET_DATA_PROPS(12,10,0,0,"ENABLE");
          _SFD_SET_DATA_PROPS(13,10,0,0,"DISABLE");
          _SFD_SET_DATA_PROPS(14,10,0,0,"AS_OFF");
          _SFD_SET_DATA_PROPS(15,10,0,0,"AS_READY");
          _SFD_SET_DATA_PROPS(16,10,0,0,"AS_DRIVING");
          _SFD_SET_DATA_PROPS(17,10,0,0,"AS_FINISH");
          _SFD_SET_DATA_PROPS(18,10,0,0,"AS_EMERGENCY");
          _SFD_SET_DATA_PROPS(19,10,0,0,"BLINK");
          _SFD_SET_DATA_PROPS(20,10,0,0,"EBS_DISABLE");
          _SFD_SET_DATA_PROPS(21,10,0,0,"EBS_ARMED");
          _SFD_SET_DATA_PROPS(22,10,0,0,"EBS_ENABLE");
          _SFD_SET_DATA_PROPS(23,2,0,1,"VCU_Valve");
          _SFD_SET_DATA_PROPS(24,2,0,1,"R2D");
          _SFD_SET_DATA_PROPS(25,10,0,0,"MANUAL_DRIVING");
          _SFD_SET_DATA_PROPS(26,10,0,0,"MANUAL_MODE");
          _SFD_SET_DATA_PROPS(27,1,1,0,"LVMS");
          _SFD_SET_DATA_PROPS(28,1,1,0,"AMI_State");
          _SFD_SET_DATA_PROPS(29,1,1,0,"Res_EBS");
          _SFD_SET_DATA_PROPS(30,1,1,0,"Res_GO");
          _SFD_SET_DATA_PROPS(31,1,1,0,"START_Flag");
          _SFD_SET_DATA_PROPS(32,1,1,0,"Misson_Finished");
          _SFD_SET_DATA_PROPS(33,1,1,0,"Buzzer_Overflag");
          _SFD_SET_DATA_PROPS(34,10,0,0,"BUZZER_START");
          _SFD_SET_DATA_PROPS(35,10,0,0,"BUZZER_EBS");
          _SFD_SET_DATA_PROPS(36,10,0,0,"TRACKDRIVE");
          _SFD_SET_DATA_PROPS(37,1,1,0,"Res_Origin_Flag");
        ...
        {
          static unsigned int sStartGuardMap[] = { 1, 7, 15, 29, 44 };

          static unsigned int sEndGuardMap[] = { 5, 11, 22, 38, 59 };
        ...
        {
          static unsigned int sStartGuardMap[] = { 1, 31, 45, 51 };

          static unsigned int sEndGuardMap[] = { 25, 38, 49, 61 };

          static int sPostFixPredicateTree[] = { 0, 1, -3, 2, -1, -3, 3, -3 };

          _SFD_CV_INIT_TRANS(7,4,&(sStartGuardMap[0]),&(sEndGuardMap[0]),8,
                             &(sPostFixPredicateTree[0]));
        }
...

        {
          ...
          uint8_T *c3_Buzzer_Overflag;
          uint8_T *c3_Res_Origin_Flag;
          c3_Res_Origin_Flag = (uint8_T *)ssGetInputPortSignal(chartInstance->S,
            11);
          ...
          c3_Veh_Spd = (real32_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c3_ASSI_State = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 6);
          c3_System_48V_Relay = (uint8_T *)ssGetOutputPortSignal
            (chartInstance->S, 5);
          ...
          _SFD_SET_DATA_VALUE_PTR(6U, c3_System_48V_Relay);
          _SFD_SET_DATA_VALUE_PTR(7U, c3_ASSI_State);
          _SFD_SET_DATA_VALUE_PTR(8U, c3_Veh_Spd);
          _SFD_SET_DATA_VALUE_PTR(9U, c3_ASMS);
          _SFD_SET_DATA_VALUE_PTR(10U, &chartInstance->c3_ON);
          _SFD_SET_DATA_VALUE_PTR(11U, &chartInstance->c3_OFF);
          _SFD_SET_DATA_VALUE_PTR(12U, &chartInstance->c3_ENABLE);
          _SFD_SET_DATA_VALUE_PTR(13U, &chartInstance->c3_DISABLE);
          _SFD_SET_DATA_VALUE_PTR(14U, &chartInstance->c3_AS_OFF);
          _SFD_SET_DATA_VALUE_PTR(15U, &chartInstance->c3_AS_READY);
          _SFD_SET_DATA_VALUE_PTR(16U, &chartInstance->c3_AS_DRIVING);
          _SFD_SET_DATA_VALUE_PTR(17U, &chartInstance->c3_AS_FINISH);
          _SFD_SET_DATA_VALUE_PTR(18U, &chartInstance->c3_AS_EMERGENCY);
          _SFD_SET_DATA_VALUE_PTR(19U, &chartInstance->c3_BLINK);
          _SFD_SET_DATA_VALUE_PTR(20U, &chartInstance->c3_EBS_DISABLE);
          _SFD_SET_DATA_VALUE_PTR(21U, &chartInstance->c3_EBS_ARMED);
          _SFD_SET_DATA_VALUE_PTR(22U, &chartInstance->c3_EBS_ENABLE);
          _SFD_SET_DATA_VALUE_PTR(23U, c3_VCU_Valve);
          _SFD_SET_DATA_VALUE_PTR(24U, c3_R2D);
          _SFD_SET_DATA_VALUE_PTR(25U, &chartInstance->c3_MANUAL_DRIVING);
          _SFD_SET_DATA_VALUE_PTR(26U, &chartInstance->c3_MANUAL_MODE);
          _SFD_SET_DATA_VALUE_PTR(27U, c3_LVMS);
          _SFD_SET_DATA_VALUE_PTR(28U, c3_AMI_State);
          _SFD_SET_DATA_VALUE_PTR(29U, c3_Res_EBS);
          _SFD_SET_DATA_VALUE_PTR(30U, c3_Res_GO);
          _SFD_SET_DATA_VALUE_PTR(31U, c3_START_Flag);
          _SFD_SET_DATA_VALUE_PTR(32U, c3_Misson_Finished);
          _SFD_SET_DATA_VALUE_PTR(33U, c3_Buzzer_Overflag);
          _SFD_SET_DATA_VALUE_PTR(34U, &chartInstance->c3_BUZZER_START);
          _SFD_SET_DATA_VALUE_PTR(35U, &chartInstance->c3_BUZZER_EBS);
          _SFD_SET_DATA_VALUE_PTR(36U, &chartInstance->c3_TRACKDRIVE);
          _SFD_SET_DATA_VALUE_PTR(37U, c3_Res_Origin_Flag);
        }
      }
    } else {
...
{
  return "YT6EGfSZ4WmjJWXs6emj7";
}

static void sf_opaque_initialize_c3_FSAC2021_V1_Running(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_FSAC2021_V1_Running
    ((SFc3_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar);
  initialize_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_FSAC2021_V1_Running(void *chartInstanceVar)
{
  enable_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_FSAC2021_V1_Running(void *chartInstanceVar)
{
  disable_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_FSAC2021_V1_Running(void *chartInstanceVar)
{
  sf_gateway_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_FSAC2021_V1_Running(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_FSAC2021_V1_Running
    ((SFc3_FSAC2021_V1_RunningInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_FSAC2021_V1_Running();/* state var info */
...
extern void sf_internal_set_sim_state_c3_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_FSAC2021_V1_Running();/* state var info */
  ...
  set_sim_state_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_FSAC2021_V1_Running(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c3_FSAC2021_V1_Running(S);
}

static void sf_opaque_set_sim_state_c3_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_FSAC2021_V1_Running(S, st);
}

static void sf_opaque_terminate_c3_FSAC2021_V1_Running(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_FSAC2021_V1_Running((SFc3_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_FSAC2021_V1_Running(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_FSAC2021_V1_Running
      ((SFc3_FSAC2021_V1_RunningInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_FSAC2021_V1_Running(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(980745304U));
  ssSetChecksum1(S,(2102022878U));
  ssSetChecksum2(S,(1990295733U));
  ssSetChecksum3(S,(2495311396U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_FSAC2021_V1_Running(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_FSAC2021_V1_Running(SimStruct *S)
{
  SFc3_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_FSAC2021_V1_RunningInstanceStruct *)utMalloc(sizeof
    (SFc3_FSAC2021_V1_RunningInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_FSAC2021_V1_RunningInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_FSAC2021_V1_Running;
...
void c3_FSAC2021_V1_Running_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_FSAC2021_V1_Running(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_FSAC2021_V1_Running_method_dispatcher.\n"
