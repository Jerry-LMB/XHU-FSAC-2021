...
static void initialize_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initialize_params_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void enable_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void disable_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void set_sim_state_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void finalize_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void sf_gateway_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c10_chartstep_c10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initSimStructsc10_FSAC2021_V1_Running
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static boolean_T c10_b_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct *
  chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_c_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_d_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_b_tp_Normal, const char_T *c10_identifier);
static uint8_T c10_e_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint32_T c10_f_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_b_previousTicks, const char_T
  *c10_identifier);
static uint32_T c10_g_emlrt_marshallIn(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static const mxArray *c10_h_emlrt_marshallIn
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray
   *c10_b_setSimStateSideEffectsInfo, const char_T *c10_identifier);
static const mxArray *c10_i_emlrt_marshallIn
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c10_u,
   const emlrtMsgIdentifier *c10_parentId);
static void c10_updateDataWrittenToVector
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance, uint32_T
   c10_vectorIndex);
static void init_dsm_address_info(SFc10_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
  ...
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_tp_On = 0U;
  chartInstance->c10_is_active_c10_FSAC2021_V1_Running = 0U;
  chartInstance->c10_is_c10_FSAC2021_V1_Running = c10_IN_NO_ACTIVE_CHILD;
  ...
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_FSAC2021_V1_Running;
  c10_b_u = c10_b_hoistedGlobal;
  c10_c_y = NULL;
  sf_mex_assign(&c10_c_y, sf_mex_create("y", &c10_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c10_y, 1, c10_c_y);
  c10_c_hoistedGlobal = chartInstance->c10_is_c10_FSAC2021_V1_Running;
  ...
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c10_st)
{
  ...
  *c10_Output = c10_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c10_u, 0)), "Output");
  chartInstance->c10_is_active_c10_FSAC2021_V1_Running = c10_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_FSAC2021_V1_Running");
  chartInstance->c10_is_c10_FSAC2021_V1_Running = c10_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 2)),
     "is_c10_FSAC2021_V1_Running");
  ...
  c10_update_debugger_state_c10_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  c10_set_sim_state_side_effects_c10_FSAC2021_V1_Running(chartInstance);
  ...
  chartInstance->c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c10_is_active_c10_FSAC2021_V1_Running == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 9U, chartInstance->c10_sfEvent);
    chartInstance->c10_is_active_c10_FSAC2021_V1_Running = 1U;
    ...
    chartInstance->c10_is_c10_FSAC2021_V1_Running = c10_IN_Normal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
    chartInstance->c10_tp_Normal = 1U;
    ...
    *c10_Output = 1U;
    ...
    switch (chartInstance->c10_is_c10_FSAC2021_V1_Running) {
     case c10_IN_Normal:
      CV_CHART_EVAL(9, 0, 1);
      ...
      if (c10_out) {
        ...
        chartInstance->c10_tp_Normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
        chartInstance->c10_is_c10_FSAC2021_V1_Running = c10_IN_ON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
        chartInstance->c10_temporalCounter_i1 = 0U;
        chartInstance->c10_tp_ON = 1U;
      } else {
     ...
     case c10_IN_ON:
      ...
      if (c10_b_out) {
        ...
        chartInstance->c10_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
        chartInstance->c10_is_c10_FSAC2021_V1_Running = c10_IN_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
        chartInstance->c10_tp_Off = 1U;
      } else {
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  chartInstance = (SFc10_FSAC2021_V1_RunningInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_FSAC2021_V1_Running_get_eml_resolved_functions_info(void)
{
...
void sf_c10_FSAC2021_V1_Running_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_FSAC2021_V1_Running_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_FSAC2021_V1_Running_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_FSAC2021_V1_Running_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_FSAC2021_V1_Running(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[24],T\"Output\",},{M[8],M[0],T\"is_active_c10_FSAC2021_V1_Running\",},{M[9],M[0],T\"is_c10_FSAC2021_V1_Running\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_FSAC2021_V1_Running_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_FSAC2021_V1_RunningInstanceStruct *)
...
static void sf_opaque_initialize_c10_FSAC2021_V1_Running(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_FSAC2021_V1_Running
    ((SFc10_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar);
  initialize_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_FSAC2021_V1_Running(void *chartInstanceVar)
{
  enable_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_FSAC2021_V1_Running(void *chartInstanceVar)
{
  disable_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_FSAC2021_V1_Running(void *chartInstanceVar)
{
  sf_gateway_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_FSAC2021_V1_Running
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_FSAC2021_V1_Running
    ((SFc10_FSAC2021_V1_RunningInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_FSAC2021_V1_Running();/* state var info */
...
extern void sf_internal_set_sim_state_c10_FSAC2021_V1_Running(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_FSAC2021_V1_Running();/* state var info */
  ...
  set_sim_state_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_FSAC2021_V1_Running(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c10_FSAC2021_V1_Running(S);
}

static void sf_opaque_set_sim_state_c10_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_FSAC2021_V1_Running(S, st);
}

static void sf_opaque_terminate_c10_FSAC2021_V1_Running(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_FSAC2021_V1_Running((SFc10_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_FSAC2021_V1_Running(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c10_FSAC2021_V1_Running
      ((SFc10_FSAC2021_V1_RunningInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_FSAC2021_V1_Running(SimStruct *S)
{
...
static void mdlRTW_c10_FSAC2021_V1_Running(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_FSAC2021_V1_Running(SimStruct *S)
{
  SFc10_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_FSAC2021_V1_RunningInstanceStruct *)utMalloc(sizeof
    (SFc10_FSAC2021_V1_RunningInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_FSAC2021_V1_RunningInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_FSAC2021_V1_Running;
...
void c10_FSAC2021_V1_Running_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_FSAC2021_V1_Running(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_FSAC2021_V1_Running_method_dispatcher.\n"
