...
static void initialize_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initialize_params_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void enable_c8_FSAC2021_V1_Running(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
static void disable_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void set_sim_state_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c8_st);
static void c8_set_sim_state_side_effects_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void finalize_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void sf_gateway_c8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void initSimStructsc8_FSAC2021_V1_Running
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance);
static void c8_exit_internal_Horn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static int32_T c8_emlrt_marshallIn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_b_emlrt_marshallIn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c8_b_tp_Horn, const char_T *c8_identifier);
static uint8_T c8_c_emlrt_marshallIn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint32_T c8_d_emlrt_marshallIn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c8_b_previousTicks, const char_T *c8_identifier);
static uint32_T c8_e_emlrt_marshallIn(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static const mxArray *c8_f_emlrt_marshallIn
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray
   *c8_b_setSimStateSideEffectsInfo, const char_T *c8_identifier);
static const mxArray *c8_g_emlrt_marshallIn
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c8_u,
   const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_FSAC2021_V1_RunningInstanceStruct
  *chartInstance);
  ...
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_temporalCounter_i1 = 0U;
  chartInstance->c8_is_active_c8_FSAC2021_V1_Running = 0U;
  chartInstance->c8_is_c8_FSAC2021_V1_Running = c8_IN_NO_ACTIVE_CHILD;
  ...
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c8_is_active_c8_FSAC2021_V1_Running == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 7U, chartInstance->c8_sfEvent);
  }

  if (chartInstance->c8_is_c8_FSAC2021_V1_Running == c8_IN_Horn) {
  ...
  if (chartInstance->c8_is_c8_FSAC2021_V1_Running == c8_IN_EBS_Horn_OFF) {
  ...
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  c8_c_hoistedGlobal = chartInstance->c8_is_active_c8_FSAC2021_V1_Running;
  c8_c_u = c8_c_hoistedGlobal;
  c8_d_y = NULL;
  sf_mex_assign(&c8_d_y, sf_mex_create("y", &c8_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c8_y, 2, c8_d_y);
  c8_d_hoistedGlobal = chartInstance->c8_is_c8_FSAC2021_V1_Running;
  ...
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_Buzzer_Pin = c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c8_is_active_c8_FSAC2021_V1_Running = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
     "is_active_c8_FSAC2021_V1_Running");
  chartInstance->c8_is_c8_FSAC2021_V1_Running = c8_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
     "is_c8_FSAC2021_V1_Running");
  ...
  c8_update_debugger_state_c8_FSAC2021_V1_Running(chartInstance);
  ...
  (SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance)
{
  ...
  c8_Buzzer_Overflag = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c8_Buzzer_Pin = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c8_set_sim_state_side_effects_c8_FSAC2021_V1_Running(chartInstance);
  ...
  if (chartInstance->c8_is_active_c8_FSAC2021_V1_Running == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 7U, chartInstance->c8_sfEvent);
    chartInstance->c8_is_active_c8_FSAC2021_V1_Running = 1U;
    ...
    chartInstance->c8_is_c8_FSAC2021_V1_Running = c8_IN_Horn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
    chartInstance->c8_temporalCounter_i2 = 0U;
    chartInstance->c8_tp_Horn = 1U;
    ...
    *c8_Buzzer_Pin = chartInstance->c8_ON;
    ...
    switch (chartInstance->c8_is_c8_FSAC2021_V1_Running) {
     ...
     case c8_IN_Horn:
      ...
      if (c8_out) {
        ...
        chartInstance->c8_tp_Horn = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_is_c8_FSAC2021_V1_Running = c8_IN_EBS_Horn_OFF;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_EBS_Horn_OFF = 1U;
...
const mxArray *sf_c8_FSAC2021_V1_Running_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  chartInstance = (SFc8_FSAC2021_V1_RunningInstanceStruct *)chartInstanceVoid;
...
void sf_c8_FSAC2021_V1_Running_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_FSAC2021_V1_Running_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_FSAC2021_V1_Running_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_FSAC2021_V1_Running_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_FSAC2021_V1_Running(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[9],T\"Buzzer_Overflag\",},{M[1],M[5],T\"Buzzer_Pin\",},{M[8],M[0],T\"is_active_c8_FSAC2021_V1_Running\",},{M[9],M[0],T\"is_c8_FSAC2021_V1_Running\",},{M[9],M[14],T\"is_Horn\",},{M[11],M[0],T\"temporalCounter_i2\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x2[11 3],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_FSAC2021_V1_Running_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_FSAC2021_V1_RunningInstanceStruct *)
...
static void sf_opaque_initialize_c8_FSAC2021_V1_Running(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_FSAC2021_V1_Running
    ((SFc8_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar);
  initialize_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_FSAC2021_V1_Running(void *chartInstanceVar)
{
  enable_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_FSAC2021_V1_Running(void *chartInstanceVar)
{
  disable_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_FSAC2021_V1_Running(void *chartInstanceVar)
{
  sf_gateway_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_FSAC2021_V1_Running(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_FSAC2021_V1_Running
    ((SFc8_FSAC2021_V1_RunningInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_FSAC2021_V1_Running();/* state var info */
...
extern void sf_internal_set_sim_state_c8_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_FSAC2021_V1_Running();/* state var info */
  ...
  set_sim_state_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_FSAC2021_V1_Running(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c8_FSAC2021_V1_Running(S);
}

static void sf_opaque_set_sim_state_c8_FSAC2021_V1_Running(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_FSAC2021_V1_Running(S, st);
}

static void sf_opaque_terminate_c8_FSAC2021_V1_Running(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_FSAC2021_V1_RunningInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_FSAC2021_V1_Running((SFc8_FSAC2021_V1_RunningInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_FSAC2021_V1_Running(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_FSAC2021_V1_Running
      ((SFc8_FSAC2021_V1_RunningInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_FSAC2021_V1_Running(SimStruct *S)
{
...
static void mdlRTW_c8_FSAC2021_V1_Running(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_FSAC2021_V1_Running(SimStruct *S)
{
  SFc8_FSAC2021_V1_RunningInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_FSAC2021_V1_RunningInstanceStruct *)utMalloc(sizeof
    (SFc8_FSAC2021_V1_RunningInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_FSAC2021_V1_RunningInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_FSAC2021_V1_Running;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_FSAC2021_V1_Running;
...
void c8_FSAC2021_V1_Running_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_FSAC2021_V1_Running(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_FSAC2021_V1_Running(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_FSAC2021_V1_Running_method_dispatcher.\n"
