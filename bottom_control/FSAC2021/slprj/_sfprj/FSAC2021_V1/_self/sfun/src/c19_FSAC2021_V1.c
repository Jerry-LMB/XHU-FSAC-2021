...
#define c19_IN_Normal                  ((uint8_T)1U)
#define c19_IN_ON                      ((uint8_T)2U)
#define c19_IN_Off                     ((uint8_T)3U)
#define c19_IN_On                      ((uint8_T)4U)
...
static void initialize_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void initialize_params_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void enable_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void disable_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void c19_update_debugger_state_c19_FSAC2021_V1
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_FSAC2021_V1
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance);
static void set_sim_state_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_st);
static void c19_set_sim_state_side_effects_c19_FSAC2021_V1
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance);
static void finalize_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void sf_gateway_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void c19_chartstep_c19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
static void initSimStructsc19_FSAC2021_V1(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static boolean_T c19_b_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_c_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static uint8_T c19_d_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_b_tp_Normal, const char_T *c19_identifier);
static uint8_T c19_e_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint32_T c19_f_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_b_previousTicks, const char_T
  *c19_identifier);
static uint32_T c19_g_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static const mxArray *c19_h_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_b_setSimStateSideEffectsInfo, const char_T *
  c19_identifier);
static const mxArray *c19_i_emlrt_marshallIn(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_updateDataWrittenToVector(SFc19_FSAC2021_V1InstanceStruct
  *chartInstance, uint32_T c19_vectorIndex);
static void init_dsm_address_info(SFc19_FSAC2021_V1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_tp_Normal = 0U;
  chartInstance->c19_tp_ON = 0U;
  chartInstance->c19_temporalCounter_i1 = 0U;
  chartInstance->c19_tp_Off = 0U;
  chartInstance->c19_tp_On = 0U;
  chartInstance->c19_is_active_c19_FSAC2021_V1 = 0U;
  chartInstance->c19_is_c19_FSAC2021_V1 = c19_IN_NO_ACTIVE_CHILD;
  ...
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c19_is_active_c19_FSAC2021_V1 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 15U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_FSAC2021_V1 == c19_IN_Normal) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_FSAC2021_V1 == c19_IN_Off) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
  }

  if (chartInstance->c19_is_c19_FSAC2021_V1 == c19_IN_ON) {
  ...
  if (chartInstance->c19_is_c19_FSAC2021_V1 == c19_IN_On) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c19_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c19_sfEvent);
  }
  ...
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance)
{
  ...
  c19_c_hoistedGlobal = chartInstance->c19_is_c19_FSAC2021_V1;
  ...
  *chartInstance, const mxArray *c19_st)
{
  ...
  *c19_Output = c19_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c19_u, 0)), "Output");
  chartInstance->c19_is_active_c19_FSAC2021_V1 = c19_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
     "is_active_c19_FSAC2021_V1");
  chartInstance->c19_is_c19_FSAC2021_V1 = c19_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c19_u, 2)), "is_c19_FSAC2021_V1");
  ...
  c19_update_debugger_state_c19_FSAC2021_V1(chartInstance);
  ...
  (SFc19_FSAC2021_V1InstanceStruct *chartInstance)
{
  if (chartInstance->c19_doSetSimStateSideEffects != 0) {
    if (chartInstance->c19_is_c19_FSAC2021_V1 == c19_IN_Normal) {
      chartInstance->c19_tp_Normal = 1U;
    } else {
      chartInstance->c19_tp_Normal = 0U;
    }
  ...
  *chartInstance)
{
  ...
  uint8_T *c19_Output;
  c19_Output = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c19_Input = (uint8_T *)ssGetInputPortSignal(chartInstance->S, 0);
  c19_set_sim_state_side_effects_c19_FSAC2021_V1(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c19_Input, 0U);
  _SFD_DATA_RANGE_CHECK((real_T)*c19_Output, 1U);
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_FSAC2021_V1(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c19_is_active_c19_FSAC2021_V1 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 15U, chartInstance->c19_sfEvent);
    chartInstance->c19_is_active_c19_FSAC2021_V1 = 1U;
    ...
    chartInstance->c19_is_c19_FSAC2021_V1 = c19_IN_Normal;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
    chartInstance->c19_tp_Normal = 1U;
    ...
    *c19_Output = 0U;
    ...
    switch (chartInstance->c19_is_c19_FSAC2021_V1) {
     case c19_IN_Normal:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_out, 2U, c19_b_sf_marshallOut,
        c19_b_sf_marshallIn);
      c19_out = CV_EML_IF(0, 0, 0, (real_T)*c19_Input == 1.0);
      _SFD_SYMBOL_SCOPE_POP();
      if (c19_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
        chartInstance->c19_tp_Normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c19_sfEvent);
        chartInstance->c19_is_c19_FSAC2021_V1 = c19_IN_ON;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
        chartInstance->c19_temporalCounter_i1 = 0U;
        chartInstance->c19_tp_ON = 1U;
      } else {
     ...
     case c19_IN_ON:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_b_out, 2U, c19_b_sf_marshallOut,
        c19_b_sf_marshallIn);
      c19_b_out = CV_EML_IF(1, 0, 0, *c19_Input == 0);
      _SFD_SYMBOL_SCOPE_POP();
      if (c19_b_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
        chartInstance->c19_tp_ON = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c19_sfEvent);
        chartInstance->c19_is_c19_FSAC2021_V1 = c19_IN_Off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c19_sfEvent);
        chartInstance->c19_tp_Off = 1U;
      } else {
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_d_nargout, 1U,
          c19_sf_marshallOut, c19_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_c_out, 2U,
          c19_b_sf_marshallOut, c19_b_sf_marshallIn);
        c19_c_out = CV_EML_IF(3, 0, 0, chartInstance->c19_temporalCounter_i1 >=
                              5);
        _SFD_SYMBOL_SCOPE_POP();
        if (c19_c_out) {
     ...
     case c19_IN_Off:
      ...
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c19_e_debug_family_names,
        c19_b_debug_family_var_map);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_f_nargin, 0U, c19_sf_marshallOut,
        c19_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_f_nargout, 1U,
        c19_sf_marshallOut, c19_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_d_out, 2U, c19_b_sf_marshallOut,
        c19_b_sf_marshallIn);
      c19_d_out = CV_EML_IF(2, 0, 0, *c19_Input == 1);
      _SFD_SYMBOL_SCOPE_POP();
      if (c19_d_out) {
     ...
     case c19_IN_On:
      ...
      _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 3U,
                   chartInstance->c19_sfEvent);
      _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, chartInstance->c19_sfEvent);
      break;
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_FSAC2021_V1InstanceStruct *chartInstance;
  chartInstance = (SFc19_FSAC2021_V1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_FSAC2021_V1_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance, const mxArray *c19_b_tp_Normal, const char_T *c19_identifier)
{
  ...
  c19_thisId.fIdentifier = c19_identifier;
  c19_thisId.fParent = NULL;
  c19_y = c19_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c19_b_tp_Normal),
    &c19_thisId);
  sf_mex_destroy(&c19_b_tp_Normal);
  return c19_y;
}
...
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData)
{
  const mxArray *c19_b_tp_Normal;
  const char_T *c19_identifier;
  emlrtMsgIdentifier c19_thisId;
  uint8_T c19_y;
  SFc19_FSAC2021_V1InstanceStruct *chartInstance;
  chartInstance = (SFc19_FSAC2021_V1InstanceStruct *)chartInstanceVoid;
  c19_b_tp_Normal = sf_mex_dup(c19_mxArrayInData);
  c19_identifier = c19_varName;
  c19_thisId.fIdentifier = c19_identifier;
  c19_thisId.fParent = NULL;
  c19_y = c19_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c19_b_tp_Normal),
...
void sf_c19_FSAC2021_V1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_FSAC2021_V1_get_autoinheritance_info(void)
{
...
mxArray *sf_c19_FSAC2021_V1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_FSAC2021_V1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c19_FSAC2021_V1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[24],T\"Output\",},{M[8],M[0],T\"is_active_c19_FSAC2021_V1\",},{M[9],M[0],T\"is_c19_FSAC2021_V1\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[14],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_FSAC2021_V1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_FSAC2021_V1InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c19_Output = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c19_Input = (uint8_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c19_Input);
          _SFD_SET_DATA_VALUE_PTR(1U, c19_Output);
        }
      }
    } else {
...
static void sf_opaque_initialize_c19_FSAC2021_V1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_FSAC2021_V1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*)
    chartInstanceVar);
  initialize_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_FSAC2021_V1(void *chartInstanceVar)
{
  enable_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_FSAC2021_V1(void *chartInstanceVar)
{
  disable_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_FSAC2021_V1(void *chartInstanceVar)
{
  sf_gateway_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_FSAC2021_V1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_FSAC2021_V1
    ((SFc19_FSAC2021_V1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_FSAC2021_V1();/* state var info */
...
extern void sf_internal_set_sim_state_c19_FSAC2021_V1(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c19_FSAC2021_V1();/* state var info */
  ...
  set_sim_state_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_FSAC2021_V1(SimStruct* S)
{
  return sf_internal_get_sim_state_c19_FSAC2021_V1(S);
}

static void sf_opaque_set_sim_state_c19_FSAC2021_V1(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c19_FSAC2021_V1(S, st);
}

static void sf_opaque_terminate_c19_FSAC2021_V1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_FSAC2021_V1((SFc19_FSAC2021_V1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_FSAC2021_V1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_FSAC2021_V1(SimStruct *S)
{
...
static void mdlRTW_c19_FSAC2021_V1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_FSAC2021_V1(SimStruct *S)
{
  SFc19_FSAC2021_V1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_FSAC2021_V1InstanceStruct *)utMalloc(sizeof
    (SFc19_FSAC2021_V1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_FSAC2021_V1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_FSAC2021_V1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_FSAC2021_V1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_FSAC2021_V1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_FSAC2021_V1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_FSAC2021_V1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c19_FSAC2021_V1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c19_FSAC2021_V1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_FSAC2021_V1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_FSAC2021_V1;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_FSAC2021_V1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_FSAC2021_V1;
...
void c19_FSAC2021_V1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_FSAC2021_V1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_FSAC2021_V1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_FSAC2021_V1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_FSAC2021_V1_method_dispatcher.\n"
