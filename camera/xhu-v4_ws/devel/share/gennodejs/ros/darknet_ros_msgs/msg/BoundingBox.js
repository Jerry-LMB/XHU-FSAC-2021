...
class BoundingBox {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('distancex')) {
        this.distancex = initObj.distancex
      }
      else {
        this.distancex = 0;
      }
      if (initObj.hasOwnProperty('distancey')) {
        this.distancey = initObj.distancey
      }
      else {
        this.distancey = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [distancex]
    bufferOffset = _serializer.int64(obj.distancex, buffer, bufferOffset);
    // Serialize message field [distancey]
    bufferOffset = _serializer.int64(obj.distancey, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [distancex]
    data.distancex = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [distancey]
    data.distancey = _deserializer.int64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '625a2ff9b8941cb1db31ff8a4ca126e8';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.distancex !== undefined) {
      resolved.distancex = msg.distancex;
    }
    else {
      resolved.distancex = 0
    }

    if (msg.distancey !== undefined) {
      resolved.distancey = msg.distancey;
    }
    else {
      resolved.distancey = 0
    }
