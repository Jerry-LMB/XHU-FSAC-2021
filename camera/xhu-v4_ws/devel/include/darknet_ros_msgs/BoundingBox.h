...
struct BoundingBox_
{
  ...
  _ymax_type ymax;
   ...
   typedef int64_t _distancex_type;
  _distancex_type distancex;

   typedef int64_t _distancey_type;
...
bool operator==(const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator1> & lhs, const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator2> & rhs)
{
  return lhs.probability == rhs.probability &&
    ...
    lhs.xmax == rhs.xmax &&
    lhs.ymax == rhs.ymax &&
    lhs.distancex == rhs.distancex &&
    lhs.distancey == rhs.distancey &&
    lhs.id == rhs.id &&
    lhs.Class == rhs.Class;
}
...
struct MD5Sum< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x625a2ff9b8941cb1ULL;
  static const uint64_t static_value2 = 0xdb31ff8a4ca126e8ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.xmax);
      stream.next(m.ymax);
      stream.next(m.distancex);
      stream.next(m.distancey);
      stream.next(m.id);
      stream.next(m.Class);
    }
...
struct Printer< ::darknet_ros_msgs::BoundingBox_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::darknet_ros_msgs::BoundingBox_<ContainerAllocator>& v)
  {
    ...
    s << indent << "distancex: ";
    Printer<int64_t>::stream(s, indent + "  ", v.distancex);
    s << indent << "distancey: ";
    Printer<int64_t>::stream(s, indent + "  ", v.distancey);
    s << indent << "id: ";
